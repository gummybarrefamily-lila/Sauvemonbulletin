...
export const PROGRAMME: Record<MatiereId, Record<Niveau, EntreeProgramme[]>> = {
  maths: {
    ...
    "4eme": [
      { slug: "relatifs-multiplication-division", titre: "Nombres relatifs : multiplication et division", disponible: true },
      { slug: "fractions-operations", titre: "Opérations sur les fractions", disponible: true },
      { slug: "puissances", titre: "Les puissances", disponible: true },
      { slug: "calcul-litteral-developpement", titre: "Calcul littéral : développer et réduire", disponible: true },
      { slug: "equations", titre: "Les équations du premier degré", disponible: true },
      { slug: "theoreme-pythagore", titre: "Le théorème de Pythagore", disponible: true },
      { slug: "translations-rotations", titre: "Translations et rotations", disponible: true },
      { slug: "proportionnalite-pourcentages", titre: "Proportionnalité et pourcentages", disponible: true },
      { slug: "probabilites", titre: "Notion de probabilité", disponible: true },
      { slug: "pyramides-cones", titre: "Pyramides et cônes", disponible: true },
    ],
    "3eme": [
      { slug: "arithmetique", titre: "Arithmétique : diviseurs et nombres premiers", disponible: true },
      { slug: "calcul-litteral-factorisation", titre: "Calcul littéral : identités et factorisation", disponible: true },
      { slug: "equations-inequations", titre: "Équations et inéquations", disponible: true },
      { slug: "fonctions", titre: "Les fonctions", disponible: true },
      { slug: "fonctions-lineaires-affines", titre: "Fonctions linéaires et affines", disponible: true },
      { slug: "theoreme-thales", titre: "Le théorème de Thalès", disponible: true },
      { slug: "trigonometrie", titre: "La trigonométrie", disponible: true },
      { slug: "homothetie", titre: "Homothéties et agrandissements", disponible: true },
      { slug: "statistiques-probabilites", titre: "Statistiques et probabilités", disponible: true },
      { slug: "volumes-sections", titre: "Volumes et sections de solides", disponible: true },
    ],
  },
  francais: {
    "5eme": [
    ...
    "4eme": [
      { slug: "lettre-journal-intime", titre: "La lettre et le journal intime", disponible: true },
      { slug: "recit-fantastique", titre: "Le récit fantastique", disponible: true },
      { slug: "subordonnees", titre: "Les propositions subordonnées", disponible: true },
      { slug: "roman-realiste", titre: "Le roman réaliste et la nouvelle", disponible: true },
      { slug: "poesie-lyrique", titre: "La poésie lyrique", disponible: true },
      { slug: "discours-direct-indirect", titre: "Discours direct et indirect", disponible: true },
      { slug: "presse-information", titre: "Informer, s'informer, déformer", disponible: true },
      { slug: "voix-active-passive", titre: "Voix active et voix passive", disponible: true },
    ],
    "3eme": [
      { slug: "autobiographie", titre: "L'autobiographie : se raconter", disponible: true },
      { slug: "recits-guerre", titre: "Récits de guerre et d'engagement", disponible: true },
      { slug: "poesie-engagee", titre: "La poésie engagée", disponible: true },
      { slug: "subjonctif-concordance", titre: "Le subjonctif et la concordance des temps", disponible: true },
      { slug: "argumentation", titre: "L'argumentation : convaincre et persuader", disponible: true },
      { slug: "figures-de-style", titre: "Les figures de style", disponible: true },
      { slug: "theatre-tragique", titre: "Le théâtre : dénoncer les travers de la société", disponible: true },
      { slug: "grammaire-brevet", titre: "La grammaire au brevet : analyse et réécriture", disponible: true },
    ],
  },
  "physique-chimie": {
    "5eme": [
    ...
    "4eme": [
      { slug: "transformations-chimiques", titre: "Les transformations chimiques", disponible: true },
      { slug: "atomes-molecules", titre: "Atomes et molécules", disponible: true },
      { slug: "intensite-tension", titre: "Intensité et tension électriques", disponible: true },
      { slug: "vitesse-lumiere-son", titre: "Vitesse de la lumière et du son", disponible: true },
      { slug: "pression", titre: "La pression", disponible: true },
      { slug: "combustions", titre: "Les combustions", disponible: true },
    ],
    "3eme": [
      { slug: "ions-ph", titre: "Ions et pH", disponible: true },
      { slug: "gravitation-poids", titre: "Gravitation, poids et masse", disponible: true },
      { slug: "energie-cinetique", titre: "Énergie cinétique et sécurité routière", disponible: true },
      { slug: "resistance-loi-ohm", titre: "Résistance et loi d'Ohm", disponible: true },
      { slug: "puissance-energie-electrique", titre: "Puissance et énergie électriques", disponible: true },
      { slug: "signaux-information", titre: "Signaux et information", disponible: true },
    ],
  },
  svt: {
    "5eme": [
    ...
    "4eme": [
      ...
      { slug: "reproduction-humaine", titre: "La reproduction humaine", disponible: true },
      { slug: "meteo-climat", titre: "Météorologie et climat", disponible: true },
      { slug: "systeme-nerveux", titre: "Le système nerveux et le mouvement", disponible: true },
      { slug: "biodiversite-evolution", titre: "Biodiversité et évolution", disponible: true },
    ],
    "3eme": [
      { slug: "genetique", titre: "Génétique : ADN, gènes et chromosomes", disponible: true },
      { slug: "evolution-especes", titre: "L'évolution des espèces", disponible: true },
      { slug: "systeme-immunitaire", titre: "Le système immunitaire", disponible: true },
      { slug: "responsabilite-sante", titre: "Comportements responsables et santé", disponible: true },
      { slug: "risques-geologiques", titre: "Risques géologiques et humains", disponible: true },
    ],
  },
  "histoire-geo": {
    "5eme": [
    ...
    "4eme": [
      { slug: "traites-negrieres", titre: "Bourgeoisies, commerce et traites négrières", disponible: true },
      { slug: "revolution-francaise", titre: "La Révolution française et l'Empire", disponible: true },
      { slug: "industrialisation", titre: "L'Europe de la révolution industrielle", disponible: true },
      { slug: "colonisation-xixe", titre: "Conquêtes et sociétés coloniales", disponible: true },
      { slug: "urbanisation-monde", titre: "L'urbanisation du monde", disponible: true },
      { slug: "mondialisation-mers", titre: "Mers et océans dans la mondialisation", disponible: true },
    ],
    "3eme": [
      { slug: "premiere-guerre-mondiale", titre: "Civils et militaires dans la Première Guerre mondiale", disponible: true },
      { slug: "regimes-totalitaires", titre: "Démocraties et expériences totalitaires", disponible: true },
      { slug: "seconde-guerre-mondiale", titre: "La Seconde Guerre mondiale, une guerre d'anéantissement", disponible: true },
      { slug: "france-defaite-republique", titre: "La France de 1940 à nos jours", disponible: true },
      { slug: "guerre-froide", titre: "Le monde bipolaire : la guerre froide", disponible: true },
      { slug: "amenagement-territoire", titre: "Aménager le territoire français", disponible: true },
      { slug: "union-europeenne", titre: "La France et l'Union européenne", disponible: true },
    ],
  },
  chinois: {
    "5eme": [
    ...
    "4eme": [
      ...
      { slug: "hsk3-sentiments", titre: "HSK 3 — Exprimer sentiments et opinions", disponible: true },
      { slug: "hsk3-comparaison", titre: "HSK 3 — La comparaison (比) et le complément d'état", disponible: true },
      { slug: "hsk4-preparation", titre: "Vers le HSK 4 — lecture de textes courts", disponible: true },
    ],
    "3eme": [
      { slug: "hsk4-culture", titre: "HSK 4 — Culture chinoise et actualité", disponible: true },
      { slug: "hsk4-redaction", titre: "HSK 4 — Rédiger un texte structuré", disponible: true },
      { slug: "hsk4-grammaire-avancee", titre: "HSK 4 — 把, 被 et structures avancées", disponible: true },
      { slug: "hsk5-preparation", titre: "Vers le HSK 5 — compréhension fine et essais", disponible: true },
    ],
  },
  russe: {
    "5eme": [
    ...
    "4eme": [
      ...
      { slug: "cas-nominatif-accusatif", titre: "Les cas : nominatif et accusatif", disponible: true },
      { slug: "verbes-mouvement", titre: "Les verbes de mouvement", disponible: true },
      { slug: "vocabulaire-danse-2", titre: "Danse-études — en répétition avec un professeur russe", disponible: true },
    ],
    "3eme": [
      { slug: "conversation-avancee", titre: "Conversation avancée : raconter et décrire", disponible: true },
      { slug: "cas-genitif-datif", titre: "Les cas : génitif et datif", disponible: true },
      { slug: "aspect-verbal", titre: "L'aspect verbal : perfectif et imperfectif", disponible: true },
      { slug: "vocabulaire-danse-3", titre: "Danse-études — audition et scène en russe", disponible: true },
    ],
  },
  espagnol: {
    "5eme": [
    ...
    "4eme": [
      ...
      { slug: "la-ciudad", titre: "La ville et les directions", disponible: true },
      { slug: "la-comida", titre: "La nourriture et le restaurant", disponible: true },
      { slug: "ropa-compras", titre: "Les vêtements et les achats", disponible: true },
      { slug: "preterito", titre: "Parler au passé (pretérito)", disponible: true },
    ],
    "3eme": [
      { slug: "vacaciones-viajes", titre: "Vacances et voyages", disponible: true },
      { slug: "medio-ambiente", titre: "L'environnement", disponible: true },
      { slug: "futuro-planes", titre: "Le futur et les projets", disponible: true },
      { slug: "cultura-hispanica", titre: "La culture du monde hispanique", disponible: true },
  ...
  "histoire-danse": {
    ...
    "4eme": [
      ...
      { slug: "ballets-russes", titre: "Les Ballets russes de Diaghilev", disponible: true },
      { slug: "grands-choregraphes-classiques", titre: "Petipa et les grands ballets du répertoire", disponible: true },
    ],
    "3eme": [
      { slug: "danse-moderne", titre: "La danse moderne : de Duncan à Graham", disponible: true },
      { slug: "danse-contemporaine", titre: "La danse contemporaine en France et dans le monde", disponible: true },
      { slug: "hip-hop-cultures-urbaines", titre: "Hip-hop et cultures urbaines", disponible: true },
    ],
  },
};
