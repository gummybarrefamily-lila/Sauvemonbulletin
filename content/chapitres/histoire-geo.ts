...
const chapitres: Chapitre[] = [
{
  ...
  niveau: "6eme",
  description:
    "Découvrir le monde des cités grecques dans l'Antiquité : l'organisation d'une cité comme Athènes, la naissance de la démocratie, la religion et les grands sanctuaires, à travers l'exemple d'Athènes et de Sparte.",
  objectifs: [
    "Comprendre ce qu'est une cité grecque (polis) et son organisation",
    "Connaître les grandes caractéristiques d'Athènes et de Sparte",
    "Comprendre la naissance de la démocratie athénienne",
    "Connaître la religion grecque et les grands sanctuaires communs",
    "Situer le monde grec dans le temps et l'espace méditerranéen",
  ],
  slides: [
    {
      titre: "Le monde grec, un monde de cités",
      illustration: "🏛️",
      visuel: "VIIIe-IVe siècle av. J.-C.",
      contenu: [
        "La Grèce antique n'est pas un pays unique mais un ensemble de cités indépendantes",
        "Chaque cité (polis) a ses propres lois, son armée et sa monnaie",
        "Les cités grecques colonisent tout le pourtour de la Méditerranée",
        "Elles partagent cependant une même langue, une même religion et des jeux communs",
      ],
      voixOff:
        "Entre le huitième et le quatrième siècle avant Jésus-Christ, le monde grec n'est pas un pays unifié mais un ensemble de centaines de cités indépendantes, que les Grecs appellent des « poleis ». Chaque cité possède ses propres lois, sa propre armée et parfois sa propre monnaie. Ces cités fondent aussi de nombreuses colonies tout autour de la mer Méditerranée et de la mer Noire. Malgré leur indépendance, elles partagent une même langue, une même religion et des fêtes communes, comme les jeux Olympiques.",
    },
    {
      titre: "L'organisation d'une cité grecque",
      illustration: "🏘️",
      visuel: "Acropole, agora",
      contenu: [
        "La cité comprend une ville et les campagnes qui l'entourent",
        "L'acropole, sur une hauteur, abrite les temples des dieux protecteurs",
        "L'agora est la grande place publique, centre de la vie politique et commerciale",
        "Les habitants se répartissent entre citoyens, femmes, étrangers et esclaves",
      ],
      voixOff:
        "Une cité grecque comprend une ville et les campagnes environnantes qu'elle contrôle. Sur une hauteur se dresse l'acropole, qui abrite les temples dédiés aux dieux protecteurs de la cité. En contrebas, l'agora est la grande place publique, où se déroulent le commerce, les débats politiques et la vie sociale. La population de la cité n'est pas uniforme : elle se compose de citoyens, de femmes, d'étrangers appelés métèques, et d'esclaves, qui n'ont pas les mêmes droits.",
    },
    {
      titre: "Athènes, cité de la démocratie",
      illustration: "⚖️",
      visuel: "-508, Clisthène",
      contenu: [
        "Athènes est l'une des cités les plus puissantes de Grèce",
        "En -508, les réformes de Clisthène posent les bases de la démocratie",
        "Les citoyens votent les lois à l'Ecclésia, l'assemblée du peuple",
        "Seuls les hommes citoyens majeurs, nés de parents athéniens, participent au vote",
      ],
      voixOff:
        "Athènes est l'une des cités les plus puissantes et les plus influentes du monde grec. En moins cinq cent huit, les réformes du dirigeant Clisthène posent les bases de la démocratie, un mot grec qui signifie « le pouvoir du peuple ». Les citoyens se réunissent dans une grande assemblée, l'Ecclésia, pour voter eux-mêmes les lois de la cité. Attention cependant : seuls les hommes citoyens, majeurs et nés de parents athéniens, peuvent y participer ; les femmes, les étrangers et les esclaves en sont exclus.",
    },
    {
      titre: "Sparte, une cité guerrière",
      illustration: "🛡️",
      visuel: "Deux rois, hoplites",
      contenu: [
        "Sparte, dans le Péloponnèse, est organisée autour de la guerre",
        "Elle est dirigée par deux rois et un conseil de citoyens âgés",
        "Dès l'enfance, les garçons spartiates reçoivent une éducation militaire stricte",
        "Les hoplites, soldats lourdement armés, forment la puissante armée spartiate",
      ],
      voixOff:
        "Sparte, une autre grande cité grecque située dans le Péloponnèse, organise toute sa vie autour de la guerre. Elle est dirigée par deux rois et un conseil de citoyens âgés. Dès leur plus jeune âge, les garçons spartiates sont retirés à leur famille pour recevoir une éducation militaire très stricte, afin de devenir des hoplites, des soldats lourdement armés d'un bouclier, d'une lance et d'une cuirasse, qui font la réputation de la puissante armée spartiate.",
    },
    {
      titre: "La religion grecque",
      illustration: "⚡",
      visuel: "Zeus, mont Olympe",
      contenu: [
        "Les Grecs sont polythéistes : ils croient en de nombreux dieux",
        "Les douze grands dieux habitent le mont Olympe, dirigés par Zeus",
        "Chaque dieu a un domaine particulier : Athéna (sagesse), Poséidon (mer), Apollon (arts)",
        "Les Grecs leur offrent des sacrifices et construisent de grands temples",
      ],
      voixOff:
        "Les Grecs sont polythéistes, c'est-à-dire qu'ils croient en de nombreux dieux. Les douze plus grands dieux résident, selon la légende, au sommet du mont Olympe, sous l'autorité de Zeus, le roi des dieux et maître de la foudre. Chaque dieu possède un domaine particulier : Athéna, déesse de la sagesse, protège Athènes ; Poséidon règne sur la mer ; Apollon est le dieu des arts et de la lumière. Pour honorer ces dieux, les Grecs leur offrent des sacrifices et construisent de magnifiques temples.",
    },
    {
      titre: "Les sanctuaires communs et les jeux Olympiques",
      illustration: "🏅",
      visuel: "Olympie, Delphes",
      contenu: [
        "Delphes et Olympie sont de grands sanctuaires communs à tous les Grecs",
        "À Delphes, on consulte l'oracle d'Apollon pour connaître l'avenir",
        "Les jeux Olympiques, en l'honneur de Zeus, ont lieu à Olympie tous les quatre ans",
        "Pendant les jeux, une trêve suspend les guerres entre les cités grecques",
      ],
      voixOff:
        "Certains lieux appartiennent à tout le monde grec, au-delà des rivalités entre cités. À Delphes, les Grecs viennent consulter l'oracle du dieu Apollon pour connaître l'avenir. À Olympie se déroulent, tous les quatre ans depuis sept cent soixante-seize avant Jésus-Christ selon la tradition, les jeux Olympiques, organisés en l'honneur de Zeus. Pendant ces jeux, une trêve sacrée suspend même les guerres entre cités, preuve de l'unité culturelle et religieuse du monde grec.",
    },
    {
      titre: "Les guerres médiques, les Grecs face à la Perse",
      illustration: "⚔️",
      visuel: "Marathon, -490",
      contenu: [
        "Au Ve siècle avant J.-C., l'immense empire perse attaque les cités grecques",
        "En -490, les Athéniens remportent la célèbre victoire de Marathon",
        "En -480, la flotte grecque triomphe à la bataille navale de Salamine",
        "Ces victoires renforcent la fierté et l'unité du monde grec",
      ],
      voixOff:
        "Au cinquième siècle avant Jésus-Christ, l'immense empire perse cherche à conquérir les cités grecques : ce sont les guerres médiques. En moins quatre cent quatre-vingt-dix, les soldats athéniens remportent une victoire célèbre à Marathon, malgré leur infériorité numérique. Dix ans plus tard, en moins quatre cent quatre-vingts, la flotte grecque triomphe à la bataille navale de Salamine. Ces victoires renforcent considérablement la fierté et le sentiment d'unité des cités grecques face à un ennemi commun.",
    },
    {
      ...
      visuel: "📌",
      contenu: [
        "Le monde grec : de nombreuses cités indépendantes (poleis) autour de la Méditerranée",
        "Athènes invente la démocratie (Clisthène, -508) ; Sparte est une cité guerrière",
        "Religion polythéiste : douze dieux de l'Olympe, sanctuaires communs, jeux Olympiques",
        "Victoires grecques contre les Perses (Marathon -490, Salamine -480)",
      ],
      voixOff:
        "Résumons. Le monde grec antique est formé de nombreuses cités indépendantes, les poleis, réparties tout autour de la Méditerranée. Athènes invente la démocratie grâce aux réformes de Clisthène en moins cinq cent huit, tandis que Sparte reste une cité guerrière dirigée par deux rois. Tous les Grecs partagent cependant la même religion polythéiste, avec les douze dieux de l'Olympe, et se retrouvent dans des sanctuaires communs comme Delphes et Olympie, où se déroulent les jeux Olympiques. Face à l'empire perse, les cités grecques remportent d'importantes victoires à Marathon et à Salamine. Bravo, tu connais l'essentiel de ce chapitre !",
    },
  ],
  fiche: {
    intro:
      "Entre le VIIIe et le IVe siècle avant J.-C., le monde grec se compose de nombreuses cités indépendantes, réparties autour de la Méditerranée, qui partagent la même langue, la même religion et de grands sanctuaires communs.",
    sections: [
      {
        titre: "La cité grecque",
        points: [
          "Une cité (polis) = une ville + ses campagnes, indépendante politiquement",
          "L'acropole (temples) et l'agora (place publique) au cœur de la cité",
          "Citoyens, femmes, métèques (étrangers) et esclaves ont des statuts différents",
        ],
      },
      {
        titre: "Athènes et Sparte, deux cités différentes",
        points: [
          "Athènes : réformes de Clisthène (-508), naissance de la démocratie, Ecclésia",
          "Sparte : cité guerrière, deux rois, éducation militaire des garçons, hoplites",
        ],
      },
      {
        titre: "La religion grecque",
        points: [
          "Polythéisme : douze grands dieux sur le mont Olympe, dirigés par Zeus",
          "Sanctuaires communs à tous les Grecs : Delphes (oracle), Olympie (jeux)",
          "Jeux Olympiques tous les quatre ans en l'honneur de Zeus",
        ],
      },
      {
        titre: "Les guerres médiques",
        points: [
          "L'empire perse attaque les cités grecques au Ve siècle av. J.-C.",
          "Victoire d'Athènes à Marathon (-490)",
          "Victoire navale grecque à Salamine (-480)",
        ],
      },
    ],
    audio:
      "Fiche de révision : le monde des cités grecques. Entre le huitième et le quatrième siècle avant Jésus-Christ, le monde grec se compose de très nombreuses cités indépendantes, les poleis, réparties autour de la Méditerranée. Chaque cité s'organise autour de l'acropole, qui abrite les temples, et de l'agora, la place publique. À Athènes, les réformes de Clisthène, en moins cinq cent huit, posent les bases de la démocratie : les citoyens votent les lois à l'Ecclésia. À Sparte, cité guerrière dirigée par deux rois, les garçons reçoivent dès l'enfance une éducation militaire pour devenir hoplites. Tous les Grecs partagent la même religion polythéiste, avec douze grands dieux résidant sur le mont Olympe sous l'autorité de Zeus, et se retrouvent dans des sanctuaires communs comme Delphes, où l'on consulte l'oracle d'Apollon, et Olympie, où se déroulent tous les quatre ans les jeux Olympiques. Au cinquième siècle avant Jésus-Christ, les cités grecques repoussent l'empire perse lors des guerres médiques, remportant les victoires de Marathon en moins quatre cent quatre-vingt-dix et de Salamine en moins quatre cent quatre-vingts.",
  },
  memoCards: [
    { recto: "Qu'est-ce qu'une « polis » ?", verso: "Une cité grecque indépendante, formée d'une ville et de ses campagnes environnantes." },
    { recto: "Qu'est-ce que l'acropole ?", verso: "La hauteur qui domine la cité et abrite les temples des dieux protecteurs." },
    { recto: "Qu'est-ce que l'agora ?", verso: "La grande place publique, centre de la vie politique et commerciale de la cité." },
    { recto: "Qui pose les bases de la démocratie athénienne et quand ?", verso: "Clisthène, en -508." },
    { recto: "Comment vote-t-on à Athènes ?", verso: "Les citoyens (hommes majeurs nés de parents athéniens) votent les lois à l'assemblée, l'Ecclésia." },
    { recto: "Quelles sont les particularités de Sparte ?", verso: "Une cité guerrière dirigée par deux rois, où les garçons reçoivent une éducation militaire stricte pour devenir hoplites." },
    { recto: "Qui dirige les douze dieux de l'Olympe ?", verso: "Zeus, le roi des dieux et maître de la foudre." },
    { recto: "Où et quand ont lieu les premiers jeux Olympiques ?", verso: "À Olympie, tous les quatre ans, à partir de -776 selon la tradition." },
  ],
  exercices: [
    {
      type: "qcm",
      difficulte: "facile",
      question: "Comment appelle-t-on une cité grecque en grec ancien ?",
      choix: ["Une agora", "Une polis", "Une acropole", "Une colonie"],
      bonneReponse: 1,
      explication: "Le mot « polis » désigne une cité grecque indépendante, dont vient le mot « politique ».",
    },
    {
      type: "qcm",
      difficulte: "facile",
      question: "Où se trouvent les temples dans une cité grecque ?",
      choix: ["Sur l'agora", "Sur l'acropole", "Hors de la cité", "Dans le port"],
      bonneReponse: 1,
      explication: "L'acropole, sur une hauteur, abrite les temples dédiés aux dieux protecteurs de la cité.",
    },
    {
      type: "ouverte",
      difficulte: "facile",
      question: "Qui dirige les douze dieux grecs de l'Olympe ?",
      reponse: "Zeus.",
      explication: "Zeus est le roi des dieux dans la mythologie grecque, maître de la foudre.",
    },
    {
      type: "qcm",
      difficulte: "facile",
      question: "Où se déroulaient les jeux Olympiques antiques ?",
      choix: ["À Athènes", "À Sparte", "À Olympie", "À Delphes"],
      bonneReponse: 2,
      explication: "Les jeux Olympiques se déroulaient à Olympie, tous les quatre ans, en l'honneur de Zeus.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Qui peut voter à l'Ecclésia, l'assemblée d'Athènes ?",
      choix: ["Tous les habitants d'Athènes", "Seulement les hommes citoyens majeurs", "Seulement les femmes", "Seulement les esclaves"],
      bonneReponse: 1,
      explication: "Seuls les hommes citoyens, majeurs et nés de parents athéniens, participent au vote.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Qu'apportent les réformes de Clisthène en -508 ?",
      reponse: "Elles posent les bases de la démocratie à Athènes, en donnant aux citoyens le pouvoir de voter eux-mêmes les lois de la cité à l'Ecclésia.",
      explication: "Le mot démocratie vient du grec et signifie « le pouvoir du peuple ».",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Décris l'éducation des garçons à Sparte.",
      reponse: "Dès l'enfance, les garçons spartiates sont retirés à leur famille pour recevoir une éducation militaire très stricte, afin de devenir des hoplites, soldats de l'armée spartiate.",
      explication: "Toute la société spartiate est organisée autour de la préparation à la guerre.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Que va-t-on chercher au sanctuaire de Delphes ?",
      choix: ["Des jeux sportifs", "Les prédictions de l'oracle d'Apollon", "Des lois écrites", "Des soldats"],
      bonneReponse: 1,
      explication: "À Delphes, les Grecs consultent l'oracle du dieu Apollon pour connaître l'avenir.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Explique pourquoi on peut dire que le monde grec est « un monde de cités » plutôt qu'un pays uni.",
      reponse:
        "Parce que la Grèce antique se compose de centaines de cités indépendantes (poleis), chacune ayant ses propres lois, sa propre armée et parfois sa propre monnaie, sans pouvoir politique central commun, bien qu'elles partagent la même langue et la même religion.",
      explication: "Cette organisation en cités indépendantes est une caractéristique essentielle du monde grec antique.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Compare l'organisation politique d'Athènes et de Sparte.",
      reponse:
        "Athènes est une démocratie où les citoyens votent eux-mêmes les lois à l'Ecclésia, depuis les réformes de Clisthène. Sparte est dirigée par deux rois et un conseil de citoyens âgés, et organise toute sa société autour de la préparation militaire plutôt que de la participation politique de tous les citoyens.",
      explication: "Ces deux cités illustrent la diversité des régimes politiques dans le monde grec.",
    },
    {
      type: "qcm",
      difficulte: "avance",
      question: "En quelle année les Athéniens remportent-ils la bataille de Marathon ?",
      choix: ["-776", "-508", "-490", "-480"],
      bonneReponse: 2,
      explication: "La victoire de Marathon, en -490, est l'une des grandes victoires grecques lors des guerres médiques.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Pourquoi les jeux Olympiques et les sanctuaires comme Delphes montrent-ils une unité du monde grec malgré la division en cités ?",
      reponse:
        "Parce que tous les Grecs, quelle que soit leur cité d'origine, se reconnaissent dans la même religion, participent aux mêmes fêtes religieuses et sportives, et respectent une trêve sacrée pendant les jeux Olympiques, ce qui montre une identité culturelle commune au-delà des rivalités politiques.",
      explication: "Ces lieux communs jouent un rôle fédérateur essentiel dans le monde grec antique.",
    },
  ],
  revisionFinChapitre: [
    {
      type: "qcm",
      difficulte: "facile",
      question: "Quel est le nom de la place publique d'une cité grecque ?",
      choix: ["L'acropole", "L'agora", "L'Ecclésia", "L'Olympe"],
      bonneReponse: 1,
      explication: "L'agora est le centre de la vie politique et commerciale de la cité.",
    },
    {
      type: "ouverte",
      difficulte: "facile",
      question: "Que signifie le mot « démocratie » ?",
      reponse: "Le pouvoir du peuple.",
      explication: "Ce mot grec désigne le régime politique inventé à Athènes.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Qui sont les hoplites ?",
      reponse: "Des soldats grecs lourdement armés d'un bouclier, d'une lance et d'une cuirasse, notamment célèbres à Sparte.",
      explication: "Les hoplites forment le cœur des armées des cités grecques.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Quels peuples les cités grecques affrontent-elles lors des guerres médiques ?",
      choix: ["Les Romains", "Les Perses", "Les Égyptiens", "Les Carthaginois"],
      bonneReponse: 1,
      explication: "Les guerres médiques opposent les cités grecques à l'empire perse au Ve siècle av. J.-C.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "En une phrase, explique ce qui unit les cités grecques malgré leurs différences.",
      reponse: "Elles partagent la même langue, la même religion polythéiste et des sanctuaires communs comme Delphes et Olympie.",
      explication: "Cette unité culturelle coexiste avec une forte indépendance politique des cités.",
    },
  ],
  examens: [
    {
      titre: "Examen 1 — Le monde des cités grecques",
      dureeMinutes: 20,
      questions: [
        {
          type: "qcm",
          difficulte: "facile",
          question: "Qu'est-ce qu'une cité grecque (polis) ?",
          choix: ["Un empire unique dirigeant toute la Grèce", "Une ville indépendante avec ses campagnes environnantes", "Un temple religieux", "Une armée de mercenaires"],
          bonneReponse: 1,
          explication: "Chaque polis est une entité politique indépendante, formée d'une ville et de ses territoires.",
        },
        {
          type: "ouverte",
          difficulte: "facile",
          question: "Qui sont Zeus, Athéna et Poséidon ?",
          reponse: "Des dieux grecs : Zeus est le roi des dieux, Athéna la déesse de la sagesse, Poséidon le dieu de la mer.",
          explication: "Les Grecs sont polythéistes et vénèrent de nombreux dieux, résidant sur le mont Olympe.",
        },
        {
          type: "qcm",
          difficulte: "moyen",
          question: "En quelle année les réformes de Clisthène posent-elles les bases de la démocratie athénienne ?",
          choix: ["-776", "-508", "-490", "-480"],
          bonneReponse: 1,
          explication: "Les réformes de Clisthène datent de -508.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Qui peut être citoyen à Athènes et participer au vote ?",
          reponse: "Seuls les hommes libres, majeurs, nés de parents athéniens ; les femmes, les étrangers (métèques) et les esclaves en sont exclus.",
          explication: "La démocratie athénienne est donc une démocratie limitée à une partie de la population.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Décris l'organisation politique et sociale de Sparte.",
          reponse: "Sparte est dirigée par deux rois et un conseil de citoyens âgés ; toute la société est organisée autour de la préparation militaire, avec une éducation stricte des garçons pour devenir hoplites.",
          explication: "Sparte se distingue nettement du modèle démocratique athénien.",
        },
        {
          type: "ouverte",
          difficulte: "avance",
          question:
            "Développement construit : présente l'organisation d'une cité grecque et compare Athènes et Sparte (une quinzaine de lignes).",
          reponse:
            "Introduction : le monde grec antique est formé de nombreuses cités indépendantes, ou poleis, dont Athènes et Sparte sont deux exemples célèbres. Première partie : une cité grecque s'organise autour de l'acropole, qui abrite les temples, et de l'agora, la place publique. Deuxième partie : à Athènes, les réformes de Clisthène en -508 posent les bases de la démocratie ; les citoyens votent les lois à l'Ecclésia, même si femmes, étrangers et esclaves en sont exclus. Troisième partie : à Sparte, dirigée par deux rois, la vie est organisée autour de la guerre, avec une éducation militaire stricte des garçons pour devenir hoplites. Conclusion : ces deux cités montrent la diversité des organisations politiques possibles dans le monde grec, malgré une culture et une religion communes.",
          explication: "Un bon développement présente clairement l'organisation générale d'une cité avant de comparer les deux exemples.",
        },
      ],
    },
    {
      titre: "Examen 2 — Le monde des cités grecques",
      dureeMinutes: 20,
      questions: [
        {
          type: "qcm",
          difficulte: "facile",
          question: "Quel dieu est honoré lors des jeux Olympiques antiques ?",
          choix: ["Apollon", "Zeus", "Poséidon", "Athéna"],
          bonneReponse: 1,
          explication: "Les jeux Olympiques, à Olympie, sont organisés en l'honneur de Zeus.",
        },
        {
          type: "ouverte",
          difficulte: "facile",
          question: "Qu'est-ce que l'oracle de Delphes ?",
          reponse: "Un lieu sacré où l'on consulte la prêtresse du dieu Apollon pour connaître l'avenir.",
          explication: "Delphes est l'un des grands sanctuaires communs à tous les Grecs.",
        },
        {
          type: "qcm",
          difficulte: "moyen",
          question: "Quelle bataille navale voit la victoire des Grecs sur les Perses en -480 ?",
          choix: ["Marathon", "Salamine", "Troie", "Actium"],
          bonneReponse: 1,
          explication: "La bataille navale de Salamine, en -480, est une grande victoire grecque lors des guerres médiques.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Qu'est-ce que la trêve sacrée pendant les jeux Olympiques ?",
          reponse: "Une période pendant laquelle les guerres entre cités grecques sont suspendues, afin de permettre à tous de se rendre en sécurité aux jeux Olympiques à Olympie.",
          explication: "Cette trêve illustre l'unité religieuse et culturelle du monde grec malgré ses divisions politiques.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Pourquoi peut-on dire que les Grecs sont polythéistes ?",
          reponse: "Parce qu'ils croient en de nombreux dieux, comme les douze grands dieux de l'Olympe, chacun ayant un domaine particulier (guerre, mer, sagesse, arts...).",
          explication: "Le polythéisme grec s'oppose au monothéisme, qui ne reconnaît qu'un seul dieu.",
        },
        {
          type: "ouverte",
          difficulte: "avance",
          question:
            "Développement construit : explique ce qui unit les cités grecques malgré leur indépendance politique, en t'appuyant sur la religion et les guerres médiques (une quinzaine de lignes).",
          reponse:
            "Introduction : bien que politiquement indépendantes, les cités grecques partagent une identité commune forte. Première partie : elles vénèrent les mêmes dieux polythéistes, résidant selon la légende sur le mont Olympe sous l'autorité de Zeus, et fréquentent des sanctuaires communs comme Delphes, où l'on consulte l'oracle d'Apollon. Deuxième partie : les jeux Olympiques, organisés tous les quatre ans à Olympie en l'honneur de Zeus, rassemblent des athlètes venus de toutes les cités et imposent une trêve sacrée. Troisième partie : face à la menace commune de l'empire perse lors des guerres médiques, plusieurs cités s'unissent et remportent d'importantes victoires, à Marathon en -490 et à Salamine en -480. Conclusion : religion, sanctuaires communs et danger extérieur renforcent ainsi un sentiment d'unité culturelle malgré la fragmentation politique du monde grec.",
          explication: "On attend une explication structurée mobilisant religion, sanctuaires et guerres médiques.",
        },
      ],
    },
  ],
  syntheseRevisions: [
    "Le monde grec (VIIIe-IVe siècle av. J.-C.) est formé de nombreuses cités indépendantes (poleis) autour de la Méditerranée.",
    "Une cité s'organise autour de l'acropole (temples) et de l'agora (place publique).",
    "Athènes invente la démocratie grâce aux réformes de Clisthène (-508) ; seuls les hommes citoyens votent à l'Ecclésia.",
    "Sparte est une cité guerrière dirigée par deux rois, où les garçons deviennent hoplites.",
    "Religion polythéiste : douze dieux de l'Olympe (Zeus), sanctuaires communs (Delphes, Olympie), jeux Olympiques.",
    "Guerres médiques : victoires grecques contre les Perses à Marathon (-490) et Salamine (-480).",
  ],
},
{
  slug: "habiter-littoral",
  titre: "Habiter les littoraux",
  matiere: "histoire-geo",
  niveau: "6eme",
  description:
    "Comprendre pourquoi les littoraux attirent de nombreux habitants et activités (tourisme, ports, industries), et identifier les risques naturels auxquels ces espaces sont exposés, à travers des exemples en France et dans le monde.",
  objectifs: [
    "Comprendre ce qu'est un littoral et pourquoi il attire les populations",
    "Connaître les principales activités présentes sur les littoraux",
    "Comprendre les risques naturels qui menacent les littoraux",
    "Connaître des exemples de littoraux aménagés en France et dans le monde",
    "Comprendre les enjeux d'aménagement et de protection des littoraux",
  ],
  slides: [
    {
      titre: "Qu'est-ce qu'un littoral ?",
      illustration: "🏖️",
      visuel: "Zone de contact terre-mer",
      contenu: [
        "Le littoral est la zone de contact entre la terre et la mer",
        "Il comprend la côte, la plage et parfois des espaces proches en mer",
        "Les littoraux prennent des formes variées : plages, falaises, marais, deltas",
        "Environ 40 % de la population mondiale vit à moins de 100 km d'un littoral",
      ],
      voixOff:
        "Le littoral est la zone de contact entre la terre et la mer. Il peut prendre des formes très variées selon les régions du monde : plages de sable, falaises rocheuses, marais côtiers, ou deltas de fleuves. Ces espaces attirent énormément les populations : on estime qu'environ quarante pour cent des habitants de la planète vivent à moins de cent kilomètres d'un littoral.",
    },
    {
      titre: "Un espace attractif pour le tourisme",
      illustration: "🌊",
      visuel: "Côte d'Azur",
      contenu: [
        "Les littoraux attirent des millions de touristes chaque année",
        "Plages, climat agréable et paysages en font des destinations recherchées",
        "En France, la Côte d'Azur ou le littoral aquitain sont très fréquentés l'été",
        "Le tourisme littoral crée des emplois mais peut saturer certains espaces",
      ],
      voixOff:
        "Grâce à leurs plages, à un climat souvent agréable et à des paysages recherchés, les littoraux attirent chaque année des millions de touristes. En France, la Côte d'Azur ou le littoral aquitain se transforment en véritables destinations de vacances, en particulier pendant l'été. Le tourisme crée de nombreux emplois locaux, mais il peut aussi entraîner une forte concentration de population sur des espaces limités, notamment lors de la haute saison.",
    },
    {
      titre: "Des littoraux tournés vers le commerce mondial",
      illustration: "🚢",
      visuel: "Ports (Rotterdam, Shanghai)",
      contenu: [
        "De nombreux ports se sont développés sur les littoraux du monde entier",
        "Ils permettent le transport par bateau de marchandises entre les continents",
        "Rotterdam (Pays-Bas) et Shanghai (Chine) comptent parmi les plus grands ports du monde",
        "Ces ports emploient de nombreux habitants et stimulent l'économie régionale",
      ],
      voixOff:
        "Les littoraux sont aussi des espaces essentiels pour le commerce mondial. De très grands ports s'y sont développés, permettant de transporter par bateau d'immenses quantités de marchandises entre les continents. Rotterdam, aux Pays-Bas, et Shanghai, en Chine, comptent parmi les plus grands ports du monde. Ces ports emploient de nombreux habitants dans la logistique, l'industrie et les transports, et stimulent fortement l'économie de toute la région.",
    },
    {
      titre: "Les littoraux, espaces d'industries",
      illustration: "🏭",
      visuel: "Zones industrialo-portuaires",
      contenu: [
        "Autour des grands ports se développent souvent des zones industrielles",
        "Ces zones industrialo-portuaires accueillent raffineries, usines et entrepôts",
        "L'accès direct à la mer facilite l'importation des matières premières",
        "Ces industries peuvent aussi provoquer une pollution importante du littoral",
      ],
      voixOff:
        "Autour des grands ports se développent souvent d'importantes zones industrielles, appelées zones industrialo-portuaires, qui accueillent raffineries, usines et entrepôts. L'accès direct à la mer facilite grandement l'importation de matières premières, comme le pétrole. Mais ces activités industrielles peuvent aussi provoquer une pollution importante des eaux et des sols du littoral, ce qui pose de vrais défis environnementaux.",
    },
    {
      titre: "Les risques naturels sur les littoraux",
      illustration: "🌪️",
      visuel: "Submersion, tempêtes",
      contenu: [
        "Les littoraux sont exposés à des risques naturels spécifiques",
        "Tempêtes et fortes marées peuvent provoquer des submersions marines",
        "L'érosion côtière fait reculer certaines falaises et certaines plages",
        "Certaines côtes sont aussi menacées par les tsunamis, notamment en Asie",
      ],
      voixOff:
        "Vivre sur un littoral expose aussi à des risques naturels spécifiques. Les tempêtes, associées à de fortes marées, peuvent provoquer des submersions marines qui inondent les zones basses. L'érosion côtière, quant à elle, fait reculer certaines falaises et certaines plages, année après année. Dans certaines régions, notamment en Asie, les côtes sont également exposées au risque de tsunamis, des vagues gigantesques provoquées par des séismes sous-marins.",
    },
    {
      titre: "La montée des eaux, une menace croissante",
      illustration: "🌡️",
      visuel: "Réchauffement climatique",
      contenu: [
        "Le réchauffement climatique entraîne une élévation du niveau des mers",
        "Certains littoraux très bas, comme aux Pays-Bas, sont particulièrement menacés",
        "Des îles ou des archipels peuvent être menacés de submersion à long terme",
        "Cette menace pousse à repenser l'aménagement de nombreux littoraux",
      ],
      voixOff:
        "Le réchauffement climatique entraîne une élévation progressive du niveau des mers, qui menace de plus en plus les littoraux du monde entier. Certains territoires très bas, comme une grande partie des Pays-Bas, sont particulièrement exposés à ce risque. Certaines îles ou archipels pourraient même être menacés de submersion à plus long terme. Face à cette menace grandissante, de nombreux littoraux doivent repenser leur aménagement pour mieux se protéger.",
    },
    {
      titre: "Protéger et aménager les littoraux",
      illustration: "🧱",
      visuel: "Digues, polders",
      contenu: [
        "Pour se protéger, certains littoraux construisent des digues et des jetées",
        "Aux Pays-Bas, des polders, terres gagnées sur la mer, sont protégés par des digues",
        "D'autres espaces choisissent de laisser la nature reprendre certains terrains (zones tampons)",
        "L'aménagement du littoral doit concilier développement économique et protection",
      ],
      voixOff:
        "Pour se protéger des risques littoraux, les hommes construisent des ouvrages comme des digues ou des jetées. Aux Pays-Bas, de vastes polders, des terres gagnées sur la mer, sont ainsi protégés depuis des siècles par un impressionnant système de digues. Dans d'autres régions, on choisit au contraire de laisser certains terrains redevenir des zones naturelles tampons, capables d'absorber les tempêtes. L'aménagement des littoraux doit donc trouver un équilibre entre développement économique et protection face aux risques naturels.",
    },
    {
      titre: "Ce qu'il faut retenir",
      illustration: "🏆",
      visuel: "📌",
      contenu: [
        "Le littoral, zone de contact terre-mer, attire environ 40 % de la population mondiale",
        "Il concentre tourisme, grands ports mondiaux et zones industrielles",
        "Il est exposé à des risques naturels : submersions, érosion, tsunamis",
        "La montée des eaux, liée au réchauffement climatique, menace de nombreux littoraux",
      ],
      voixOff:
        "Résumons. Le littoral, zone de contact entre la terre et la mer, attire environ quarante pour cent de la population mondiale, grâce au tourisme, aux grands ports mondiaux comme Rotterdam ou Shanghai, et aux zones industrielles qui s'y développent. Mais ces espaces sont aussi exposés à des risques naturels importants : submersions marines, érosion côtière, tsunamis, et de plus en plus, la montée des eaux liée au réchauffement climatique. Face à ces risques, les hommes aménagent et protègent les littoraux grâce à des digues, des polders ou des zones naturelles tampons. Bravo, tu connais l'essentiel de ce chapitre !",
    },
  ],
  fiche: {
    intro:
      "Le littoral, zone de contact entre la terre et la mer, attire une part importante de la population mondiale grâce au tourisme, au commerce et à l'industrie, mais reste exposé à d'importants risques naturels qu'il faut aménager et gérer.",
    sections: [
      {
        titre: "Un espace attractif",
        points: [
          "Environ 40 % de la population mondiale vit à moins de 100 km d'un littoral",
          "Tourisme balnéaire : plages, climat, paysages (Côte d'Azur, littoral aquitain)",
          "Grands ports mondiaux : Rotterdam, Shanghai",
        ],
      },
      {
        titre: "Un espace économique majeur",
        points: [
          "Les ports assurent le transport maritime des marchandises dans le monde",
          "Zones industrialo-portuaires : raffineries, usines, entrepôts",
          "Ces activités créent des emplois mais peuvent polluer le littoral",
        ],
      },
      {
        titre: "Les risques naturels du littoral",
        points: [
          "Submersions marines lors de tempêtes et fortes marées",
          "Érosion côtière : recul des plages et des falaises",
          "Tsunamis dans certaines régions (Asie notamment)",
        ],
      },
      {
        titre: "S'adapter et se protéger",
        points: [
          "Montée du niveau des mers liée au réchauffement climatique",
          "Digues et polders (Pays-Bas) pour protéger les terres basses",
          "Zones tampons naturelles pour absorber les tempêtes",
        ],
      },
    ],
    audio:
      "Fiche de révision : habiter les littoraux. Le littoral est la zone de contact entre la terre et la mer ; environ quarante pour cent de la population mondiale vit à moins de cent kilomètres d'une côte. Ces espaces sont très attractifs pour le tourisme, comme sur la Côte d'Azur en France, mais aussi pour le commerce mondial, grâce à de très grands ports comme Rotterdam aux Pays-Bas ou Shanghai en Chine, autour desquels se développent souvent des zones industrialo-portuaires. Mais habiter un littoral expose aussi à des risques naturels : submersions marines lors de tempêtes, érosion côtière qui fait reculer plages et falaises, et parfois tsunamis, notamment en Asie. Le réchauffement climatique aggrave ces risques en provoquant une montée du niveau des mers, qui menace particulièrement les littoraux les plus bas, comme aux Pays-Bas. Pour se protéger, les hommes construisent des digues, aménagent des polders ou préservent des zones naturelles tampons, afin de concilier développement économique et protection face aux risques.",
  },
  memoCards: [
    { recto: "Qu'est-ce qu'un littoral ?", verso: "La zone de contact entre la terre et la mer." },
    { recto: "Quelle part de la population mondiale vit près d'un littoral ?", verso: "Environ 40 % vit à moins de 100 km d'une côte." },
    { recto: "Cite deux grands ports mondiaux.", verso: "Rotterdam (Pays-Bas) et Shanghai (Chine)." },
    { recto: "Qu'est-ce qu'une zone industrialo-portuaire ?", verso: "Une zone industrielle (raffineries, usines) développée autour d'un grand port." },
    { recto: "Qu'est-ce que la submersion marine ?", verso: "L'inondation d'une zone côtière basse par la mer, souvent lors d'une tempête." },
    { recto: "Qu'est-ce que l'érosion côtière ?", verso: "Le recul progressif des plages ou des falaises sous l'effet de la mer." },
    { recto: "Qu'est-ce qu'un polder ?", verso: "Une terre gagnée sur la mer, protégée par des digues, notamment aux Pays-Bas." },
    { recto: "Pourquoi le niveau des mers monte-t-il ?", verso: "À cause du réchauffement climatique, qui fait fondre les glaces et dilate les océans." },
  ],
  exercices: [
    {
      type: "qcm",
      ...
      choix: ["Une chaîne de montagnes", "La zone de contact entre la terre et la mer", "Un désert", "Une forêt tropicale"],
      bonneReponse: 1,
      explication: "Le littoral comprend la côte, la plage et les espaces proches de la mer.",
    },
    {
      type: "qcm",
      difficulte: "facile",
      question: "Quelle activité touristique se développe fortement sur les littoraux ?",
      choix: ["Le ski", "Le tourisme balnéaire (plages)", "La randonnée en montagne", "La visite de déserts"],
      bonneReponse: 1,
      explication: "Les plages et le climat attirent de nombreux touristes sur les littoraux, comme la Côte d'Azur.",
    },
    {
      type: "ouverte",
      difficulte: "facile",
      question: "Cite un grand port mondial situé sur un littoral.",
      reponse: "Rotterdam (ou Shanghai).",
      explication: "Ces ports permettent le commerce maritime international.",
    },
    {
      type: "qcm",
      difficulte: "facile",
      question: "Quel risque naturel est lié aux tempêtes sur le littoral ?",
      choix: ["La sécheresse", "La submersion marine", "Les incendies de forêt", "Les avalanches"],
      bonneReponse: 1,
      explication: "Les tempêtes associées à de fortes marées peuvent provoquer des submersions marines.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Qu'est-ce que l'érosion côtière ?",
      choix: ["La construction de ports", "Le recul progressif des plages et des falaises", "L'augmentation du tourisme", "La pollution de l'air"],
      bonneReponse: 1,
      explication: "L'érosion côtière est un phénomène naturel qui peut être accéléré par les activités humaines.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Pourquoi les grands ports se développent-ils sur les littoraux ?",
      reponse: "Parce que l'accès direct à la mer permet de transporter par bateau d'immenses quantités de marchandises entre les continents, ce qui facilite le commerce mondial.",
      explication: "Rotterdam et Shanghai comptent parmi les plus grands ports du monde.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Qu'est-ce qu'un polder et où en trouve-t-on de nombreux exemples ?",
      reponse: "Un polder est une terre gagnée sur la mer, protégée par des digues. On en trouve de nombreux exemples aux Pays-Bas.",
      explication: "Les polders permettent d'habiter et de cultiver des terres autrefois recouvertes par la mer.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Quel phénomène climatique aggrave la montée du niveau des mers ?",
      choix: ["La déforestation", "Le réchauffement climatique", "La pollution de l'air uniquement", "L'urbanisation"],
      bonneReponse: 1,
      explication: "Le réchauffement climatique fait fondre les glaces et dilate l'eau des océans, ce qui élève leur niveau.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Explique pourquoi les littoraux sont des espaces à la fois attractifs et exposés à des risques.",
      reponse:
        "Ils sont attractifs car ils offrent des opportunités économiques (tourisme, commerce maritime, industrie) et un cadre de vie recherché. Mais ils sont aussi exposés à des risques naturels comme les submersions marines, l'érosion côtière ou les tsunamis, aggravés par le réchauffement climatique et la montée des eaux.",
      explication: "Cette double réalité oblige les sociétés à aménager les littoraux avec précaution.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Comment les hommes tentent-ils de protéger les littoraux face aux risques naturels ?",
      reponse:
        "Ils construisent des ouvrages de protection comme des digues ou des jetées, aménagent des polders protégés par des digues (comme aux Pays-Bas), et dans certains cas préservent des zones naturelles tampons capables d'absorber une partie des tempêtes.",
      explication: "Ces solutions combinent souvent aménagements techniques et solutions fondées sur la nature.",
    },
    {
      type: "qcm",
      difficulte: "avance",
      question: "Pourquoi les zones industrialo-portuaires se développent-elles près des grands ports ?",
      choix: [
        "Pour être loin de la mer",
        "Pour faciliter l'importation de matières premières grâce à l'accès direct à la mer",
        "Pour éviter toute pollution",
        "Parce que la loi l'impose partout",
      ],
      bonneReponse: 1,
      explication: "L'accès direct à la mer facilite le transport et l'importation de matières premières comme le pétrole.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Pourquoi certains littoraux, comme aux Pays-Bas, sont-ils particulièrement menacés par la montée des eaux ?",
      reponse:
        "Parce que ce sont des territoires très bas, parfois situés en dessous du niveau de la mer, gagnés sur celle-ci grâce à des polders et protégés par des digues ; une élévation du niveau des mers augmente donc fortement le risque de submersion pour ces territoires.",
      explication: "C'est pourquoi les Pays-Bas investissent massivement dans des systèmes de protection contre la mer.",
    },
  ],
  revisionFinChapitre: [
    {
      type: "qcm",
      difficulte: "facile",
      question: "Quelle part de la population mondiale vit à moins de 100 km d'un littoral ?",
      choix: ["10 %", "40 %", "80 %", "100 %"],
      bonneReponse: 1,
      explication: "Environ 40 % des habitants de la planète vivent près d'un littoral.",
    },
    {
      type: "ouverte",
      difficulte: "facile",
      question: "Cite un exemple de littoral touristique en France.",
      reponse: "La Côte d'Azur (ou le littoral aquitain).",
      explication: "Ces littoraux attirent de nombreux touristes, surtout en été.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Qu'est-ce qu'une submersion marine ?",
      reponse: "L'inondation d'une zone côtière basse par la mer, souvent lors d'une tempête associée à de fortes marées.",
      explication: "Ce risque menace particulièrement les zones littorales de faible altitude.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Quel pays est connu pour ses polders protégés par des digues ?",
      choix: ["Le Japon", "Les Pays-Bas", "L'Égypte", "Le Nigeria"],
      bonneReponse: 1,
      explication: "Les Pays-Bas ont gagné de nombreuses terres sur la mer grâce aux polders.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "En une phrase, explique pourquoi le littoral est un espace à aménager avec précaution.",
      reponse: "Parce qu'il concentre de nombreuses activités humaines (tourisme, ports, industries) tout en étant exposé à des risques naturels comme la submersion, l'érosion ou les tsunamis.",
      explication: "Cette double contrainte oblige à des choix d'aménagement réfléchis.",
    },
  ],
  examens: [
    {
      titre: "Examen 1 — Habiter les littoraux",
      dureeMinutes: 20,
      questions: [
        {
          type: "qcm",
          difficulte: "facile",
          question: "Qu'est-ce que le littoral ?",
          choix: ["Une zone désertique", "La zone de contact entre la terre et la mer", "Une chaîne de montagnes", "Un fleuve"],
          bonneReponse: 1,
          explication: "Le littoral inclut la côte, la plage et les espaces proches de la mer.",
        },
        {
          type: "ouverte",
          difficulte: "facile",
          question: "Pourquoi de nombreux touristes se rendent-ils sur les littoraux ?",
          reponse: "Pour profiter des plages, du climat agréable et des paysages, notamment pendant les vacances d'été.",
          explication: "Le tourisme balnéaire est l'une des principales activités des littoraux.",
        },
        {
          type: "qcm",
          difficulte: "moyen",
          question: "Quel type d'espace se développe souvent autour des grands ports ?",
          choix: ["Des zones agricoles", "Des zones industrialo-portuaires", "Des forêts protégées", "Des déserts"],
          bonneReponse: 1,
          explication: "Ces zones accueillent raffineries, usines et entrepôts, profitant de l'accès direct à la mer.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Cite deux risques naturels qui menacent les littoraux.",
          reponse: "Par exemple : la submersion marine (lors de tempêtes) et l'érosion côtière (qui fait reculer plages et falaises). On peut aussi citer les tsunamis.",
          explication: "Ces risques rendent l'aménagement des littoraux particulièrement complexe.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Comment le réchauffement climatique affecte-t-il les littoraux ?",
          reponse: "Il provoque une élévation du niveau des mers, ce qui augmente le risque de submersion, en particulier pour les littoraux les plus bas comme aux Pays-Bas.",
          explication: "Cette menace pousse à repenser l'aménagement de nombreux littoraux dans le monde.",
        },
        {
          type: "ouverte",
          difficulte: "avance",
          question:
            "Développement construit : explique pourquoi les littoraux sont des espaces très attractifs pour les activités humaines (une quinzaine de lignes).",
          reponse:
            "Introduction : les littoraux, zones de contact entre terre et mer, concentrent environ 40 % de la population mondiale et de nombreuses activités humaines. Première partie : ils attirent d'abord le tourisme, grâce aux plages et aux paysages, comme sur la Côte d'Azur en France. Deuxième partie : ils sont aussi essentiels au commerce mondial grâce à de grands ports comme Rotterdam ou Shanghai, qui permettent le transport maritime de marchandises entre les continents. Troisième partie : autour de ces ports se développent des zones industrialo-portuaires, qui profitent de l'accès direct à la mer pour importer des matières premières. Conclusion : cette forte concentration d'activités rend cependant les littoraux vulnérables aux risques naturels, ce qui impose de les aménager avec précaution.",
          explication: "Un bon développement distingue clairement tourisme, commerce et industrie comme facteurs d'attractivité.",
        },
      ],
    },
    {
      titre: "Examen 2 — Habiter les littoraux",
      dureeMinutes: 20,
      questions: [
        {
          type: "qcm",
          difficulte: "facile",
          question: "Quel est l'un des plus grands ports du monde, situé aux Pays-Bas ?",
          choix: ["Shanghai", "Rotterdam", "Marseille", "Le Havre"],
          bonneReponse: 1,
          explication: "Rotterdam est l'un des plus grands ports d'Europe et du monde.",
        },
        {
          type: "ouverte",
          difficulte: "facile",
          question: "Qu'est-ce qu'un polder ?",
          reponse: "Une terre gagnée sur la mer, protégée par des digues.",
          explication: "Les polders sont typiques des Pays-Bas.",
        },
        {
          type: "qcm",
          difficulte: "moyen",
          question: "Quel phénomène décrit le recul progressif des plages et des falaises ?",
          choix: ["La submersion marine", "L'érosion côtière", "L'urbanisation", "La désertification"],
          bonneReponse: 1,
          explication: "L'érosion côtière peut être accentuée par les activités humaines et le changement climatique.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Pourquoi les zones industrialo-portuaires peuvent-elles poser un problème environnemental ?",
          reponse: "Parce que les activités industrielles (raffineries, usines) qui s'y installent peuvent polluer les eaux et les sols du littoral.",
          explication: "Ces pollutions posent des défis pour la protection de l'environnement littoral.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Quelles solutions les hommes utilisent-ils pour protéger les littoraux menacés ?",
          reponse: "La construction de digues et de jetées, l'aménagement de polders protégés, ou la préservation de zones naturelles tampons capables d'absorber les tempêtes.",
          explication: "Ces solutions combinent souvent aménagement technique et protection de la nature.",
        },
        {
          type: "ouverte",
          difficulte: "avance",
          question:
            "Développement construit : explique quels risques naturels menacent les littoraux et comment les sociétés s'y adaptent (une quinzaine de lignes).",
          reponse:
            "Introduction : très attractifs, les littoraux sont aussi des espaces exposés à d'importants risques naturels que les sociétés doivent gérer. Première partie : les tempêtes et les fortes marées peuvent provoquer des submersions marines, tandis que l'érosion côtière fait reculer plages et falaises ; dans certaines régions, comme en Asie, les tsunamis représentent un danger supplémentaire. Deuxième partie : le réchauffement climatique aggrave ces risques en élevant le niveau des mers, ce qui menace particulièrement les littoraux les plus bas, comme aux Pays-Bas. Troisième partie : pour s'adapter, les sociétés construisent des digues et des polders, ou préservent des zones naturelles tampons capables d'absorber une partie des tempêtes. Conclusion : habiter un littoral suppose donc de concilier développement économique et protection face à des risques naturels appelés à s'intensifier.",
          explication: "On attend une explication organisée reliant risques naturels et solutions d'adaptation.",
        },
      ],
    },
  ],
  syntheseRevisions: [
    "Le littoral est la zone de contact entre la terre et la mer ; environ 40 % de la population mondiale y vit à proximité.",
    "Les littoraux attirent le tourisme (Côte d'Azur) et concentrent de grands ports mondiaux (Rotterdam, Shanghai).",
    "Des zones industrialo-portuaires se développent autour des ports, avec un risque de pollution.",
    "Les littoraux sont exposés à des risques naturels : submersions marines, érosion côtière, tsunamis.",
    "Le réchauffement climatique aggrave la montée du niveau des mers, menaçant les littoraux les plus bas (Pays-Bas).",
    "Les hommes protègent les littoraux grâce à des digues, des polders ou des zones naturelles tampons.",
  ],
},
{
  ...
  niveau: "6eme",
  description:
    "Découvrir ce qu'est une métropole, comprendre pourquoi de plus en plus d'habitants de la planète y vivent, et étudier l'organisation de l'espace urbain à travers des exemples comme Paris, Tokyo ou Lagos.",
  objectifs: [
    "Définir ce qu'est une métropole et connaître le processus d'urbanisation",
    "Comprendre l'organisation de l'espace dans une métropole (centre, périphérie)",
    "Connaître des exemples de métropoles dans le monde et leurs spécificités",
    "Comprendre les avantages et les difficultés d'habiter une métropole",
    "Comprendre les enjeux de la mobilité et des inégalités urbaines",
  ],
  slides: [
    {
      titre: "Qu'est-ce qu'une métropole ?",
      illustration: "🏙️",
      visuel: "> 1 million d'habitants",
      contenu: [
        "Une métropole est une très grande ville qui concentre pouvoirs et populations",
        "Elle rassemble souvent plusieurs centaines de milliers, voire millions, d'habitants",
        "Elle concentre des fonctions de commandement : politique, économique, culturel",
        "Une métropole s'étend bien au-delà de son centre-ville, avec sa banlieue et ses périphéries",
      ],
      voixOff:
        "Une métropole est une très grande ville qui concentre à la fois une population nombreuse et des fonctions de commandement importantes : sièges de gouvernement, grandes entreprises, universités, aéroports internationaux. Une métropole ne se limite pas à son centre-ville : elle s'étend sur un vaste espace comprenant sa banlieue et ses périphéries, parfois habitées par plusieurs millions de personnes au total.",
    },
    {
      titre: "Le monde de plus en plus urbain",
      illustration: "📈",
      visuel: "Plus de 55% en ville",
      contenu: [
        "Depuis 2007, plus de la moitié des habitants de la planète vit en ville",
        "Ce processus, appelé urbanisation, s'accélère depuis le XXe siècle",
        "L'exode rural pousse de nombreux habitants des campagnes vers les villes",
        "Les métropoles attirent en cherchant emplois, études et meilleurs services",
      ],
      voixOff:
        "Depuis deux mille sept, plus de la moitié de la population mondiale vit désormais en ville : c'est ce qu'on appelle l'urbanisation. Ce mouvement s'est fortement accéléré depuis le vingtième siècle. De nombreux habitants quittent les campagnes pour s'installer en ville, un phénomène appelé exode rural, à la recherche d'un emploi, de meilleures études, ou de services comme les hôpitaux, qu'ils espèrent trouver plus facilement dans les grandes métropoles.",
    },
    {
      titre: "Le centre d'une métropole",
      illustration: "🏢",
      visuel: "Quartier des affaires",
      contenu: [
        "Le centre-ville concentre souvent les commerces, bureaux et monuments historiques",
        "Dans certaines métropoles, un quartier d'affaires regroupe de hautes tours (gratte-ciel)",
        "Le foncier (prix des terrains) y est très élevé, en raison de la forte demande",
        "Les logements y sont souvent plus petits et plus chers qu'en périphérie",
      ],
      voixOff:
        "Le centre d'une métropole concentre souvent les commerces, les bureaux et les monuments historiques les plus prestigieux. Dans de nombreuses métropoles, un quartier d'affaires spécifique regroupe de hautes tours, appelées gratte-ciel, comme à La Défense à Paris ou à Manhattan à New York. Le prix des terrains y est très élevé en raison de la forte demande, ce qui rend les logements souvent plus petits et plus coûteux qu'en périphérie.",
    },
    {
      titre: "La périphérie et l'étalement urbain",
      illustration: "🏡",
      visuel: "Banlieue, périurbain",
      contenu: [
        "Autour du centre s'étendent la banlieue puis les espaces périurbains",
        "L'étalement urbain désigne l'extension continue de la ville sur les espaces alentour",
        "De nombreux habitants choisissent la périphérie pour un logement plus grand et moins cher",
        "Cet étalement pose des questions d'environnement (artificialisation des sols agricoles)",
      ],
      voixOff:
        "Au-delà du centre s'étendent la banlieue, puis des espaces de plus en plus éloignés appelés espaces périurbains. On parle d'étalement urbain pour désigner cette extension continue de la ville sur les terres environnantes. De nombreux habitants choisissent de s'y installer pour bénéficier d'un logement plus grand et moins cher, souvent une maison individuelle. Mais cet étalement pose des problèmes environnementaux, en particulier l'artificialisation de terres auparavant agricoles ou naturelles.",
    },
    {
      titre: "Se déplacer dans une métropole",
      illustration: "🚇",
      visuel: "Métro, tramway",
      contenu: [
        "Les métropoles développent des transports en commun (métro, tramway, bus)",
        "Ces transports permettent de relier le centre aux périphéries et banlieues",
        "Malgré cela, la circulation automobile provoque souvent des embouteillages",
        "Les déplacements quotidiens domicile-travail sont appelés « migrations pendulaires »",
      ],
      voixOff:
        "Pour permettre à des millions d'habitants de se déplacer chaque jour, les métropoles développent des réseaux de transports en commun : métro, tramway, bus, parfois trains de banlieue. Ces transports relient le centre aux banlieues et aux espaces périurbains. Mais malgré ces efforts, la circulation automobile reste souvent très dense et provoque des embouteillages. Les déplacements quotidiens entre le domicile et le lieu de travail sont appelés « migrations pendulaires », car ils se répètent chaque jour dans les deux sens.",
    },
    {
      titre: "Des métropoles dans le monde entier",
      illustration: "🌏",
      visuel: "Tokyo, Lagos, New York",
      contenu: [
        "Tokyo, au Japon, est l'une des plus grandes métropoles du monde",
        "Lagos, au Nigeria, connaît une croissance urbaine très rapide en Afrique",
        "New York et Paris sont des métropoles majeures aux fonctions internationales",
        "Ces métropoles se ressemblent (centre, périphérie) mais ont chacune leurs particularités",
      ],
      voixOff:
        "Les métropoles existent sur tous les continents. Tokyo, au Japon, avec son agglomération de plusieurs dizaines de millions d'habitants, est l'une des plus grandes du monde. Lagos, au Nigeria, connaît quant à elle une croissance urbaine extrêmement rapide, typique de nombreuses villes africaines. New York et Paris, elles, sont des métropoles aux fonctions internationales majeures, dans les domaines financier, politique et culturel. Toutes partagent une organisation en centre et périphérie, mais chacune garde ses propres particularités.",
    },
    {
      titre: "Des inégalités au sein des métropoles",
      illustration: "⚖️",
      visuel: "Quartiers riches / pauvres",
      contenu: [
        "Toutes les métropoles connaissent des inégalités entre quartiers",
        "Certains quartiers concentrent richesse, commerces et bons équipements",
        "D'autres quartiers, souvent en périphérie, connaissent davantage de pauvreté",
        "Dans certaines métropoles du Sud, des bidonvilles se développent en périphérie",
      ],
      voixOff:
        "Habiter une métropole, ce n'est pas vivre la même expérience partout : de fortes inégalités existent entre les quartiers. Certains concentrent la richesse, les commerces de luxe et les meilleurs équipements, tandis que d'autres, souvent situés en périphérie, connaissent davantage de pauvreté et de difficultés d'accès aux services. Dans certaines métropoles des pays du Sud, comme Lagos ou Mumbai, des bidonvilles, quartiers d'habitat précaire, se développent en périphérie faute de logements suffisants.",
    },
    {
      titre: "Ce qu'il faut retenir",
      illustration: "🏆",
      visuel: "📌",
      contenu: [
        "Une métropole concentre population nombreuse et fonctions de commandement",
        "Depuis 2007, plus de la moitié de l'humanité vit en ville",
        "Une métropole s'organise en centre (cher, dense) et périphérie (étalement urbain)",
        "Transports, mobilité et inégalités sont des enjeux majeurs des métropoles",
      ],
      voixOff:
        "Résumons. Une métropole est une très grande ville qui concentre à la fois une population nombreuse et des fonctions de commandement importantes. Depuis deux mille sept, plus de la moitié de l'humanité vit en ville, un mouvement appelé urbanisation. Une métropole s'organise généralement autour d'un centre dense et coûteux, entouré de périphéries en constante extension : c'est l'étalement urbain. Les transports en commun sont essentiels pour permettre les déplacements quotidiens, mais des inégalités importantes subsistent entre les différents quartiers. Bravo, tu connais l'essentiel de ce chapitre !",
    },
  ],
  fiche: {
    intro:
      "Depuis 2007, plus de la moitié de l'humanité vit en ville. Les métropoles, très grandes villes qui concentrent population et fonctions de commandement, s'organisent en centre et périphérie et connaissent des enjeux communs de mobilité et d'inégalités.",
    sections: [
      {
        titre: "Qu'est-ce qu'une métropole ?",
        points: [
          "Une très grande ville qui concentre population nombreuse et fonctions de commandement",
          "Urbanisation : depuis 2007, plus de la moitié des habitants du monde vit en ville",
          "L'exode rural alimente la croissance des métropoles",
        ],
      },
      {
        titre: "L'organisation de l'espace urbain",
        points: [
          "Centre : commerces, bureaux, quartiers d'affaires (gratte-ciel), foncier cher",
          "Périphérie : banlieue, espaces périurbains, étalement urbain",
          "Étalement urbain : artificialisation des sols agricoles et naturels",
        ],
      },
      {
        titre: "Se déplacer et vivre dans une métropole",
        points: [
          "Transports en commun (métro, tramway, bus) pour relier centre et périphérie",
          "Migrations pendulaires : déplacements quotidiens domicile-travail",
          "Exemples de métropoles : Paris, Tokyo, Lagos, New York",
        ],
      },
      {
        titre: "Les inégalités dans les métropoles",
        points: [
          "Quartiers riches (commerces, équipements) et quartiers plus pauvres",
          "Bidonvilles en périphérie de certaines métropoles du Sud (Lagos, Mumbai)",
          "Des enjeux d'accès au logement et aux services pour tous les habitants",
        ],
      },
    ],
    audio:
      "Fiche de révision : habiter une métropole. Une métropole est une très grande ville qui concentre à la fois une population nombreuse et des fonctions de commandement : sièges politiques, grandes entreprises, universités. Depuis deux mille sept, plus de la moitié de l'humanité vit en ville, un mouvement appelé urbanisation, alimenté notamment par l'exode rural. Une métropole s'organise en un centre dense, où le prix des terrains est élevé, avec parfois un quartier d'affaires aux nombreux gratte-ciel, et des périphéries de plus en plus étendues, un phénomène appelé étalement urbain. Pour permettre les déplacements quotidiens entre domicile et travail, appelés migrations pendulaires, les métropoles développent des transports en commun comme le métro ou le tramway. Des métropoles comme Paris, Tokyo, Lagos ou New York existent sur tous les continents, mais toutes connaissent aussi de fortes inégalités entre quartiers riches et quartiers plus pauvres, parfois marqués par des bidonvilles en périphérie.",
  },
  memoCards: [
    { recto: "Qu'est-ce qu'une métropole ?", verso: "Une très grande ville qui concentre une population nombreuse et des fonctions de commandement." },
    { recto: "Qu'est-ce que l'urbanisation ?", verso: "Le processus par lequel une part croissante de la population mondiale vit en ville." },
    { recto: "Depuis quand plus de la moitié de l'humanité vit-elle en ville ?", verso: "Depuis 2007." },
    { recto: "Qu'est-ce que l'exode rural ?", verso: "Le départ d'habitants des campagnes vers les villes." },
    { recto: "Qu'est-ce que l'étalement urbain ?", verso: "L'extension continue d'une ville sur les espaces environnants (périurbains, agricoles)." },
    { recto: "Qu'est-ce qu'une migration pendulaire ?", verso: "Un déplacement quotidien répété entre le domicile et le lieu de travail ou d'études." },
    { recto: "Cite trois métropoles mondiales.", verso: "Par exemple Paris, Tokyo, Lagos ou New York." },
    { recto: "Qu'est-ce qu'un bidonville ?", verso: "Un quartier d'habitat précaire, souvent situé en périphérie des métropoles des pays du Sud." },
  ],
  exercices: [
    {
      type: "qcm",
      ...
      choix: ["Un petit village", "Une très grande ville qui concentre population et pouvoirs", "Une région agricole", "Un pays entier"],
      bonneReponse: 1,
      explication: "Une métropole concentre à la fois une population nombreuse et des fonctions de commandement.",
    },
    {
      type: "qcm",
      difficulte: "facile",
      question: "Depuis quelle année plus de la moitié de la population mondiale vit-elle en ville ?",
      choix: ["1900", "1950", "2007", "2050"],
      bonneReponse: 2,
      explication: "Ce seuil symbolique a été franchi en 2007.",
    },
    {
      type: "ouverte",
      difficulte: "facile",
      question: "Qu'est-ce que l'exode rural ?",
      reponse: "Le départ d'habitants des campagnes pour s'installer en ville.",
      explication: "L'exode rural est l'un des principaux moteurs de la croissance des métropoles.",
    },
    {
      type: "qcm",
      difficulte: "facile",
      question: "Comment appelle-t-on un quartier regroupant de hautes tours de bureaux dans une métropole ?",
      choix: ["Un bidonville", "Un quartier d'affaires", "Une banlieue", "Un espace périurbain"],
      bonneReponse: 1,
      explication: "Le quartier d'affaires concentre souvent gratte-ciel et sièges d'entreprises.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Qu'est-ce que l'étalement urbain ?",
      choix: ["La diminution de la taille des villes", "L'extension continue de la ville sur les espaces environnants", "La construction de gratte-ciel", "Le développement du métro"],
      bonneReponse: 1,
      explication: "L'étalement urbain gagne sur les espaces périurbains, souvent au détriment des terres agricoles.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Pourquoi le prix des terrains est-il souvent très élevé au centre des métropoles ?",
      reponse: "Parce que la demande de logements et de locaux commerciaux y est très forte, alors que l'espace disponible est limité.",
      explication: "Ce phénomène explique pourquoi les logements y sont souvent plus petits et plus chers qu'en périphérie.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Qu'est-ce qu'une migration pendulaire ?",
      reponse: "Un déplacement quotidien, répété chaque jour dans les deux sens, entre le domicile et le lieu de travail ou d'études.",
      explication: "Ces déplacements expliquent les embouteillages et l'affluence dans les transports en commun aux heures de pointe.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Quelle métropole africaine connaît une croissance urbaine particulièrement rapide ?",
      choix: ["Tokyo", "Lagos", "Paris", "New York"],
      bonneReponse: 1,
      explication: "Lagos, au Nigeria, est l'une des métropoles à la croissance la plus rapide au monde.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Explique pourquoi les métropoles développent des réseaux de transports en commun.",
      reponse:
        "Parce qu'un grand nombre d'habitants doivent se déplacer chaque jour entre leur domicile, souvent en périphérie, et leur lieu de travail ou d'études, souvent au centre. Les transports en commun (métro, tramway, bus) permettent de limiter les embouteillages et la pollution liés à l'usage de la voiture individuelle.",
      explication: "Ces transports sont un enjeu majeur d'organisation et d'environnement pour les métropoles.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Quelles inégalités peut-on observer entre les quartiers d'une métropole ?",
      reponse:
        "Certains quartiers, souvent centraux ou bien situés, concentrent richesse, commerces de qualité et bons équipements (écoles, hôpitaux, transports), tandis que d'autres quartiers, parfois en périphérie, connaissent davantage de pauvreté, un habitat plus précaire, voire des bidonvilles dans certaines métropoles du Sud.",
      explication: "Ces inégalités posent des questions d'accès aux services et de justice sociale dans les métropoles.",
    },
    {
      type: "qcm",
      difficulte: "avance",
      question: "Que désigne le terme « fonctions de commandement » d'une métropole ?",
      choix: [
        "Le fait d'avoir une armée",
        "La concentration de pouvoirs politiques, économiques ou culturels importants",
        "Le nombre d'habitants uniquement",
        "La présence de bidonvilles",
      ],
      bonneReponse: 1,
      explication: "Sièges de gouvernement, grandes entreprises, universités : ces fonctions distinguent une métropole d'une simple grande ville.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Pourquoi peut-on dire qu'habiter une métropole présente à la fois des avantages et des difficultés ?",
      reponse:
        "Les avantages incluent l'accès à de nombreux emplois, services, transports et loisirs. Les difficultés comprennent le coût élevé du logement, les embouteillages, la pollution, et les inégalités entre quartiers riches et quartiers plus pauvres.",
      explication: "Cette double réalité explique la diversité des expériences vécues par les habitants d'une même métropole.",
    },
  ],
  revisionFinChapitre: [
    {
      ...
      choix: ["La disparition des villes", "Le fait qu'une part croissante de la population vit en ville", "La construction de fermes", "Le développement de l'agriculture"],
      bonneReponse: 1,
      explication: "L'urbanisation désigne la croissance de la population urbaine dans le monde.",
    },
    {
      type: "ouverte",
      difficulte: "facile",
      question: "Nomme deux métropoles dans le monde.",
      reponse: "Par exemple Paris et Tokyo (ou Lagos, New York).",
      explication: "Ces métropoles concentrent population et fonctions de commandement importantes.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Comment s'appelle le déplacement quotidien entre domicile et travail ?",
      reponse: "La migration pendulaire.",
      explication: "Ce déplacement se répète chaque jour, dans les deux sens.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Qu'est-ce qu'un bidonville ?",
      choix: ["Un quartier d'affaires", "Un quartier d'habitat précaire", "Un parc naturel", "Un centre commercial"],
      bonneReponse: 1,
      explication: "Les bidonvilles se développent souvent en périphérie des métropoles du Sud, faute de logements suffisants.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "En une phrase, explique comment s'organise l'espace d'une métropole.",
      reponse: "Elle s'organise autour d'un centre dense et coûteux, entouré de banlieues puis d'espaces périurbains de plus en plus étendus.",
      explication: "Cette organisation en centre et périphérie se retrouve dans la plupart des métropoles du monde.",
    },
  ],
  examens: [
    {
      titre: "Examen 1 — Habiter une métropole",
      dureeMinutes: 20,
      questions: [
        {
          type: "qcm",
          difficulte: "facile",
          question: "Que concentre une métropole, en plus d'une population nombreuse ?",
          choix: ["Des terres agricoles", "Des fonctions de commandement (politique, économique, culturel)", "Uniquement des usines", "Rien de particulier"],
          bonneReponse: 1,
          explication: "Une métropole se distingue d'une simple grande ville par ces fonctions de commandement.",
        },
        {
          type: "ouverte",
          difficulte: "facile",
          question: "Qu'est-ce que l'exode rural ?",
          reponse: "Le départ d'habitants des campagnes vers les villes, à la recherche d'emplois ou de meilleurs services.",
          explication: "L'exode rural alimente fortement la croissance des métropoles, en particulier dans les pays en développement.",
        },
        {
          type: "qcm",
          difficulte: "moyen",
          question: "Pourquoi le logement est-il souvent plus cher au centre d'une métropole qu'en périphérie ?",
          choix: [
            "Parce que les logements y sont plus grands",
            "Parce que la demande y est forte et l'espace limité",
            "Parce que les transports n'y existent pas",
            "Parce que les impôts y sont plus bas",
          ],
          bonneReponse: 1,
          explication: "La rareté du foncier au centre explique la forte hausse des prix de l'immobilier.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Explique ce qu'est l'étalement urbain et une de ses conséquences.",
          reponse: "L'étalement urbain est l'extension continue d'une ville sur les espaces qui l'entourent. Il entraîne notamment l'artificialisation de terres agricoles ou naturelles, au détriment de l'environnement.",
          explication: "L'étalement urbain est un enjeu environnemental majeur pour de nombreuses métropoles.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Pourquoi les métropoles développent-elles des transports en commun ?",
          reponse: "Pour permettre à un grand nombre d'habitants de se déplacer chaque jour entre leur domicile et leur lieu de travail ou d'études, tout en limitant les embouteillages et la pollution liés à la voiture individuelle.",
          explication: "Le métro, le tramway et le bus sont des exemples de transports en commun urbains.",
        },
        {
          type: "ouverte",
          difficulte: "avance",
          question:
            "Développement construit : explique comment s'organise l'espace d'une métropole, du centre à la périphérie (une quinzaine de lignes).",
          reponse:
            "Introduction : habiter une métropole, c'est vivre dans un espace organisé selon une logique de centre et de périphérie. Première partie : le centre-ville concentre souvent commerces, bureaux, monuments historiques et parfois un quartier d'affaires aux nombreux gratte-ciel ; le prix des terrains y est très élevé. Deuxième partie : au-delà du centre s'étendent la banlieue puis des espaces périurbains de plus en plus éloignés, un phénomène appelé étalement urbain, qui gagne parfois sur des terres agricoles. Troisième partie : pour relier ces différents espaces, les métropoles développent des transports en commun (métro, tramway, bus), essentiels aux migrations pendulaires quotidiennes entre domicile et travail. Conclusion : cette organisation en centre et périphérie se retrouve dans la plupart des métropoles du monde, malgré leurs différences culturelles et géographiques.",
          explication: "Un bon développement organise clairement centre, périphérie et transports.",
        },
      ],
    },
    {
      titre: "Examen 2 — Habiter une métropole",
      dureeMinutes: 20,
      questions: [
        {
          type: "qcm",
          difficulte: "facile",
          question: "Comment appelle-t-on les déplacements quotidiens entre domicile et travail ?",
          choix: ["L'exode rural", "Les migrations pendulaires", "L'étalement urbain", "L'urbanisation"],
          bonneReponse: 1,
          explication: "Les migrations pendulaires se répètent chaque jour, dans les deux sens.",
        },
        {
          type: "ouverte",
          difficulte: "facile",
          question: "Cite un exemple de transport en commun utilisé dans les métropoles.",
          reponse: "Le métro (ou le tramway, le bus).",
          explication: "Ces transports permettent de relier le centre aux périphéries.",
        },
        {
          type: "qcm",
          difficulte: "moyen",
          question: "Qu'est-ce qu'un bidonville ?",
          choix: ["Un quartier d'affaires luxueux", "Un quartier d'habitat précaire, souvent en périphérie", "Un espace agricole", "Un centre historique"],
          bonneReponse: 1,
          explication: "Les bidonvilles se développent notamment dans certaines métropoles des pays du Sud, comme Lagos ou Mumbai.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Pourquoi peut-on dire que toutes les métropoles ne se ressemblent pas totalement ?",
          reponse: "Parce que si elles partagent une organisation en centre et périphérie, chacune a ses propres caractéristiques culturelles, économiques et démographiques : Tokyo, Lagos, Paris ou New York ont des histoires et des fonctions différentes.",
          explication: "Chaque métropole s'inscrit dans un contexte géographique et historique particulier.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Quelles difficultés certains habitants rencontrent-ils dans les métropoles ?",
          reponse: "Le coût élevé du logement, les embouteillages, la pollution, ou encore l'habitat précaire dans certains quartiers, en particulier dans des bidonvilles.",
          explication: "Ces difficultés touchent en particulier les populations les plus pauvres des métropoles.",
        },
        {
          type: "ouverte",
          difficulte: "avance",
          question:
            "Développement construit : explique pourquoi de plus en plus d'habitants de la planète vivent dans des métropoles et quels enjeux cela pose (une quinzaine de lignes).",
          reponse:
            "Introduction : depuis 2007, plus de la moitié de l'humanité vit en ville, et cette urbanisation continue de s'accélérer. Première partie : l'exode rural pousse de nombreux habitants des campagnes vers les métropoles, à la recherche d'emplois, d'études ou de meilleurs services (santé, éducation). Deuxième partie : cette croissance urbaine pose des enjeux d'organisation : étalement urbain, besoin de transports en commun efficaces pour les migrations pendulaires, et pression sur le logement au centre. Troisième partie : elle entraîne aussi des inégalités importantes entre quartiers riches et quartiers plus pauvres, avec parfois l'apparition de bidonvilles dans certaines métropoles du Sud. Conclusion : habiter une métropole présente donc à la fois des opportunités et des défis, qui varient selon les quartiers et les continents.",
          explication: "On attend une explication structurée reliant causes de l'urbanisation et enjeux qui en découlent.",
        },
      ],
    },
  ],
  syntheseRevisions: [
    "Une métropole concentre une population nombreuse et des fonctions de commandement.",
    "Depuis 2007, plus de la moitié de l'humanité vit en ville (urbanisation), alimentée par l'exode rural.",
    "Le centre d'une métropole concentre commerces, bureaux et un foncier cher ; la périphérie s'étend (étalement urbain).",
    "Les migrations pendulaires (domicile-travail) nécessitent des transports en commun (métro, tramway, bus).",
    "Des métropoles existent sur tous les continents : Paris, Tokyo, Lagos, New York, chacune avec ses spécificités.",
    "Les métropoles connaissent des inégalités entre quartiers, parfois marquées par des bidonvilles en périphérie.",
  ],
},
{
  slug: "monotheismes-antiquite",
  titre: "Judaïsme et christianisme dans l'Antiquité",
  matiere: "histoire-geo",
  niveau: "6eme",
  description:
    "Découvrir la naissance et la diffusion des deux premiers monothéismes de l'Antiquité méditerranéenne : le judaïsme, religion du peuple hébreu, et le christianisme, né de la prédication de Jésus, qui se répand ensuite dans tout l'Empire romain.",
  objectifs: [
    "Comprendre ce qu'est un monothéisme et le distinguer du polythéisme",
    "Connaître les grandes étapes de l'histoire du peuple hébreu et du judaïsme",
    "Connaître la vie et l'enseignement de Jésus de Nazareth",
    "Comprendre comment le christianisme se diffuse dans l'Empire romain",
    "Connaître les grands textes sacrés de ces deux religions",
  ],
  slides: [
    {
      titre: "Qu'est-ce qu'un monothéisme ?",
      illustration: "☝️",
      visuel: "Un seul Dieu",
      contenu: [
        "Un monothéisme est une religion qui ne croit qu'en un seul Dieu",
        "Cela diffère du polythéisme, comme la religion grecque ou romaine",
        "Le judaïsme est l'un des tout premiers monothéismes de l'histoire",
        "Le christianisme naît ensuite, à partir du judaïsme, au Ier siècle après J.-C.",
      ],
      voixOff:
        "Un monothéisme est une religion qui affirme qu'il n'existe qu'un seul Dieu, à la différence du polythéisme, comme la religion grecque ou romaine, qui reconnaît de nombreux dieux. Le judaïsme, religion du peuple hébreu, est l'un des tout premiers monothéismes de l'histoire de l'humanité. Plus tard, au premier siècle après Jésus-Christ, le christianisme naît à son tour, en s'appuyant largement sur les textes et les croyances du judaïsme.",
    },
    {
      titre: "Les Hébreux et leur Dieu unique",
      illustration: "📖",
      visuel: "Torah, Abraham",
      contenu: [
        "Selon la Bible, Abraham est le premier à croire en un Dieu unique",
        "Les Hébreux se considèrent comme le peuple choisi par ce Dieu",
        "Leur histoire, leurs croyances et leurs lois sont racontées dans la Torah",
        "La Torah forme les cinq premiers livres de la Bible hébraïque",
      ],
      voixOff:
        "Selon la Bible, texte sacré des Hébreux, c'est Abraham qui, le premier, croit en un Dieu unique et conclut une alliance avec lui. Les Hébreux se considèrent alors comme le peuple choisi par ce Dieu. Leur histoire, leurs croyances et leurs lois sont rassemblées dans la Torah, qui forme les cinq premiers livres de la Bible hébraïque et reste aujourd'hui le texte sacré fondamental du judaïsme.",
    },
    {
      titre: "Jérusalem et le Temple",
      illustration: "🕍",
      visuel: "Temple de Jérusalem",
      contenu: [
        "Jérusalem devient la ville sainte des Hébreux, capitale du royaume d'Israël",
        "Le roi Salomon y fait construire un premier Temple, vers le Xe siècle av. J.-C.",
        "Ce Temple abrite le lieu le plus sacré du judaïsme",
        "Détruit puis reconstruit, il est définitivement détruit par les Romains en 70 apr. J.-C.",
      ],
      voixOff:
        "Jérusalem devient la ville sainte des Hébreux et la capitale de leur royaume. Le roi Salomon y fait construire, vers le dixième siècle avant Jésus-Christ, un premier Temple, qui abrite le lieu le plus sacré du judaïsme. Ce Temple est détruit une première fois par les Babyloniens, puis reconstruit, avant d'être définitivement détruit par les Romains en soixante-dix après Jésus-Christ, après une révolte juive contre l'occupation romaine.",
    },
    {
      titre: "Jésus de Nazareth",
      illustration: "✝️",
      visuel: "Ier siècle apr. J.-C.",
      contenu: [
        "Jésus naît vers l'an 5 ou 4 av. J.-C., à Bethléem, en Judée, sous domination romaine",
        "Il prêche l'amour de Dieu et l'amour du prochain, entouré de ses douze apôtres",
        "Ses paroles et ses actes sont rapportés dans les Évangiles",
        "Vers l'an 30, il est condamné et crucifié à Jérusalem par les autorités romaines",
      ],
      voixOff:
        "Jésus naît vers l'an cinq ou quatre avant Jésus-Christ, à Bethléem, en Judée, une région alors sous domination romaine. Il parcourt le pays en prêchant l'amour de Dieu et l'amour du prochain, entouré de ses douze apôtres, ses plus proches disciples. Ses paroles et les événements de sa vie sont rapportés dans les Évangiles, rédigés après sa mort. Vers l'an trente, jugé et condamné par les autorités romaines, Jésus est crucifié à Jérusalem.",
    },
    {
      titre: "La naissance du christianisme",
      illustration: "🕊️",
      visuel: "Résurrection, apôtres",
      contenu: [
        "Les disciples de Jésus croient qu'il est ressuscité après sa mort",
        "Ils le considèrent comme le fils de Dieu, le Christ (« le Messie »)",
        "L'apôtre Paul joue un rôle essentiel dans la diffusion du message chrétien",
        "Les premiers chrétiens se réunissent en petites communautés autour de la Méditerranée",
      ],
      voixOff:
        "Après la mort de Jésus, ses disciples croient fermement qu'il est ressuscité, et le considèrent comme le fils de Dieu, le Christ, un mot qui signifie « le Messie », l'envoyé de Dieu. C'est ainsi que naît le christianisme. L'apôtre Paul joue un rôle essentiel dans la diffusion de ce nouveau message, en voyageant dans tout le bassin méditerranéen pour fonder des communautés chrétiennes, d'abord discrètes et minoritaires.",
    },
    {
      titre: "Les persécutions des chrétiens",
      illustration: "🦁",
      visuel: "Ier-IIIe siècle",
      contenu: [
        "Les premiers chrétiens refusent de sacrifier aux dieux romains et à l'empereur",
        "Ce refus est perçu comme une menace pour l'ordre religieux et politique romain",
        "Entre le Ier et le IIIe siècle, les chrétiens sont parfois persécutés par Rome",
        "Malgré les persécutions, le nombre de chrétiens continue d'augmenter",
      ],
      voixOff:
        "Les premiers chrétiens refusent de sacrifier aux dieux romains et de rendre un culte à l'empereur, ce qui inquiète les autorités romaines, attachées à l'ordre religieux traditionnel. Entre le premier et le troisième siècle après Jésus-Christ, les chrétiens sont donc parfois persécutés, emprisonnés ou exécutés. Mais malgré ces persécutions, le christianisme continue de se répandre, séduisant un nombre croissant d'habitants de l'Empire, de toutes origines sociales.",
    },
    {
      titre: "Le christianisme devient religion de l'Empire",
      illustration: "⛪",
      visuel: "313 et 380",
      contenu: [
        "En 313, l'empereur Constantin autorise la liberté de culte pour les chrétiens",
        "Il se convertit lui-même au christianisme",
        "En 380, l'empereur Théodose fait du christianisme la religion officielle de l'Empire",
        "Les autres cultes, dont le polythéisme romain, sont alors peu à peu interdits",
      ],
      voixOff:
        "Un tournant décisif intervient en trois cent treize, lorsque l'empereur Constantin autorise, par l'édit de Milan, la liberté de culte pour les chrétiens, mettant fin aux persécutions. Il se convertit lui-même au christianisme. Puis, en trois cent quatre-vingts, l'empereur Théodose franchit une étape supplémentaire en faisant du christianisme la religion officielle de tout l'Empire romain, tandis que les autres cultes, comme le polythéisme traditionnel, sont progressivement interdits.",
    },
    {
      titre: "Ce qu'il faut retenir",
      illustration: "🏆",
      visuel: "📌",
      contenu: [
        "Le judaïsme, l'un des premiers monothéismes, repose sur la Torah et le Temple de Jérusalem",
        "Jésus de Nazareth prêche au Ier siècle apr. J.-C. puis est crucifié vers l'an 30",
        "Ses disciples fondent le christianisme, qui se répand malgré les persécutions",
        "En 380, le christianisme devient la religion officielle de l'Empire romain",
      ],
      voixOff:
        "Résumons. Le judaïsme, religion du peuple hébreu, est l'un des premiers monothéismes de l'histoire, fondé sur la croyance en un Dieu unique, la Torah et le Temple de Jérusalem. Au premier siècle après Jésus-Christ, Jésus de Nazareth prêche l'amour de Dieu et du prochain avant d'être crucifié vers l'an trente. Ses disciples fondent alors le christianisme, qui se répand dans tout l'Empire romain malgré les persécutions, jusqu'à devenir religion officielle de l'Empire en trois cent quatre-vingts, sous l'empereur Théodose. Bravo, tu connais l'essentiel de ce chapitre !",
    },
  ],
  fiche: {
    intro:
      "Dans l'Antiquité méditerranéenne naissent les deux premiers grands monothéismes : le judaïsme, religion du peuple hébreu fondée sur la Torah, puis le christianisme, né de la prédication de Jésus de Nazareth, qui devient religion officielle de l'Empire romain en 380.",
    sections: [
      {
        titre: "Le judaïsme",
        points: [
          "Monothéisme : croyance en un Dieu unique, dès Abraham",
          "Texte sacré : la Torah (les cinq premiers livres de la Bible hébraïque)",
          "Jérusalem, ville sainte ; Temple construit par Salomon, détruit en 70 apr. J.-C.",
        ],
      },
      {
        titre: "Jésus de Nazareth",
        points: [
          "Naît vers -5/-4, en Judée, sous domination romaine",
          "Prêche l'amour de Dieu et du prochain, entouré de douze apôtres",
          "Crucifié à Jérusalem vers l'an 30",
        ],
      },
      {
        titre: "La naissance et la diffusion du christianisme",
        points: [
          "Les disciples croient en la résurrection de Jésus, considéré comme le Christ",
          "L'apôtre Paul diffuse le message chrétien autour de la Méditerranée",
          "Persécutions des chrétiens par Rome (Ier-IIIe siècle)",
        ],
      },
      {
        titre: "Le christianisme, religion de l'Empire",
        points: [
          "313 : édit de Milan de Constantin, liberté de culte pour les chrétiens",
          "380 : édit de Théodose, le christianisme devient religion officielle de l'Empire",
          "Déclin progressif des cultes polythéistes romains",
        ],
      },
    ],
    audio:
      "Fiche de révision : judaïsme et christianisme dans l'Antiquité. Le judaïsme, religion du peuple hébreu, est l'un des premiers monothéismes de l'histoire : il repose sur la croyance en un Dieu unique, dès Abraham, et sur la Torah, texte sacré fondamental. Jérusalem est la ville sainte des Hébreux, où le roi Salomon fait construire un Temple, détruit définitivement par les Romains en soixante-dix après Jésus-Christ. Au premier siècle après Jésus-Christ, Jésus de Nazareth prêche en Judée l'amour de Dieu et du prochain, entouré de ses douze apôtres, avant d'être crucifié à Jérusalem vers l'an trente. Ses disciples croient en sa résurrection et le considèrent comme le Christ, fils de Dieu : c'est la naissance du christianisme, diffusé notamment par l'apôtre Paul autour de la Méditerranée. Les chrétiens sont d'abord persécutés par Rome, avant que l'empereur Constantin n'autorise la liberté de culte en trois cent treize, puis que l'empereur Théodose fasse du christianisme la religion officielle de l'Empire romain en trois cent quatre-vingts.",
  },
  memoCards: [
    { recto: "Qu'est-ce qu'un monothéisme ?", verso: "Une religion qui croit en un seul Dieu, à la différence du polythéisme." },
    { recto: "Quel est le texte sacré du judaïsme ?", verso: "La Torah, les cinq premiers livres de la Bible hébraïque." },
    { recto: "Quelle est la ville sainte des Hébreux ?", verso: "Jérusalem, où se trouvait le Temple construit par Salomon." },
    { recto: "Quand et où naît Jésus ?", verso: "Vers -5/-4, à Bethléem, en Judée, sous domination romaine." },
    { recto: "Que prêche Jésus ?", verso: "L'amour de Dieu et l'amour du prochain." },
    { recto: "Comment meurt Jésus, et quand ?", verso: "Il est crucifié à Jérusalem vers l'an 30." },
    { recto: "Qui diffuse le christianisme autour de la Méditerranée ?", verso: "L'apôtre Paul, dans les décennies qui suivent la mort de Jésus." },
    { recto: "Que se passe-t-il en 313 et en 380 ?", verso: "313 : l'édit de Milan (Constantin) autorise la liberté de culte des chrétiens. 380 : l'édit de Théodose fait du christianisme la religion officielle de l'Empire." },
  ],
  exercices: [
    {
      type: "qcm",
      difficulte: "facile",
      question: "Qu'est-ce qu'un monothéisme ?",
      choix: ["Une religion sans dieu", "Une religion qui croit en un seul Dieu", "Une religion qui croit en plusieurs dieux", "Une religion sans texte sacré"],
      bonneReponse: 1,
      explication: "Le monothéisme s'oppose au polythéisme, qui reconnaît plusieurs dieux.",
    },
    {
      type: "qcm",
      difficulte: "facile",
      question: "Quel est le texte sacré fondamental du judaïsme ?",
      choix: ["Les Évangiles", "La Torah", "Le Coran", "L'Iliade"],
      bonneReponse: 1,
      explication: "La Torah forme les cinq premiers livres de la Bible hébraïque.",
    },
    {
      type: "ouverte",
      difficulte: "facile",
      question: "Où naît Jésus, selon les Évangiles ?",
      reponse: "À Bethléem, en Judée.",
      explication: "La Judée est alors une région sous domination romaine.",
    },
    {
      type: "qcm",
      difficulte: "facile",
      question: "Comment appelle-t-on les douze proches disciples de Jésus ?",
      choix: ["Les apôtres", "Les pharaons", "Les consuls", "Les scribes"],
      bonneReponse: 0,
      explication: "Les douze apôtres accompagnent Jésus dans sa prédication.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Qui fait construire le premier Temple de Jérusalem ?",
      choix: ["Abraham", "Le roi Salomon", "Jésus", "L'empereur Constantin"],
      bonneReponse: 1,
      explication: "Le roi Salomon fait construire le premier Temple vers le Xe siècle avant J.-C.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Que croient les disciples de Jésus après sa mort, et quel nom lui donnent-ils ?",
      reponse: "Ils croient qu'il est ressuscité et le considèrent comme le Christ (le Messie), fils de Dieu.",
      explication: "Cette croyance en la résurrection est au fondement du christianisme.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Pourquoi les premiers chrétiens sont-ils parfois persécutés par Rome ?",
      reponse: "Parce qu'ils refusent de sacrifier aux dieux romains et de rendre un culte à l'empereur, ce qui est perçu comme une menace pour l'ordre religieux et politique romain.",
      explication: "Ces persécutions ont lieu de manière irrégulière entre le Ier et le IIIe siècle après J.-C.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Quel empereur romain accorde la liberté de culte aux chrétiens en 313 ?",
      choix: ["Auguste", "Constantin", "Théodose", "Jules César"],
      bonneReponse: 1,
      explication: "L'édit de Milan, en 313, met fin aux persécutions officielles des chrétiens.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Explique la différence entre l'édit de 313 et l'édit de 380 concernant le christianisme.",
      reponse:
        "En 313, l'édit de Milan de Constantin autorise simplement la liberté de culte pour les chrétiens, qui peuvent désormais pratiquer leur religion sans être persécutés. En 380, l'édit de Théodose va plus loin en faisant du christianisme la religion officielle unique de tout l'Empire romain, les autres cultes étant progressivement interdits.",
      explication: "Ces deux étapes marquent la progression du christianisme, de la tolérance à la religion d'État.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "En quoi le judaïsme et le christianisme sont-ils tous les deux des monothéismes, mais avec des différences ?",
      reponse:
        "Les deux religions croient en un seul Dieu et partagent une partie de leurs textes sacrés (l'Ancien Testament de la Bible). Mais les chrétiens croient en plus que Jésus est le fils de Dieu, le Christ ressuscité, ce que ne reconnaît pas le judaïsme, qui attend encore la venue du Messie.",
      explication: "Cette différence essentielle explique la séparation progressive entre judaïsme et christianisme.",
    },
    {
      type: "qcm",
      difficulte: "avance",
      question: "Qui joue un rôle essentiel dans la diffusion du christianisme autour de la Méditerranée après la mort de Jésus ?",
      choix: ["L'empereur Auguste", "L'apôtre Paul", "Le roi Salomon", "Hannibal"],
      bonneReponse: 1,
      explication: "L'apôtre Paul voyage dans tout le bassin méditerranéen pour fonder des communautés chrétiennes.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Explique pourquoi la destruction du Temple de Jérusalem en 70 apr. J.-C. est un événement important pour le judaïsme.",
      reponse:
        "Le Temple était le lieu le plus sacré du judaïsme, où se pratiquaient les sacrifices religieux ; sa destruction définitive par les Romains, après une révolte juive, transforme profondément la pratique religieuse juive et accélère la dispersion des Juifs hors de Judée, un phénomène appelé la diaspora.",
      explication: "Cet événement marque un tournant majeur dans l'histoire du peuple juif dans l'Antiquité.",
    },
  ],
  revisionFinChapitre: [
    {
      type: "qcm",
      difficulte: "facile",
      question: "Comment appelle-t-on les cinq premiers livres de la Bible hébraïque ?",
      choix: ["Les Évangiles", "La Torah", "Les Actes des Apôtres", "Le Coran"],
      bonneReponse: 1,
      explication: "La Torah est le texte fondamental du judaïsme.",
    },
    {
      type: "ouverte",
      difficulte: "facile",
      question: "Quelle ville est la ville sainte des Hébreux ?",
      reponse: "Jérusalem.",
      explication: "Le Temple de Jérusalem, construit par Salomon, y abritait le lieu le plus sacré du judaïsme.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "En quelle année Jésus est-il crucifié, environ ?",
      reponse: "Vers l'an 30 après J.-C.",
      explication: "Jésus est jugé et crucifié à Jérusalem par les autorités romaines.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "En quelle année le christianisme devient-il religion officielle de l'Empire romain ?",
      choix: ["70", "313", "380", "753"],
      bonneReponse: 2,
      explication: "L'édit de Théodose, en 380, fait du christianisme la religion officielle de l'Empire.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Pourquoi les chrétiens sont-ils parfois persécutés par Rome avant 313 ?",
      reponse: "Parce qu'ils refusent de sacrifier aux dieux romains et à l'empereur, ce qui inquiète les autorités.",
      explication: "L'édit de Milan, en 313, met fin à ces persécutions officielles.",
    },
  ],
  examens: [
    {
      titre: "Examen 1 — Judaïsme et christianisme dans l'Antiquité",
      dureeMinutes: 20,
      questions: [
        {
          type: "qcm",
          difficulte: "facile",
          question: "Quel peuple pratique le judaïsme dans l'Antiquité ?",
          choix: ["Les Grecs", "Les Hébreux", "Les Romains", "Les Égyptiens"],
          bonneReponse: 1,
          explication: "Le judaïsme est la religion du peuple hébreu.",
        },
        {
          type: "ouverte",
          difficulte: "facile",
          question: "Qui, selon la Bible, est le premier à croire en un Dieu unique ?",
          reponse: "Abraham.",
          explication: "Abraham conclut une alliance avec ce Dieu unique selon le récit biblique.",
        },
        {
          type: "qcm",
          difficulte: "moyen",
          question: "Où et quand naît le christianisme ?",
          choix: [
            "En Grèce, au IVe siècle av. J.-C.",
            "En Judée, au Ier siècle apr. J.-C.",
            "À Rome, au IIIe siècle apr. J.-C.",
            "En Égypte, au IIe siècle av. J.-C.",
          ],
          bonneReponse: 1,
          explication: "Le christianisme naît en Judée, autour de la prédication de Jésus au Ier siècle après J.-C.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Que prêchait Jésus, et à qui s'adressait-il ?",
          reponse: "Il prêchait l'amour de Dieu et l'amour du prochain, en s'adressant à tous, y compris aux pauvres et aux exclus, entouré de ses douze apôtres.",
          explication: "Cet enseignement est rapporté dans les Évangiles.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Comment le christianisme se répand-il dans l'Empire romain malgré les persécutions ?",
          reponse: "Grâce à des prédicateurs comme l'apôtre Paul, qui fondent des communautés chrétiennes autour de la Méditerranée, et malgré les persécutions, le nombre de convertis continue d'augmenter dans toutes les catégories sociales.",
          explication: "Cette diffusion progressive prépare la reconnaissance officielle du christianisme au IVe siècle.",
        },
        {
          type: "ouverte",
          difficulte: "avance",
          question:
            "Développement construit : retrace les grandes étapes de la naissance et de la diffusion du christianisme, de Jésus à l'édit de Théodose (une quinzaine de lignes).",
          reponse:
            "Introduction : le christianisme naît au Ier siècle après Jésus-Christ, à partir de la prédication de Jésus de Nazareth, avant de devenir religion officielle de l'Empire romain. Première partie : Jésus, né vers -5/-4 en Judée, prêche l'amour de Dieu et du prochain, entouré de ses douze apôtres, avant d'être crucifié à Jérusalem vers l'an 30. Deuxième partie : ses disciples, croyant en sa résurrection, le considèrent comme le Christ, fils de Dieu ; l'apôtre Paul diffuse ce message autour de la Méditerranée, malgré les persécutions subies par les chrétiens entre le Ier et le IIIe siècle. Troisième partie : en 313, l'édit de Milan de Constantin autorise la liberté de culte, puis en 380, l'édit de Théodose fait du christianisme la religion officielle de l'Empire. Conclusion : en moins de quatre siècles, le christianisme passe ainsi d'un mouvement minoritaire et persécuté à la religion dominante de l'Empire romain.",
          explication: "Un bon développement suit l'ordre chronologique : vie de Jésus, diffusion, persécutions, reconnaissance officielle.",
        },
      ],
    },
    {
      titre: "Examen 2 — Judaïsme et christianisme dans l'Antiquité",
      dureeMinutes: 20,
      questions: [
        {
          type: "qcm",
          difficulte: "facile",
          question: "Qui fait construire le premier Temple de Jérusalem, vers le Xe siècle av. J.-C. ?",
          choix: ["Abraham", "Moïse", "Salomon", "Jésus"],
          bonneReponse: 2,
          explication: "Le roi Salomon fait construire ce premier Temple, lieu le plus sacré du judaïsme.",
        },
        {
          type: "ouverte",
          difficulte: "facile",
          question: "En quelle année le Temple de Jérusalem est-il définitivement détruit par les Romains ?",
          reponse: "En 70 apr. J.-C.",
          explication: "Cette destruction suit une révolte juive contre l'occupation romaine.",
        },
        {
          type: "qcm",
          difficulte: "moyen",
          question: "Que signifie le mot « Christ » ?",
          choix: ["Le fils", "Le Messie, l'envoyé de Dieu", "Le prophète", "Le roi des Juifs"],
          bonneReponse: 1,
          explication: "Les disciples de Jésus le considèrent comme le Christ, envoyé par Dieu.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Qu'est-ce que l'édit de Milan, en 313 ?",
          reponse: "Un texte de l'empereur Constantin qui autorise la liberté de culte pour les chrétiens, mettant fin aux persécutions officielles.",
          explication: "Constantin se convertit lui-même au christianisme après cette décision.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Pourquoi peut-on dire que le judaïsme et le christianisme sont liés ?",
          reponse: "Parce que le christianisme naît à partir du judaïsme : Jésus est juif, ses premiers disciples aussi, et les deux religions partagent une partie de leurs textes sacrés (l'Ancien Testament).",
          explication: "Cette filiation religieuse explique de nombreux points communs entre les deux traditions.",
        },
        {
          type: "ouverte",
          difficulte: "avance",
          question:
            "Développement construit : explique les grandes étapes de l'histoire du judaïsme dans l'Antiquité, d'Abraham à la destruction du Temple en 70 (une quinzaine de lignes).",
          reponse:
            "Introduction : le judaïsme est l'un des premiers monothéismes de l'histoire, fondé sur la croyance en un Dieu unique. Première partie : selon la Bible, Abraham est le premier à croire en ce Dieu unique et à conclure une alliance avec lui ; les Hébreux se considèrent comme le peuple choisi et rassemblent leurs croyances et leurs lois dans la Torah. Deuxième partie : Jérusalem devient leur ville sainte, où le roi Salomon fait construire, vers le Xe siècle avant J.-C., un premier Temple, lieu le plus sacré du judaïsme. Troisième partie : occupée par Rome, la Judée connaît des révoltes juives, et le Temple, reconstruit après une première destruction, est définitivement détruit par les Romains en 70 après Jésus-Christ. Conclusion : cette destruction marque un tournant majeur pour le peuple juif, qui se disperse alors davantage autour de la Méditerranée.",
          explication: "On attend une présentation chronologique claire mobilisant Abraham, la Torah, Jérusalem et le Temple.",
        },
      ],
    },
  ],
  syntheseRevisions: [
    "Le judaïsme, religion des Hébreux, est l'un des premiers monothéismes : un seul Dieu, la Torah, Jérusalem et le Temple.",
    "Le Temple de Jérusalem, construit par Salomon, est définitivement détruit par les Romains en 70 apr. J.-C.",
    "Jésus de Nazareth (né vers -5/-4) prêche l'amour de Dieu et du prochain avant d'être crucifié vers l'an 30.",
    "Ses disciples, croyant en sa résurrection, fondent le christianisme, diffusé notamment par l'apôtre Paul.",
    "Les chrétiens sont persécutés par Rome (Ier-IIIe siècle) avant l'édit de Milan (313, Constantin).",
    "En 380, l'édit de Théodose fait du christianisme la religion officielle de l'Empire romain.",
  ],
},
{
  slug: "neolithique",
  titre: "Le Néolithique et les premiers villages",
  matiere: "histoire-geo",
  niveau: "6eme",
  description:
    "Comprendre la grande révolution néolithique : l'invention de l'agriculture et de l'élevage, la sédentarisation des hommes et la naissance des premiers villages, il y a environ 10 000 ans.",
  objectifs: [
    "Comprendre ce qu'est la révolution néolithique et où elle apparaît",
    "Connaître les inventions de l'agriculture et de l'élevage",
    "Comprendre le passage du nomadisme à la sédentarisation",
    "Connaître les caractéristiques des premiers villages (Jéricho, Çatal Höyük)",
    "Comprendre l'apparition des débuts d'inégalités sociales",
  ],
  slides: [
    {
      titre: "Qu'est-ce que le Néolithique ?",
      illustration: "🌾",
      visuel: "-10 000 ans",
      contenu: [
        "Le Néolithique signifie « âge de la pierre nouvelle » (pierre polie)",
        "Il commence vers -10 000 ans au Proche-Orient (Croissant fertile)",
        "C'est une période de grands bouleversements dans la vie des hommes",
        "On parle de « révolution néolithique » pour ces changements profonds",
      ],
      voixOff:
        "Après des millions d'années de vie nomade, une véritable révolution s'opère à partir d'environ moins dix mille ans : le Néolithique. Ce mot signifie « âge de la pierre nouvelle », car les hommes polissent désormais leurs outils. Ce grand changement commence dans une région du Proche-Orient appelée le Croissant fertile, qui correspond aujourd'hui à des pays comme l'Irak, la Syrie ou la Turquie. On parle de révolution néolithique tant les transformations sont profondes et rapides à l'échelle de la Préhistoire.",
    },
    {
      titre: "L'invention de l'agriculture",
      illustration: "🌾",
      visuel: "Blé, orge",
      contenu: [
        "Les hommes domestiquent des plantes sauvages : blé, orge, lentilles",
        "Ils apprennent à semer, cultiver et récolter au bon moment",
        "L'agriculture permet de produire davantage de nourriture qu'avant",
        "Elle libère les hommes de la seule dépendance à la chasse et à la cueillette",
      ],
      voixOff:
        "La première grande invention du Néolithique est l'agriculture. Les hommes observent les plantes sauvages, comme le blé, l'orge ou les lentilles, et apprennent à les domestiquer : ils sélectionnent les meilleures graines, les sèment, puis récoltent au bon moment. Grâce à l'agriculture, une même surface de terre peut nourrir bien plus de personnes qu'avec la seule cueillette. C'est un changement immense dans la manière de se procurer sa nourriture.",
    },
    {
      titre: "L'invention de l'élevage",
      illustration: "🐑",
      visuel: "Moutons, chèvres",
      contenu: [
        "Les hommes domestiquent des animaux : moutons, chèvres, puis bœufs et porcs",
        "L'élevage fournit viande, lait, laine et peaux de façon régulière",
        "Le chien est domestiqué plus tôt encore, comme animal de compagnie et d'aide à la chasse",
        "Agriculture et élevage forment les deux piliers de l'économie néolithique",
      ],
      voixOff:
        "En parallèle de l'agriculture, les hommes domestiquent des animaux : d'abord les moutons et les chèvres, puis les bœufs et les porcs. L'élevage apporte une source régulière de viande, de lait, de laine et de peaux, sans dépendre uniquement des aléas de la chasse. Le chien, domestiqué encore plus tôt, aide les hommes à la chasse et à la garde des troupeaux. Ensemble, l'agriculture et l'élevage transforment complètement l'économie des sociétés humaines.",
    },
    {
      titre: "La sédentarisation",
      illustration: "🏘️",
      visuel: "Nomade → sédentaire",
      contenu: [
        "Cultiver la terre oblige à rester près de ses champs : c'est la sédentarisation",
        "Les hommes construisent des maisons durables, en pierre, en terre ou en bois",
        "Ils s'installent dans des villages, souvent près de points d'eau",
        "Le stockage des récoltes (silos, greniers) devient indispensable",
      ],
      voixOff:
        "Puisqu'il faut surveiller les champs, semer puis attendre les récoltes, les hommes ne peuvent plus se déplacer comme avant : ils se sédentarisent. Ils construisent des habitations durables en pierre, en terre séchée ou en bois, et s'installent en groupes près de points d'eau, comme des rivières ou des sources. Il faut désormais conserver les récoltes pour l'année entière : les hommes inventent des silos et des greniers pour stocker le grain.",
    },
    {
      titre: "Les premiers villages : Jéricho et Çatal Höyük",
      illustration: "🏛️",
      visuel: "Proche-Orient",
      contenu: [
        "Jéricho (actuelle Cisjordanie) : l'un des plus anciens villages connus, vers -9000",
        "Il est entouré d'un mur de pierre et d'une tour, signe d'une organisation collective",
        "Çatal Höyük (actuelle Turquie), vers -7000, regroupe plusieurs milliers d'habitants",
        "Ces villages montrent une vie collective organisée, avec des maisons serrées les unes contre les autres",
      ],
      voixOff:
        "Parmi les tout premiers villages du monde figure Jéricho, dans l'actuelle Cisjordanie, occupé dès environ moins neuf mille ans. Il est entouré d'un mur de pierre et d'une tour, ce qui prouve une organisation collective déjà développée. Un peu plus tard, vers moins sept mille ans, le village de Çatal Höyük, en Turquie actuelle, rassemble plusieurs milliers d'habitants dans des maisons serrées les unes contre les autres, sans rues, où l'on circule par les toits.",
    },
    {
      titre: "Nouvelles techniques et nouveaux objets",
      illustration: "🏺",
      visuel: "Poterie",
      contenu: [
        "La pierre polie remplace peu à peu la pierre simplement taillée",
        "Les hommes inventent la poterie pour cuisiner et conserver les aliments",
        "Ils tissent des fibres végétales et animales pour fabriquer des vêtements",
        "Ces nouveaux objets facilitent la vie quotidienne des villages",
      ],
      voixOff:
        "Le Néolithique voit apparaître de nouvelles techniques. La pierre polie, plus solide et plus efficace, remplace progressivement la pierre simplement taillée du Paléolithique. Les hommes inventent aussi la poterie : des récipients en terre cuite qui permettent de cuisiner, de transporter et de conserver l'eau et les aliments. Ils apprennent également à tisser des fibres végétales et animales pour fabriquer des vêtements, remplaçant peu à peu les peaux de bêtes.",
    },
    {
      titre: "Les débuts des inégalités sociales",
      illustration: "⚖️",
      visuel: "Surplus, échanges",
      contenu: [
        "L'agriculture permet parfois de produire un surplus de nourriture",
        "Ce surplus peut être échangé ou stocké, ce qui crée des différences de richesse",
        "Certains villages échangent des objets sur de longues distances (silex, coquillages)",
        "Naissent alors les premières formes d'organisation sociale et de hiérarchie",
      ],
      voixOff:
        "En produisant plus de nourriture que nécessaire, certaines familles ou certains villages accumulent un surplus. Ce surplus peut être conservé, mais aussi échangé contre d'autres biens, parfois venus de très loin, comme du silex ou des coquillages. Ces échanges et cette accumulation de richesses font naître les premières différences sociales entre les hommes, alors qu'au Paléolithique, les sociétés étaient beaucoup plus égalitaires.",
    },
    {
      titre: "Ce qu'il faut retenir",
      illustration: "🏆",
      visuel: "📌",
      contenu: [
        "Vers -10 000 ans, au Proche-Orient : révolution néolithique",
        "Agriculture et élevage remplacent progressivement chasse et cueillette",
        "Sédentarisation : premiers villages (Jéricho, Çatal Höyük)",
        "Nouveaux objets (pierre polie, poterie) et débuts des inégalités",
      ],
      voixOff:
        "Résumons. Vers moins dix mille ans, au Proche-Orient, se produit la révolution néolithique. Les hommes inventent l'agriculture et l'élevage, ce qui leur permet progressivement de se sédentariser et de fonder les premiers villages, comme Jéricho ou Çatal Höyük. De nouvelles techniques apparaissent, la pierre polie et la poterie, tandis que les surplus de nourriture et les échanges font naître les premières inégalités sociales. Bravo, tu connais l'essentiel de ce chapitre !",
    },
  ],
  fiche: {
    intro:
      "Vers -10 000 ans, au Proche-Orient, une véritable révolution transforme la vie des hommes : l'invention de l'agriculture et de l'élevage entraîne leur sédentarisation et la naissance des premiers villages.",
    sections: [
      {
        titre: "L'agriculture et l'élevage",
        points: [
          "Domestication des plantes : blé, orge, lentilles",
          "Domestication des animaux : moutons, chèvres, bœufs, porcs",
          "Ces inventions permettent de produire davantage de nourriture",
        ],
      },
      {
        titre: "La sédentarisation",
        points: [
          "Les hommes s'installent durablement près de leurs champs",
          "Construction de maisons en pierre, terre ou bois",
          "Invention de silos et greniers pour stocker les récoltes",
        ],
      },
      {
        titre: "Les premiers villages",
        points: [
          "Jéricho (Proche-Orient), vers -9000, entouré d'un mur et d'une tour",
          "Çatal Höyük (Turquie actuelle), vers -7000, plusieurs milliers d'habitants",
          "Naissance d'une vie collective organisée",
        ],
      },
      {
        titre: "Nouvelles techniques et débuts des inégalités",
        points: [
          "Pierre polie et poterie facilitent la vie quotidienne",
          "Le surplus agricole permet l'échange et l'accumulation de richesses",
          "Apparition des premières inégalités sociales",
        ],
      },
    ],
    audio:
      "Fiche de révision : le Néolithique et les premiers villages. Vers moins dix mille ans, au Proche-Orient, dans une région appelée le Croissant fertile, les hommes inventent l'agriculture, en domestiquant des plantes comme le blé et l'orge, et l'élevage, en domestiquant des animaux comme les moutons et les chèvres. Ces inventions transforment leur mode de vie : ils doivent désormais rester près de leurs champs et se sédentarisent, construisant des maisons durables et fondant les premiers villages, comme Jéricho ou Çatal Höyük, qui rassemble plusieurs milliers d'habitants. De nouvelles techniques apparaissent, la pierre polie et la poterie. Enfin, les surplus de nourriture produits par l'agriculture permettent des échanges sur de longues distances et font naître les premières inégalités sociales entre les hommes.",
  },
  memoCards: [
    { recto: "Que signifie « Néolithique » ?", verso: "« Âge de la pierre nouvelle » : la période où les hommes polissent la pierre." },
    { recto: "Où et quand commence la révolution néolithique ?", verso: "Vers -10 000 ans, au Proche-Orient (Croissant fertile)." },
    { recto: "Quelles plantes les hommes domestiquent-ils en premier ?", verso: "Le blé, l'orge et les lentilles." },
    { recto: "Quels animaux les hommes domestiquent-ils ?", verso: "Les moutons et les chèvres, puis les bœufs et les porcs." },
    { recto: "Qu'est-ce que la sédentarisation ?", verso: "Le fait de s'installer durablement au même endroit, au lieu de se déplacer sans cesse." },
    { recto: "Cite deux premiers villages néolithiques.", verso: "Jéricho (Proche-Orient) et Çatal Höyük (Turquie actuelle)." },
    { recto: "À quoi sert la poterie ?", verso: "À cuisiner, transporter et conserver l'eau et les aliments." },
    { recto: "Pourquoi les inégalités sociales apparaissent-elles au Néolithique ?", verso: "Le surplus de nourriture produit par l'agriculture peut être stocké et échangé, créant des différences de richesse." },
  ],
  exercices: [
    {
      type: "qcm",
      difficulte: "facile",
      question: "Que signifie le mot « Néolithique » ?",
      choix: ["Âge du bronze", "Âge de la pierre nouvelle (polie)", "Âge du fer", "Âge de l'écriture"],
      bonneReponse: 1,
      explication: "Néolithique vient du grec et signifie « pierre nouvelle », en référence à la pierre polie.",
    },
    {
      type: "qcm",
      difficulte: "facile",
      question: "Quelles sont les deux grandes inventions du Néolithique ?",
      choix: ["L'écriture et la roue", "L'agriculture et l'élevage", "Le feu et la pierre taillée", "La monnaie et le commerce"],
      bonneReponse: 1,
      explication: "L'agriculture (culture des plantes) et l'élevage (domestication des animaux) transforment le mode de vie des hommes.",
    },
    {
      type: "ouverte",
      difficulte: "facile",
      question: "Qu'est-ce que la sédentarisation ?",
      reponse: "Le fait de s'installer durablement au même endroit, dans un habitat fixe, au lieu de se déplacer en permanence.",
      explication: "La sédentarisation est une conséquence directe de la pratique de l'agriculture.",
    },
    {
      type: "qcm",
      difficulte: "facile",
      question: "Dans quelle région du monde commence la révolution néolithique ?",
      choix: ["En Europe", "Au Proche-Orient", "En Amérique", "En Océanie"],
      bonneReponse: 1,
      explication: "Le Proche-Orient, dans la région du Croissant fertile, est l'un des premiers foyers de la révolution néolithique.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Quel est l'un des plus anciens villages connus, entouré d'un mur et d'une tour ?",
      choix: ["Çatal Höyük", "Jéricho", "Uruk", "Memphis"],
      bonneReponse: 1,
      explication: "Jéricho, dans l'actuelle Cisjordanie, est occupé dès environ -9000 et protégé par un mur et une tour de pierre.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Pourquoi les hommes doivent-ils se sédentariser lorsqu'ils pratiquent l'agriculture ?",
      reponse: "Parce qu'il faut rester sur place pour semer, entretenir les cultures, puis attendre et surveiller la récolte, ce qui empêche de se déplacer comme avant.",
      explication: "L'agriculture impose un cycle annuel qui attache les hommes à un lieu précis.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Quels nouveaux objets apparaissent au Néolithique ?",
      reponse: "La pierre polie, la poterie (récipients en terre cuite) et les tissus fabriqués à partir de fibres végétales et animales.",
      explication: "Ces objets facilitent le stockage, la cuisson et l'habillement dans les villages sédentaires.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Combien d'habitants pouvait rassembler le village de Çatal Höyük ?",
      choix: ["Une dizaine", "Une centaine", "Plusieurs milliers", "Plusieurs millions"],
      bonneReponse: 2,
      explication: "Çatal Höyük, en Turquie actuelle, rassemblait plusieurs milliers d'habitants vers -7000.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Explique pourquoi on parle de « révolution néolithique » pour désigner ces changements.",
      reponse:
        "On parle de révolution car les changements sont profonds et transforment presque tous les aspects de la vie humaine (alimentation, habitat, organisation sociale) en un temps relativement court à l'échelle de la Préhistoire, après des millions d'années de mode de vie nomade inchangé.",
      explication: "Le terme insiste sur l'ampleur et la rapidité des bouleversements par rapport au reste de la Préhistoire.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Comment le surplus agricole peut-il faire naître des inégalités entre les hommes ?",
      reponse:
        "Certaines familles ou certains villages produisent plus de nourriture que nécessaire ; ce surplus peut être stocké, échangé contre d'autres biens ou accumulé, ce qui crée des différences de richesse et de pouvoir entre ceux qui possèdent plus et ceux qui possèdent moins.",
      explication: "C'est l'une des conséquences sociales majeures de la révolution néolithique.",
    },
    {
      type: "qcm",
      difficulte: "avance",
      question: "Quel type d'objets circule sur de longues distances entre les villages néolithiques ?",
      choix: ["Des tablettes d'écriture", "Du silex et des coquillages", "Des pièces de monnaie", "Des livres"],
      bonneReponse: 1,
      explication: "Le silex et les coquillages sont échangés sur de longues distances, preuve de réseaux d'échanges déjà développés.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Compare le mode de vie des hommes du Paléolithique et celui des hommes du Néolithique.",
      reponse:
        "Au Paléolithique, les hommes sont nomades, vivent de chasse, pêche et cueillette, et utilisent des outils de pierre taillée. Au Néolithique, ils deviennent sédentaires, pratiquent l'agriculture et l'élevage, vivent en villages, utilisent des outils de pierre polie et inventent la poterie, tout en connaissant les débuts des inégalités sociales.",
      explication: "Cette comparaison résume les grands changements entre les deux grandes périodes de la Préhistoire.",
    },
  ],
  revisionFinChapitre: [
    {
      type: "qcm",
      difficulte: "facile",
      question: "Quelles plantes les hommes domestiquent-ils en premier au Néolithique ?",
      choix: ["Le riz et le maïs", "Le blé, l'orge et les lentilles", "La pomme de terre", "Le café et le cacao"],
      bonneReponse: 1,
      explication: "Le blé, l'orge et les lentilles sont domestiqués très tôt au Proche-Orient.",
    },
    {
      type: "ouverte",
      difficulte: "facile",
      question: "Nomme deux animaux domestiqués au Néolithique.",
      reponse: "Les moutons et les chèvres (on peut aussi citer les bœufs ou les porcs).",
      explication: "L'élevage se développe en parallèle de l'agriculture.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Pourquoi construit-on des silos et des greniers au Néolithique ?",
      reponse: "Pour stocker les récoltes et pouvoir se nourrir toute l'année, entre deux moissons.",
      explication: "Le stockage devient indispensable avec la vie sédentaire et l'agriculture.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Quel village néolithique se trouve dans l'actuelle Turquie ?",
      choix: ["Jéricho", "Çatal Höyük", "Uruk", "Ur"],
      bonneReponse: 1,
      explication: "Çatal Höyük, en Turquie actuelle, est l'un des plus grands villages néolithiques connus.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "En une phrase, explique ce qui change avec la révolution néolithique.",
      reponse: "Les hommes passent d'un mode de vie nomade fondé sur la chasse et la cueillette à un mode de vie sédentaire fondé sur l'agriculture et l'élevage, dans des villages.",
      explication: "Cette phrase résume le changement central du chapitre.",
    },
  ],
  examens: [
    {
      titre: "Examen 1 — Le Néolithique et les premiers villages",
      dureeMinutes: 20,
      questions: [
        {
          type: "qcm",
          difficulte: "facile",
          question: "Vers quelle date commence la révolution néolithique ?",
          choix: ["-3 millions d'années", "-400 000 ans", "-10 000 ans", "-3300 ans"],
          bonneReponse: 2,
          explication: "La révolution néolithique commence vers -10 000 ans au Proche-Orient.",
        },
        {
          type: "ouverte",
          difficulte: "facile",
          question: "Qu'est-ce que l'agriculture ?",
          reponse: "La domestication et la culture de plantes (comme le blé ou l'orge) pour produire de la nourriture.",
          explication: "L'agriculture est l'une des deux grandes inventions du Néolithique, avec l'élevage.",
        },
        {
          type: "qcm",
          difficulte: "moyen",
          question: "Qu'est-ce qui entoure le village de Jéricho, preuve d'une organisation collective ?",
          choix: ["Un fossé rempli d'eau", "Un mur de pierre et une tour", "Une pyramide", "Un temple en bois"],
          bonneReponse: 1,
          explication: "Ce mur et cette tour, datés d'environ -9000, témoignent d'une organisation collective déjà développée.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Explique le lien entre agriculture et sédentarisation.",
          reponse: "Cultiver la terre demande de rester sur place pour semer, entretenir les cultures et attendre la récolte, ce qui pousse les hommes à s'installer durablement près de leurs champs.",
          explication: "La sédentarisation est une conséquence directe de la pratique de l'agriculture.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Pourquoi peut-on parler d'une vie collective organisée à Çatal Höyük ?",
          reponse: "Parce que plusieurs milliers d'habitants y vivent ensemble, dans des maisons construites côte à côte, ce qui suppose une organisation pour partager l'espace et les ressources.",
          explication: "La taille de ce village néolithique impressionne par son organisation pour l'époque.",
        },
        {
          type: "ouverte",
          difficulte: "avance",
          question:
            "Développement construit : explique comment l'invention de l'agriculture et de l'élevage transforme le mode de vie des hommes au Néolithique (une quinzaine de lignes).",
          reponse:
            "Introduction : vers -10 000 ans, au Proche-Orient, l'invention de l'agriculture et de l'élevage bouleverse la vie des hommes. Première partie : en domestiquant des plantes (blé, orge) et des animaux (moutons, chèvres), les hommes assurent une source de nourriture plus abondante et plus régulière que la chasse et la cueillette. Deuxième partie : cultiver la terre oblige les hommes à se sédentariser, à construire des maisons durables et à fonder des villages comme Jéricho ou Çatal Höyük. Troisième partie : cette nouvelle vie s'accompagne de nouvelles techniques (pierre polie, poterie) et de premières inégalités sociales, liées à l'accumulation et à l'échange des surplus agricoles. Conclusion : la révolution néolithique pose les bases des sociétés qui donneront bientôt naissance aux premières civilisations.",
          explication: "Un bon développement relie clairement causes (agriculture) et conséquences (sédentarisation, villages, inégalités).",
        },
      ],
    },
    {
      titre: "Examen 2 — Le Néolithique et les premiers villages",
      dureeMinutes: 20,
      questions: [
        {
          type: "qcm",
          difficulte: "facile",
          question: "Quel matériau les hommes apprennent-ils à travailler pour fabriquer des récipients ?",
          choix: ["Le métal", "La terre cuite (poterie)", "Le verre", "Le papyrus"],
          bonneReponse: 1,
          explication: "La poterie, en terre cuite, apparaît au Néolithique pour cuisiner et conserver les aliments.",
        },
        {
          type: "ouverte",
          difficulte: "facile",
          question: "Qu'est-ce que l'élevage ?",
          reponse: "La domestication d'animaux (comme les moutons ou les chèvres) pour en tirer viande, lait, laine ou peaux.",
          explication: "L'élevage complète l'agriculture dans l'économie néolithique.",
        },
        {
          type: "qcm",
          difficulte: "moyen",
          question: "Que produit parfois l'agriculture, en plus de nourrir la population ?",
          choix: ["Un surplus qui peut être échangé", "De l'or", "Des écritures", "Des monnaies"],
          bonneReponse: 0,
          explication: "Le surplus agricole permet le stockage et l'échange, et fait naître des inégalités.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Cite un exemple d'échange à longue distance entre villages néolithiques.",
          reponse: "L'échange de silex ou de coquillages entre des régions parfois très éloignées.",
          explication: "Ces échanges montrent que les villages néolithiques ne vivent pas isolés.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Pourquoi dit-on que le Néolithique prépare la naissance des premières civilisations ?",
          reponse: "Parce que la sédentarisation, l'agriculture, les villages organisés et les débuts d'inégalités sociales posent les bases nécessaires à l'apparition des premières villes et des premiers États.",
          explication: "Le Néolithique est une étape essentielle avant l'apparition des premières civilisations en Mésopotamie et en Égypte.",
        },
        {
          type: "ouverte",
          difficulte: "avance",
          question:
            "Développement construit : compare le mode de vie des hommes du Paléolithique à celui des hommes du Néolithique (une quinzaine de lignes).",
          reponse:
            "Introduction : le passage du Paléolithique au Néolithique transforme profondément la vie des hommes. Première partie : au Paléolithique, les hommes sont nomades, vivent de chasse, pêche et cueillette, et utilisent des outils de pierre taillée comme le biface. Deuxième partie : au Néolithique, ils deviennent sédentaires grâce à l'agriculture et à l'élevage, s'installent dans des villages comme Jéricho ou Çatal Höyük, et fabriquent des outils de pierre polie ainsi que de la poterie. Troisième partie : cette sédentarisation entraîne aussi l'apparition de surplus, d'échanges et des premières inégalités sociales, absentes des sociétés paléolithiques plus égalitaires. Conclusion : le Néolithique marque donc une rupture majeure qui annonce les futures civilisations.",
          explication: "On attend une comparaison structurée mobilisant le vocabulaire des deux périodes.",
        },
      ],
    },
  ],
  syntheseRevisions: [
    "Le Néolithique (« pierre nouvelle ») commence vers -10 000 ans au Proche-Orient.",
    "Invention de l'agriculture (blé, orge, lentilles) et de l'élevage (moutons, chèvres, bœufs).",
    "Sédentarisation : les hommes s'installent durablement et construisent des maisons durables.",
    "Premiers villages : Jéricho (mur et tour, vers -9000) et Çatal Höyük (plusieurs milliers d'habitants, vers -7000).",
    "Nouvelles techniques : pierre polie, poterie, tissage.",
    "Le surplus agricole entraîne échanges à longue distance et débuts des inégalités sociales.",
  ],
},
{
  slug: "prehistoire",
  titre: "La Préhistoire : les débuts de l'humanité",
  matiere: "histoire-geo",
  niveau: "6eme",
  description:
    "Découvrir la longue histoire des premiers hommes, du plus ancien ancêtre de l'humanité jusqu'à Homo sapiens, à travers l'évolution des outils, la maîtrise du feu et les premières œuvres d'art.",
  objectifs: [
    "Situer la Préhistoire dans le temps long et connaître ses grandes étapes",
    "Comprendre l'évolution des espèces humaines, de l'australopithèque à Homo sapiens",
    "Connaître les progrès techniques : outils de pierre taillée, maîtrise du feu",
    "Comprendre le mode de vie nomade des chasseurs-cueilleurs",
    "Connaître les premières formes d'art préhistorique",
  ],
  slides: [
    {
      titre: "Qu'est-ce que la Préhistoire ?",
      illustration: "🦴",
      visuel: "Avant l'écriture",
      contenu: [
        "La Préhistoire commence avec les premiers hommes, il y a environ 3 millions d'années",
        "Elle se termine avec l'invention de l'écriture, vers 3300 avant J.-C.",
        "On étudie cette période grâce à l'archéologie : fossiles, outils, ossements",
        "C'est une période immense, bien plus longue que toute l'Histoire écrite",
      ],
      voixOff:
        "La Préhistoire est la période la plus longue de l'aventure humaine. Elle commence avec l'apparition des premiers êtres humains, il y a environ trois millions d'années, et se termine avec l'invention de l'écriture, vers moins trois mille trois cents. Comme il n'existe aucun texte écrit pour cette époque, les historiens et les archéologues étudient des fossiles, des ossements et des outils retrouvés lors de fouilles pour reconstituer la vie de nos ancêtres.",
    },
    {
      titre: "Les premiers ancêtres de l'Homme",
      illustration: "🚶",
      visuel: "Lucy, -3,2 millions d'années",
      contenu: [
        "Les premiers hominidés apparaissent en Afrique il y a environ 3 à 4 millions d'années",
        "L'australopithèque « Lucy », découverte en Éthiopie en 1974, marche debout",
        "La bipédie (marcher sur deux jambes) libère les mains",
        "Homo habilis, il y a environ 2,4 millions d'années, fabrique les premiers outils",
      ],
      voixOff:
        "C'est en Afrique qu'apparaissent les tout premiers ancêtres de l'humanité, il y a environ trois à quatre millions d'années. Le squelette de l'australopithèque surnommé Lucy, découvert en Éthiopie en dix-neuf cent soixante-quatorze, montre qu'il marchait déjà debout sur ses deux jambes. Cette bipédie libère les mains, qui peuvent alors fabriquer des objets. Un peu plus tard, il y a environ deux millions quatre cent mille ans, apparaît Homo habilis, littéralement « l'homme habile », qui taille les premiers outils de pierre.",
    },
    {
      titre: "Homo erectus et la conquête du monde",
      illustration: "🌍",
      visuel: "Sortie d'Afrique",
      contenu: [
        "Homo erectus apparaît il y a environ 1,9 million d'années",
        "Il est le premier à quitter l'Afrique et à peupler l'Asie et l'Europe",
        "Il maîtrise le feu, attesté il y a environ 400 000 ans",
        "Le feu sert à se chauffer, s'éclairer, cuire les aliments et éloigner les prédateurs",
      ],
      voixOff:
        "Homo erectus, « l'homme debout », apparaît il y a environ un million neuf cent mille ans. C'est le premier être humain à quitter l'Afrique pour peupler progressivement l'Asie puis l'Europe. Une immense découverte marque cette période : la maîtrise du feu, attestée avec certitude il y a environ quatre cent mille ans. Le feu permet de se réchauffer, de s'éclairer dans les grottes, de cuire les aliments et d'éloigner les animaux dangereux.",
    },
    {
      titre: "Homo sapiens, notre espèce",
      illustration: "🧠",
      visuel: "-300 000 ans, Afrique",
      contenu: [
        "Homo sapiens apparaît en Afrique il y a environ 300 000 ans",
        "Il migre ensuite vers l'Europe et l'Asie, il y a environ 70 000 ans",
        "En Europe, il côtoie un temps l'Homme de Néandertal, qui disparaît vers -40 000 ans",
        "Homo sapiens est la seule espèce humaine qui existe encore aujourd'hui",
      ],
      voixOff:
        "Notre espèce, Homo sapiens, apparaît en Afrique il y a environ trois cent mille ans. Il quitte ensuite le continent africain et migre vers l'Europe et l'Asie, à partir d'environ soixante-dix mille ans. En Europe, il rencontre alors l'Homme de Néandertal, une autre espèce humaine, mieux adaptée au froid, qui disparaît vers moins quarante mille ans. Depuis, Homo sapiens est la seule espèce humaine présente sur Terre.",
    },
    {
      titre: "Le mode de vie des chasseurs-cueilleurs",
      illustration: "🏹",
      visuel: "Nomades",
      contenu: [
        "Pendant tout le Paléolithique, les hommes sont nomades",
        "Ils vivent de la chasse, de la pêche et de la cueillette",
        "Ils se déplacent au fil des saisons, en suivant le gibier",
        "Ils s'abritent dans des grottes, des abris sous roche ou des huttes légères",
      ],
      voixOff:
        "Le Paléolithique, ou « âge de la pierre ancienne », désigne la première et la plus longue période de la Préhistoire. Pendant tout ce temps, les hommes sont nomades : ils n'ont pas d'habitat fixe et se déplacent en fonction des saisons pour suivre les troupeaux d'animaux qu'ils chassent. Ils vivent aussi de la pêche et de la cueillette de fruits, de racines et de plantes. Pour s'abriter, ils utilisent des grottes, des abris sous roche, ou construisent des huttes légères avec des peaux et des os.",
    },
    {
      titre: "Des outils de plus en plus perfectionnés",
      illustration: "🔨",
      visuel: "Biface, silex",
      contenu: [
        "Les premiers outils sont de simples galets cassés (Homo habilis)",
        "Le biface, taillé sur ses deux faces, apparaît avec Homo erectus",
        "Homo sapiens invente des outils plus fins : pointes de sagaie, aiguilles en os",
        "Il invente aussi l'arc et les armes de jet pour chasser à distance",
      ],
      voixOff:
        "Au fil du temps, les outils deviennent de plus en plus perfectionnés. Les premiers, fabriqués par Homo habilis, sont de simples galets cassés à l'aide d'un autre caillou. Avec Homo erectus apparaît le biface, une pierre taillée sur ses deux faces pour couper et découper. Plus tard, Homo sapiens invente des outils bien plus fins, comme des pointes de sagaie ou des aiguilles en os pour coudre des vêtements, ainsi que l'arc, qui permet de chasser à distance.",
    },
    {
      titre: "L'art préhistorique",
      illustration: "🎨",
      visuel: "Lascaux, Chauvet",
      contenu: [
        "Homo sapiens crée les premières œuvres d'art il y a environ 40 000 ans",
        "La grotte Chauvet (Ardèche), peinte vers -36 000 ans, est l'une des plus anciennes",
        "La grotte de Lascaux (Dordogne), peinte vers -18 000 ans, montre de nombreux animaux",
        "On trouve aussi des statuettes (Vénus) et des gravures sur os",
      ],
      voixOff:
        "C'est avec Homo sapiens qu'apparaissent les premières œuvres d'art, il y a environ quarante mille ans. La grotte Chauvet, en Ardèche, peinte vers moins trente-six mille ans, est l'une des plus anciennes grottes ornées connues. La grotte de Lascaux, en Dordogne, peinte vers moins dix-huit mille ans, est célèbre pour ses immenses fresques représentant des chevaux, des aurochs et des cerfs. Les hommes préhistoriques sculptent aussi des statuettes féminines, appelées Vénus, et gravent des dessins sur des os.",
    },
    {
      titre: "Ce qu'il faut retenir",
      illustration: "🏆",
      visuel: "📌",
      contenu: [
        "La Préhistoire va de -3 millions d'années à -3300 (invention de l'écriture)",
        "Évolution : australopithèque, Homo habilis, Homo erectus, Homo sapiens",
        "Maîtrise du feu (-400 000 ans), outils de pierre, nomadisme",
        "Homo sapiens : premier art (Lascaux, Chauvet)",
      ],
      voixOff:
        "Résumons. La Préhistoire s'étend d'environ moins trois millions d'années jusqu'à l'invention de l'écriture, vers moins trois mille trois cents. Elle est marquée par l'évolution des espèces humaines, de l'australopithèque à Homo habilis, puis Homo erectus et enfin Homo sapiens. Les hommes préhistoriques maîtrisent le feu, fabriquent des outils de pierre de plus en plus perfectionnés et vivent en nomades, chassant, pêchant et cueillant leur nourriture. Avec Homo sapiens apparaissent les premières œuvres d'art, comme celles des grottes de Lascaux et Chauvet. Bravo, tu connais l'essentiel de ce chapitre !",
    },
  ],
  fiche: {
    intro:
      "La Préhistoire est la période la plus longue de l'humanité : elle commence avec les premiers hommes, il y a environ 3 millions d'années, et se termine avec l'invention de l'écriture, vers 3300 avant J.-C.",
    sections: [
      {
        titre: "L'évolution des espèces humaines",
        points: [
          "Australopithèque (« Lucy ») : -3,2 millions d'années, marche debout",
          "Homo habilis : -2,4 millions d'années, premiers outils de pierre",
          "Homo erectus : -1,9 million d'années, sort d'Afrique, maîtrise le feu (-400 000 ans)",
          "Homo sapiens : -300 000 ans en Afrique, seule espèce humaine actuelle",
        ],
      },
      {
        titre: "Le mode de vie des hommes préhistoriques",
        points: [
          "Nomades : chasseurs-cueilleurs qui se déplacent selon les saisons",
          "Habitats : grottes, abris sous roche, huttes légères",
          "Outils de pierre taillée (galets, bifaces) puis d'os",
        ],
      },
      {
        titre: "Le feu et les techniques",
        points: [
          "Maîtrise du feu : chauffage, cuisson, protection, lumière",
          "Invention de l'arc et des armes de jet pour la chasse à distance",
          "Aiguilles en os pour coudre des vêtements en peau",
        ],
      },
      {
        titre: "L'art préhistorique",
        points: [
          "Premières œuvres d'art avec Homo sapiens, vers -40 000 ans",
          "Grotte Chauvet (Ardèche, -36 000 ans) et grotte de Lascaux (Dordogne, -18 000 ans)",
          "Statuettes (Vénus) et gravures sur os",
        ],
      },
    ],
    audio:
      "Fiche de révision : la Préhistoire, les débuts de l'humanité. La Préhistoire commence avec les premiers hommes, il y a environ trois millions d'années, et se termine avec l'invention de l'écriture, vers moins trois mille trois cents. L'espèce humaine évolue lentement : l'australopithèque Lucy marche déjà debout il y a trois millions deux cent mille ans, Homo habilis fabrique les premiers outils de pierre il y a deux millions quatre cent mille ans, Homo erectus quitte l'Afrique et maîtrise le feu il y a environ quatre cent mille ans, puis Homo sapiens apparaît en Afrique il y a trois cent mille ans et devient la seule espèce humaine actuelle. Pendant tout le Paléolithique, les hommes sont nomades : ils vivent de chasse, de pêche et de cueillette, s'abritent dans des grottes et fabriquent des outils de pierre taillée de plus en plus perfectionnés. Avec Homo sapiens apparaissent aussi les premières œuvres d'art, comme les peintures des grottes de Lascaux et de Chauvet.",
  },
  memoCards: [
    { recto: "Quand commence et finit la Préhistoire ?", verso: "Elle commence il y a environ 3 millions d'années et se termine avec l'invention de l'écriture, vers 3300 av. J.-C." },
    { recto: "Qui est « Lucy » ?", verso: "Un australopithèque découvert en Éthiopie en 1974, vieux d'environ 3,2 millions d'années, qui marchait déjà debout." },
    { recto: "Quelle espèce fabrique les premiers outils ?", verso: "Homo habilis, il y a environ 2,4 millions d'années." },
    { recto: "Quelle espèce maîtrise le feu et sort d'Afrique ?", verso: "Homo erectus, qui maîtrise le feu vers -400 000 ans et peuple l'Asie et l'Europe." },
    { recto: "Quand et où apparaît Homo sapiens ?", verso: "En Afrique, il y a environ 300 000 ans." },
    { recto: "Qu'est-ce que le nomadisme ?", verso: "Un mode de vie où l'on se déplace sans habitat fixe, en suivant le gibier et les saisons." },
    { recto: "Cite deux grottes ornées préhistoriques.", verso: "La grotte Chauvet (Ardèche, -36 000 ans) et la grotte de Lascaux (Dordogne, -18 000 ans)." },
    { recto: "Qu'est-ce qu'un biface ?", verso: "Un outil de pierre taillée sur ses deux faces, utilisé pour couper et découper." },
  ],
  exercices: [
    {
      type: "qcm",
      difficulte: "facile",
      question: "Que marque la fin de la Préhistoire ?",
      choix: ["La maîtrise du feu", "L'invention de l'écriture", "L'apparition d'Homo sapiens", "La fin de la dernière glaciation"],
      bonneReponse: 1,
      explication: "La Préhistoire se termine avec l'invention de l'écriture, vers 3300 avant J.-C.",
    },
    {
      type: "qcm",
      difficulte: "facile",
      question: "Comment vivent les hommes pendant le Paléolithique ?",
      choix: ["Ils sont sédentaires dans des villages", "Ils sont nomades, chasseurs-cueilleurs", "Ils cultivent la terre", "Ils vivent dans des villes"],
      bonneReponse: 1,
      explication: "Pendant le Paléolithique, les hommes sont nomades et vivent de chasse, pêche et cueillette.",
    },
    {
      type: "ouverte",
      difficulte: "facile",
      ...
      reponse: "Lucy.",
      explication: "Ce fossile, vieux d'environ 3,2 millions d'années, montre que les australopithèques marchaient déjà debout.",
    },
    {
      type: "qcm",
      difficulte: "facile",
      question: "Quelle espèce humaine existe encore aujourd'hui ?",
      choix: ["Homo erectus", "Homo habilis", "Homo sapiens", "L'australopithèque"],
      bonneReponse: 2,
      explication: "Homo sapiens, apparu il y a environ 300 000 ans, est la seule espèce humaine encore présente sur Terre.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Quelle espèce est la première à maîtriser le feu ?",
      choix: ["L'australopithèque", "Homo habilis", "Homo erectus", "Homo sapiens"],
      bonneReponse: 2,
      explication: "La maîtrise du feu par Homo erectus est attestée avec certitude il y a environ 400 000 ans.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Pourquoi le feu est-il si important pour les hommes préhistoriques ?",
      reponse: "Il permet de se réchauffer, de s'éclairer, de cuire les aliments et d'éloigner les animaux dangereux.",
      explication: "La maîtrise du feu est une étape majeure du progrès technique préhistorique.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Qu'est-ce que la bipédie et pourquoi est-elle importante ?",
      reponse: "C'est le fait de marcher debout sur deux jambes. Elle est importante car elle libère les mains, qui peuvent alors fabriquer et utiliser des outils.",
      explication: "La bipédie apparaît dès les premiers hominidés, comme l'australopithèque Lucy.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Où et quand apparaît Homo sapiens ?",
      choix: ["En Europe, il y a 40 000 ans", "En Afrique, il y a environ 300 000 ans", "En Asie, il y a 1 million d'années", "En Amérique, il y a 100 000 ans"],
      bonneReponse: 1,
      explication: "Homo sapiens apparaît en Afrique il y a environ 300 000 ans, avant de migrer vers l'Europe et l'Asie.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Explique en quelques phrases l'évolution des espèces humaines, de l'australopithèque à Homo sapiens.",
      reponse:
        "L'australopithèque, comme Lucy, marche debout il y a environ 3,2 millions d'années. Homo habilis, vers -2,4 millions d'années, fabrique les premiers outils de pierre. Homo erectus, vers -1,9 million d'années, sort d'Afrique et maîtrise le feu. Enfin, Homo sapiens apparaît en Afrique il y a environ 300 000 ans et devient la seule espèce humaine actuelle.",
      explication: "Cette frise chronologique des espèces humaines est un repère essentiel du chapitre.",
    },
    {
      type: "qcm",
      difficulte: "avance",
      question: "Que s'est-il passé lorsque Homo sapiens est arrivé en Europe, vers -70 000 ans ?",
      choix: [
        "Il a rencontré et côtoyé l'Homme de Néandertal",
        "Il a rencontré les australopithèques",
        "Il a inventé l'écriture",
        "Il a fondé les premières villes",
      ],
      bonneReponse: 0,
      explication: "Homo sapiens a côtoyé l'Homme de Néandertal en Europe, avant que ce dernier ne disparaisse vers -40 000 ans.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Comment les archéologues et historiens connaissent-ils la Préhistoire, alors qu'il n'existe aucun texte écrit ?",
      reponse:
        "Ils étudient les traces matérielles laissées par les hommes préhistoriques : fossiles, ossements, outils de pierre, restes de foyers, peintures rupestres, grâce à des fouilles archéologiques.",
      explication: "L'absence d'écriture rend l'archéologie indispensable pour étudier cette période.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Pourquoi peut-on dire que l'art préhistorique marque une étape importante de l'histoire humaine ?",
      reponse:
        "Il montre qu'Homo sapiens développe une pensée symbolique et une vie culturelle, capable de représenter le monde qui l'entoure (animaux, silhouettes) au-delà des seuls besoins de survie.",
      explication: "Les grottes de Lascaux et Chauvet témoignent de cette capacité artistique et symbolique.",
    },
  ],
  revisionFinChapitre: [
    {
      type: "qcm",
      difficulte: "facile",
      question: "Quelle est la première espèce à fabriquer des outils de pierre ?",
      choix: ["L'australopithèque", "Homo habilis", "Homo erectus", "Homo sapiens"],
      bonneReponse: 1,
      explication: "Homo habilis, « l'homme habile », taille les premiers outils il y a environ 2,4 millions d'années.",
    },
    {
      type: "ouverte",
      difficulte: "facile",
      question: "Que signifie « nomade » ?",
      reponse: "Qui n'a pas d'habitat fixe et se déplace régulièrement, notamment pour suivre le gibier.",
      explication: "Les chasseurs-cueilleurs du Paléolithique sont nomades.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Cite deux grottes ornées et leur région.",
      reponse: "La grotte Chauvet en Ardèche et la grotte de Lascaux en Dordogne.",
      explication: "Ces deux grottes françaises comptent parmi les plus célèbres témoignages de l'art préhistorique.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Vers quelle date les hommes maîtrisent-ils le feu ?",
      choix: ["-3 millions d'années", "-400 000 ans", "-40 000 ans", "-3300 ans"],
      bonneReponse: 1,
      explication: "La maîtrise du feu par Homo erectus est attestée il y a environ 400 000 ans.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Pourquoi la Préhistoire est-elle considérée comme la période la plus longue de l'humanité ?",
      reponse: "Parce qu'elle s'étend sur environ 3 millions d'années, contre seulement quelques milliers d'années pour l'Histoire écrite.",
      explication: "Cette durée immense explique la lenteur de l'évolution des espèces et des techniques.",
    },
  ],
  examens: [
    {
      titre: "Examen 1 — La Préhistoire : les débuts de l'humanité",
      dureeMinutes: 20,
      questions: [
        {
          type: "qcm",
          difficulte: "facile",
          question: "Sur quel continent apparaissent les premiers hommes ?",
          choix: ["L'Europe", "L'Asie", "L'Afrique", "L'Amérique"],
          bonneReponse: 2,
          explication: "Les premiers hominidés, comme les australopithèques, apparaissent en Afrique.",
        },
        {
          type: "ouverte",
          difficulte: "facile",
          question: "Qu'est-ce que le Paléolithique ?",
          reponse: "La première et la plus longue période de la Préhistoire, pendant laquelle les hommes sont des chasseurs-cueilleurs nomades utilisant des outils de pierre taillée.",
          explication: "Le mot signifie littéralement « âge de la pierre ancienne ».",
        },
        {
          type: "qcm",
          difficulte: "moyen",
          question: "Quelle espèce humaine est la première à sortir d'Afrique ?",
          choix: ["L'australopithèque", "Homo habilis", "Homo erectus", "Homo sapiens"],
          bonneReponse: 2,
          explication: "Homo erectus, il y a environ 1,9 million d'années, est le premier à peupler l'Asie et l'Europe.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Décris deux progrès techniques réalisés pendant la Préhistoire.",
          reponse: "Par exemple : la taille des outils de pierre (galets, bifaces) et la maîtrise du feu, qui permet de se chauffer et de cuire les aliments.",
          explication: "Ces progrès techniques transforment progressivement le mode de vie des hommes préhistoriques.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Pourquoi peut-on dire que les hommes préhistoriques dépendent étroitement de leur environnement ?",
          reponse: "Parce qu'ils vivent de chasse, de pêche et de cueillette, se déplacent selon les saisons et le gibier, et utilisent les ressources naturelles (pierre, os, peaux) pour fabriquer leurs outils et vêtements.",
          explication: "Le mode de vie nomade illustre cette dépendance directe à la nature.",
        },
        {
          type: "ouverte",
          difficulte: "avance",
          question:
            "Développement construit : présente les grandes étapes de l'évolution humaine pendant la Préhistoire, des premiers hominidés à Homo sapiens (une quinzaine de lignes).",
          reponse:
            "Introduction : la Préhistoire, période la plus longue de l'humanité, est marquée par une lente évolution des espèces humaines. Première partie : en Afrique, l'australopithèque Lucy marche déjà debout il y a environ 3,2 millions d'années ; Homo habilis, vers -2,4 millions d'années, fabrique les premiers outils de pierre. Deuxième partie : Homo erectus, vers -1,9 million d'années, quitte l'Afrique pour peupler l'Asie et l'Europe, et maîtrise le feu vers -400 000 ans. Troisième partie : Homo sapiens apparaît en Afrique il y a environ 300 000 ans, migre à son tour vers l'Europe où il côtoie l'Homme de Néandertal, avant de devenir la seule espèce humaine. Conclusion : cette longue évolution s'accompagne de progrès techniques et culturels, jusqu'aux premières œuvres d'art.",
          explication: "Un bon développement mobilise les dates et espèces clés dans l'ordre chronologique.",
        },
      ],
    },
    {
      titre: "Examen 2 — La Préhistoire : les débuts de l'humanité",
      dureeMinutes: 20,
      questions: [
        {
          type: "qcm",
          difficulte: "facile",
          question: "Quelle grotte française, peinte vers -18 000 ans, est célèbre pour ses fresques d'animaux ?",
          choix: ["La grotte Chauvet", "La grotte de Lascaux", "La grotte de Font-de-Gaume", "La grotte Cosquer"],
          bonneReponse: 1,
          explication: "La grotte de Lascaux, en Dordogne, est mondialement connue pour ses peintures d'animaux.",
        },
        {
          type: "ouverte",
          difficulte: "facile",
          question: "Que mangent les hommes préhistoriques du Paléolithique ?",
          reponse: "Ils se nourrissent de la chasse, de la pêche et de la cueillette (fruits, racines, plantes).",
          explication: "Ils ne cultivent pas encore la terre et ne pratiquent pas l'élevage.",
        },
        {
          type: "qcm",
          difficulte: "moyen",
          question: "Vers quelle date situe-t-on la disparition de l'Homme de Néandertal ?",
          choix: ["-400 000 ans", "-40 000 ans", "-3300 ans", "-10 000 ans"],
          bonneReponse: 1,
          explication: "L'Homme de Néandertal disparaît vers -40 000 ans, après avoir côtoyé Homo sapiens en Europe.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Qu'est-ce qu'un biface et à quoi sert-il ?",
          reponse: "C'est un outil de pierre taillée sur ses deux faces, utilisé pour couper, découper la viande ou travailler le bois.",
          explication: "Le biface apparaît avec Homo erectus et marque un progrès dans la taille de la pierre.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Quelles sont les sources utilisées par les archéologues pour étudier la Préhistoire ?",
          reponse: "Les fossiles, les ossements, les outils retrouvés lors des fouilles, les foyers, ainsi que les peintures et gravures rupestres.",
          explication: "En l'absence d'écriture, ces traces matérielles sont les seules sources disponibles.",
        },
        {
          type: "ouverte",
          difficulte: "avance",
          question:
            "Développement construit : explique comment le mode de vie et les techniques des hommes préhistoriques évoluent au fil du temps (une quinzaine de lignes).",
          reponse:
            "Introduction : pendant toute la Préhistoire, les hommes transforment progressivement leur mode de vie et leurs techniques. Première partie : les premiers outils, de simples galets cassés fabriqués par Homo habilis, deviennent des bifaces plus élaborés avec Homo erectus. Deuxième partie : la maîtrise du feu, vers -400 000 ans, transforme la vie quotidienne : chauffage, cuisson, protection contre les prédateurs. Troisième partie : avec Homo sapiens apparaissent des outils plus fins (aiguilles en os, pointes de sagaie), l'arc, ainsi que les premières œuvres d'art comme les peintures de Lascaux et Chauvet. Conclusion : ces progrès témoignent d'une intelligence et d'une créativité croissantes, sans que les hommes cessent d'être nomades avant le Néolithique.",
          explication: "On attend une explication organisée et chronologique, avec du vocabulaire précis (biface, nomade, bipédie).",
        },
      ],
    },
  ],
  syntheseRevisions: [
    "La Préhistoire va d'environ -3 millions d'années à l'invention de l'écriture, vers -3300.",
    "Évolution des espèces : australopithèque (Lucy, -3,2 Ma), Homo habilis (-2,4 Ma), Homo erectus (-1,9 Ma), Homo sapiens (-300 000 ans).",
    "Homo erectus maîtrise le feu vers -400 000 ans et sort le premier d'Afrique.",
    "Homo sapiens, seule espèce humaine actuelle, côtoie l'Homme de Néandertal en Europe avant sa disparition (-40 000 ans).",
    "Mode de vie du Paléolithique : nomadisme, chasse, pêche, cueillette, outils de pierre taillée.",
    "Premières œuvres d'art avec Homo sapiens : grottes de Lascaux et Chauvet, statuettes, gravures.",
  ],
},
{
  slug: "premiers-etats-ecriture",
  titre: "Premiers États et premières écritures",
  matiere: "histoire-geo",
  niveau: "6eme",
  description:
    "Découvrir la naissance des premières civilisations en Mésopotamie et en Égypte : premières villes, premiers rois et pharaons, et invention de l'écriture, vers 3300 avant J.-C.",
  objectifs: [
    "Comprendre l'apparition des premières villes en Mésopotamie",
    "Connaître l'invention de l'écriture cunéiforme et son rôle",
    "Comprendre l'organisation du pouvoir en Mésopotamie et en Égypte",
    "Connaître les grandes caractéristiques de l'Égypte des pharaons",
    "Situer ces civilisations dans le temps et l'espace",
  ],
  slides: [
    {
      titre: "La Mésopotamie, terre entre deux fleuves",
      illustration: "🏞️",
      visuel: "Tigre et Euphrate",
      contenu: [
        "La Mésopotamie se situe entre les fleuves Tigre et Euphrate (actuel Irak)",
        "Son nom signifie « entre les fleuves » en grec",
        "Les fleuves fertilisent les terres grâce à leurs crues et permettent l'irrigation",
        "Cette région est l'un des premiers foyers de civilisation au monde",
      ],
      voixOff:
        "La Mésopotamie est une région située entre deux grands fleuves, le Tigre et l'Euphrate, dans l'actuel Irak. Son nom vient du grec et signifie « entre les fleuves ». Grâce aux crues régulières de ces fleuves et à l'irrigation des terres, l'agriculture y est particulièrement riche. C'est dans cette région que naît, il y a plus de cinq mille ans, l'une des toutes premières civilisations de l'histoire humaine.",
    },
    {
      titre: "Les premières villes : Uruk",
      illustration: "🏙️",
      visuel: "Uruk, -3500",
      contenu: [
        "Uruk, vers -3500, est l'une des premières grandes villes du monde",
        "Elle peut compter plusieurs dizaines de milliers d'habitants",
        "On y trouve des temples, des palais et des quartiers d'artisans",
        "La ville est protégée par de puissants remparts",
      ],
      voixOff:
        "En Mésopotamie apparaissent les toutes premières villes de l'histoire. Uruk, fondée vers moins trois mille cinq cents, en est l'un des meilleurs exemples : elle rassemble plusieurs dizaines de milliers d'habitants, un nombre considérable pour l'époque. On y trouve de grands temples dédiés aux dieux, des palais pour les dirigeants, ainsi que des quartiers d'artisans. De puissants remparts protègent la cité des attaques ennemies.",
    },
    {
      titre: "L'invention de l'écriture cunéiforme",
      illustration: "📜",
      visuel: "-3300, tablettes d'argile",
      contenu: [
        "Vers -3300, les Sumériens inventent l'écriture en Mésopotamie",
        "Elle est d'abord utilisée pour compter les récoltes et les marchandises",
        "On écrit avec un roseau taillé (calame) sur des tablettes d'argile molle",
        "Cette écriture, faite de signes en forme de coins, est dite « cunéiforme »",
      ],
      voixOff:
        "C'est en Mésopotamie, vers moins trois mille trois cents, que les Sumériens inventent l'écriture, l'une des découvertes les plus importantes de l'histoire humaine. Elle sert d'abord à un usage très concret : compter les récoltes de blé, les têtes de bétail ou les marchandises stockées dans les temples. Les scribes écrivent à l'aide d'un roseau taillé, le calame, sur des tablettes d'argile encore molles. Les signes, en forme de petits coins, donnent son nom à cette écriture : le cunéiforme.",
    },
    {
      titre: "Le pouvoir en Mésopotamie",
      illustration: "👑",
      visuel: "Roi, temple",
      contenu: [
        "Chaque ville de Mésopotamie forme une cité-État dirigée par un roi",
        "Le roi gouverne au nom des dieux et rend la justice",
        "Le roi Hammurabi de Babylone (vers -1750) rédige l'un des premiers codes de lois",
        "Ce code fixe des règles et des punitions précises pour toute la population",
      ],
      voixOff:
        "En Mésopotamie, chaque grande ville forme une cité-État, dirigée par un roi qui gouverne au nom des dieux et rend la justice. L'un des rois les plus célèbres est Hammurabi, roi de Babylone vers moins mille sept cent cinquante, qui fait rédiger l'un des tout premiers codes de lois de l'histoire. Gravé sur une stèle de pierre, ce code fixe des règles précises et des punitions pour organiser la vie en société.",
    },
    {
      titre: "L'Égypte, don du Nil",
      illustration: "🌊",
      visuel: "Fleuve Nil",
      contenu: [
        "L'Égypte s'organise autour du fleuve Nil, qui traverse le désert",
        "Ses crues annuelles déposent un limon fertile sur les rives",
        "Cette fertilité permet une agriculture abondante (blé, orge)",
        "L'historien grec Hérodote dira plus tard : « l'Égypte est un don du Nil »",
      ],
      voixOff:
        "En Afrique du Nord, une autre grande civilisation se développe autour du fleuve Nil, qui traverse le désert d'Égypte. Chaque année, les crues du Nil déposent sur ses rives un limon noir très fertile, permettant une agriculture abondante de blé et d'orge. Cette dépendance vitale au fleuve inspirera plus tard à l'historien grec Hérodote une phrase célèbre : « l'Égypte est un don du Nil ».",
    },
    {
      titre: "Le pharaon et les hiéroglyphes",
      illustration: "𓂀",
      visuel: "-3200, hiéroglyphes",
      contenu: [
        "Vers -3200, les Égyptiens inventent leur propre écriture : les hiéroglyphes",
        "Ils écrivent sur du papyrus, une plante du Nil transformée en feuille",
        "Le pharaon est le roi d'Égypte, considéré comme un dieu vivant",
        "Il est aidé dans son gouvernement par des scribes et des fonctionnaires",
      ],
      voixOff:
        "Vers moins trois mille deux cents, les Égyptiens inventent à leur tour une écriture originale : les hiéroglyphes, des signes représentant des objets, des animaux ou des sons. Ils écrivent sur le papyrus, une plante qui pousse le long du Nil et que l'on transforme en feuilles. Le souverain de l'Égypte, le pharaon, est considéré comme un dieu vivant sur Terre. Il gouverne le pays avec l'aide de nombreux scribes et fonctionnaires chargés de l'administration.",
    },
    {
      titre: "Les pyramides, tombeaux des pharaons",
      illustration: "🔺",
      visuel: "Khéops, -2560",
      contenu: [
        "Les pharaons font construire d'immenses pyramides comme tombeaux",
        "La grande pyramide de Khéops, à Gizeh, date d'environ -2560",
        "Ces monuments protègent le corps momifié du pharaon pour l'au-delà",
        "Leur construction mobilise des milliers d'ouvriers pendant plusieurs années",
      ],
      voixOff:
        "Pour honorer leur pharaon après sa mort, les Égyptiens construisent d'immenses pyramides qui servent de tombeaux. La plus célèbre, la grande pyramide de Khéops à Gizeh, est achevée vers moins deux mille cinq cent soixante. Les Égyptiens croient en une vie après la mort : le corps du pharaon est momifié pour être conservé, et la pyramide protège son tombeau ainsi que les objets qui l'accompagnent dans l'au-delà. Ces chantiers colossaux mobilisent des milliers d'ouvriers pendant de longues années.",
    },
    {
      titre: "Ce qu'il faut retenir",
      illustration: "🏆",
      visuel: "📌",
      contenu: [
        "Mésopotamie (Tigre, Euphrate) : premières villes (Uruk), écriture cunéiforme (-3300)",
        "Égypte (Nil) : hiéroglyphes (-3200), pharaon, pyramides",
        "L'écriture marque la fin de la Préhistoire et le début de l'Histoire",
        "Ces sociétés inventent aussi les premiers États organisés et les premières lois",
      ],
      voixOff:
        "Résumons. En Mésopotamie, entre le Tigre et l'Euphrate, apparaissent les premières grandes villes, comme Uruk, et l'écriture cunéiforme, vers moins trois mille trois cents. En Égypte, le long du Nil, les hommes inventent les hiéroglyphes vers moins trois mille deux cents et sont gouvernés par un pharaon considéré comme un dieu, qui fait construire d'immenses pyramides. L'invention de l'écriture marque la fin de la Préhistoire et le début de l'Histoire. Ces civilisations inventent aussi les premiers États organisés et les premières lois écrites. Bravo, tu connais l'essentiel de ce chapitre !",
    },
  ],
  fiche: {
    intro:
      "Il y a plus de 5000 ans, en Mésopotamie puis en Égypte, naissent les premières grandes civilisations : premières villes, premiers États organisés autour d'un roi ou d'un pharaon, et invention de l'écriture, qui marque le début de l'Histoire.",
    sections: [
      {
        titre: "La Mésopotamie",
        points: [
          "Région entre les fleuves Tigre et Euphrate (actuel Irak)",
          "Premières villes : Uruk, vers -3500, plusieurs dizaines de milliers d'habitants",
          "Écriture cunéiforme inventée vers -3300, sur tablettes d'argile",
        ],
      },
      {
        titre: "Le pouvoir en Mésopotamie",
        points: [
          "Cités-États dirigées par un roi, gouvernant au nom des dieux",
          "Hammurabi de Babylone (vers -1750) : l'un des premiers codes de lois",
        ],
      },
      {
        titre: "L'Égypte des pharaons",
        points: [
          "Civilisation organisée autour du Nil, qui fertilise les terres à chaque crue",
          "Écriture hiéroglyphique inventée vers -3200, sur papyrus",
          "Le pharaon, roi considéré comme un dieu vivant",
        ],
      },
      {
        titre: "Les grands monuments égyptiens",
        points: [
          "Les pyramides, tombeaux des pharaons (Khéops, vers -2560)",
          "La momification pour préparer la vie après la mort",
          "Des chantiers colossaux mobilisant des milliers d'ouvriers",
        ],
      },
    ],
    audio:
      "Fiche de révision : premiers États et premières écritures. En Mésopotamie, entre les fleuves Tigre et Euphrate, naissent les premières grandes villes, comme Uruk vers moins trois mille cinq cents. Vers moins trois mille trois cents, les Sumériens y inventent l'écriture cunéiforme, tracée avec un calame sur des tablettes d'argile. Chaque ville forme une cité-État dirigée par un roi, comme Hammurabi de Babylone, qui rédige vers moins mille sept cent cinquante l'un des premiers codes de lois. En Égypte, le long du Nil dont les crues fertilisent les terres, les Égyptiens inventent une autre écriture, les hiéroglyphes, vers moins trois mille deux cents, tracés sur du papyrus. Le pharaon, roi considéré comme un dieu vivant, gouverne le pays et fait construire d'immenses pyramides, comme celle de Khéops, pour servir de tombeau après sa mort. L'invention de l'écriture marque la fin de la Préhistoire et le début de l'Histoire.",
  },
  memoCards: [
    { recto: "Entre quels fleuves se situe la Mésopotamie ?", verso: "Entre le Tigre et l'Euphrate, dans l'actuel Irak." },
    { recto: "Quelle est l'une des premières villes de Mésopotamie ?", verso: "Uruk, fondée vers -3500." },
    { recto: "Quand et où est inventée l'écriture cunéiforme ?", verso: "Vers -3300, en Mésopotamie, par les Sumériens." },
    { recto: "Qu'est-ce qu'une cité-État ?", verso: "Une ville organisée comme un État indépendant, dirigée par son propre roi." },
    { recto: "Qui est Hammurabi et qu'a-t-il fait ?", verso: "Un roi de Babylone (vers -1750) qui a fait rédiger l'un des premiers codes de lois." },
    { recto: "Quand et où est inventée l'écriture hiéroglyphique ?", verso: "Vers -3200, en Égypte." },
    { recto: "Qui est le pharaon ?", verso: "Le roi d'Égypte, considéré comme un dieu vivant." },
    { recto: "À quoi servent les pyramides d'Égypte ?", verso: "Ce sont des tombeaux monumentaux construits pour les pharaons." },
  ],
  exercices: [
    {
      type: "qcm",
      difficulte: "facile",
      question: "Entre quels deux fleuves se situe la Mésopotamie ?",
      choix: ["Le Nil et le Jourdain", "Le Tigre et l'Euphrate", "Le Rhône et le Rhin", "L'Indus et le Gange"],
      bonneReponse: 1,
      explication: "Le mot Mésopotamie signifie « entre les fleuves », le Tigre et l'Euphrate.",
    },
    {
      type: "qcm",
      difficulte: "facile",
      question: "Quelle invention marque la fin de la Préhistoire ?",
      choix: ["L'agriculture", "L'écriture", "Le feu", "La roue"],
      bonneReponse: 1,
      explication: "L'invention de l'écriture, vers -3300, marque conventionnellement le début de l'Histoire.",
    },
    {
      type: "ouverte",
      difficulte: "facile",
      question: "Comment appelle-t-on le roi d'Égypte ?",
      reponse: "Le pharaon.",
      explication: "Le pharaon est considéré par les Égyptiens comme un dieu vivant sur Terre.",
    },
    {
      type: "qcm",
      difficulte: "facile",
      question: "Sur quel support les Égyptiens écrivent-ils leurs hiéroglyphes ?",
      choix: ["Des tablettes d'argile", "Le papyrus", "Des feuilles de pierre", "Du parchemin"],
      bonneReponse: 1,
      explication: "Le papyrus est une plante du Nil transformée en support d'écriture.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "À quoi sert d'abord l'écriture cunéiforme en Mésopotamie ?",
      choix: ["À écrire des poèmes", "À compter les récoltes et les marchandises", "À écrire des lois religieuses", "À dessiner des cartes"],
      bonneReponse: 1,
      explication: "L'écriture est d'abord un outil de comptabilité pour les temples et les palais.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Pourquoi peut-on dire que « l'Égypte est un don du Nil » ?",
      reponse: "Parce que les crues annuelles du Nil déposent un limon fertile sur ses rives, ce qui permet une agriculture riche dans un pays entouré de désert.",
      explication: "Cette phrase est attribuée à l'historien grec Hérodote.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Qu'est-ce que le code d'Hammurabi ?",
      reponse: "L'un des premiers codes de lois de l'histoire, rédigé vers -1750 par le roi de Babylone Hammurabi, gravé sur une stèle de pierre.",
      explication: "Il fixe des règles et des punitions précises pour organiser la société babylonienne.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Que représente la pyramide de Khéops ?",
      choix: ["Un temple pour les dieux", "Le tombeau d'un pharaon", "Un palais royal", "Un grenier à blé"],
      bonneReponse: 1,
      explication: "La pyramide de Khéops, à Gizeh, est le tombeau monumental du pharaon Khéops, vers -2560.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Explique pourquoi l'écriture est une invention essentielle pour l'organisation des premiers États.",
      reponse:
        "L'écriture permet de conserver des informations (comptes, lois, décisions royales), de les transmettre sur de longues distances et dans le temps, et donc de mieux administrer un territoire, gérer les récoltes, les impôts et rendre la justice.",
      explication: "L'écriture est un outil indispensable au fonctionnement des premiers États organisés.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Compare le rôle du roi en Mésopotamie et celui du pharaon en Égypte.",
      reponse:
        "En Mésopotamie, le roi dirige une cité-État et gouverne au nom des dieux, en rendant la justice, comme Hammurabi et son code de lois. En Égypte, le pharaon est considéré comme un dieu lui-même, incarné sur Terre, et dirige tout le pays avec l'aide de scribes et de fonctionnaires.",
      explication: "Cette comparaison montre deux formes différentes d'organisation du pouvoir dans l'Antiquité.",
    },
    {
      type: "qcm",
      difficulte: "avance",
      question: "Comment appelle-t-on les fonctionnaires égyptiens capables de lire et d'écrire ?",
      choix: ["Les pharaons", "Les scribes", "Les prêtres uniquement", "Les esclaves"],
      bonneReponse: 1,
      explication: "Les scribes forment une catégorie sociale importante, indispensable à l'administration égyptienne.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Pourquoi les fleuves (Tigre, Euphrate, Nil) sont-ils si importants pour la naissance de ces civilisations ?",
      reponse:
        "Ils fertilisent les terres grâce à leurs crues, permettent l'irrigation des cultures et donc une agriculture abondante capable de nourrir de grandes populations, ce qui favorise la naissance de villes et d'États organisés.",
      explication: "Ces civilisations sont parfois qualifiées de « civilisations fluviales » tant les fleuves sont centraux dans leur développement.",
    },
  ],
  revisionFinChapitre: [
    {
      type: "qcm",
      difficulte: "facile",
      question: "Comment s'appelle l'écriture inventée en Mésopotamie ?",
      choix: ["Les hiéroglyphes", "L'écriture cunéiforme", "L'alphabet grec", "L'écriture latine"],
      bonneReponse: 1,
      explication: "L'écriture cunéiforme, faite de signes en forme de coins, est inventée vers -3300.",
    },
    {
      type: "ouverte",
      difficulte: "facile",
      question: "Quel fleuve traverse l'Égypte et fertilise ses terres ?",
      reponse: "Le Nil.",
      explication: "Les crues annuelles du Nil déposent un limon fertile sur ses rives.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Que fait construire le pharaon pour préparer sa vie après la mort ?",
      reponse: "Une pyramide, qui sert de tombeau monumental et protège son corps momifié.",
      explication: "Les Égyptiens croient en une vie après la mort, d'où l'importance de ces monuments.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Qui est Hammurabi ?",
      choix: ["Un pharaon d'Égypte", "Un roi de Babylone auteur d'un code de lois", "Un scribe égyptien", "Un dieu mésopotamien"],
      bonneReponse: 1,
      explication: "Hammurabi, roi de Babylone vers -1750, fait rédiger l'un des premiers codes de lois de l'histoire.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Pourquoi dit-on que l'écriture marque le début de l'Histoire ?",
      reponse: "Parce qu'à partir de son invention, les hommes laissent des documents écrits qui permettent aux historiens d'étudier le passé autrement que par les seules traces archéologiques.",
      explication: "C'est la convention utilisée pour distinguer la Préhistoire de l'Histoire.",
    },
  ],
  examens: [
    {
      titre: "Examen 1 — Premiers États et premières écritures",
      dureeMinutes: 20,
      questions: [
        {
          type: "qcm",
          difficulte: "facile",
          question: "Dans quelle région naît la civilisation mésopotamienne ?",
          choix: ["Entre le Tigre et l'Euphrate", "Le long du Nil", "En Grèce", "En Italie"],
          bonneReponse: 0,
          explication: "La Mésopotamie se situe entre les fleuves Tigre et Euphrate.",
        },
        {
          type: "ouverte",
          difficulte: "facile",
          question: "Qu'est-ce que le cunéiforme ?",
          reponse: "Une écriture inventée en Mésopotamie vers -3300, faite de signes en forme de coins, tracés au calame sur des tablettes d'argile.",
          explication: "C'est l'une des toutes premières écritures de l'histoire humaine.",
        },
        {
          type: "qcm",
          difficulte: "moyen",
          question: "Qu'est-ce qu'une cité-État en Mésopotamie ?",
          choix: [
            "Un empire qui domine tout le Proche-Orient",
            "Une ville organisée comme un État indépendant, dirigée par un roi",
            "Un temple géant",
            "Une région désertique inhabitée",
          ],
          bonneReponse: 1,
          explication: "Chaque grande ville de Mésopotamie, comme Uruk ou Babylone, forme sa propre cité-État.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Que fait le pharaon pour préparer son passage dans l'au-delà ?",
          reponse: "Il fait momifier son corps et construire une pyramide qui abrite son tombeau et les objets qui l'accompagnent après sa mort.",
          explication: "Les Égyptiens croient fermement en une vie après la mort.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Explique pourquoi le Nil est essentiel à la civilisation égyptienne.",
          reponse: "Ses crues annuelles fertilisent les terres avec du limon, ce qui permet une agriculture riche malgré le désert environnant, et le fleuve sert aussi de voie de transport et de communication.",
          explication: "C'est pourquoi Hérodote disait que « l'Égypte est un don du Nil ».",
        },
        {
          type: "ouverte",
          difficulte: "avance",
          question:
            "Développement construit : présente les grandes caractéristiques de la civilisation mésopotamienne (villes, écriture, pouvoir) en une quinzaine de lignes.",
          reponse:
            "Introduction : entre le Tigre et l'Euphrate se développe, il y a plus de cinq mille ans, l'une des premières civilisations de l'histoire. Première partie : des villes comme Uruk rassemblent dès -3500 plusieurs dizaines de milliers d'habitants, avec temples, palais et remparts. Deuxième partie : vers -3300, les Sumériens y inventent l'écriture cunéiforme, d'abord pour compter récoltes et marchandises, tracée sur des tablettes d'argile avec un calame. Troisième partie : chaque ville forme une cité-État dirigée par un roi, comme Hammurabi de Babylone, qui rédige vers -1750 l'un des premiers codes de lois. Conclusion : la Mésopotamie invente ainsi les premières villes, la première écriture et les premières lois écrites de l'humanité.",
          explication: "Un bon développement organise clairement villes, écriture et pouvoir, avec dates et exemples précis.",
        },
      ],
    },
    {
      titre: "Examen 2 — Premiers États et premières écritures",
      dureeMinutes: 20,
      questions: [
        {
          type: "qcm",
          difficulte: "facile",
          question: "Comment appelle-t-on l'écriture inventée en Égypte ?",
          choix: ["Le cunéiforme", "Les hiéroglyphes", "L'alphabet phénicien", "Le grec ancien"],
          bonneReponse: 1,
          explication: "Les hiéroglyphes sont inventés en Égypte vers -3200.",
        },
        {
          type: "ouverte",
          difficulte: "facile",
          question: "Comment appelle-t-on les fonctionnaires égyptiens sachant lire et écrire ?",
          reponse: "Les scribes.",
          explication: "Ils occupent une place importante dans l'administration égyptienne.",
        },
        {
          type: "qcm",
          difficulte: "moyen",
          question: "Sur quel support écrit-on le cunéiforme mésopotamien ?",
          choix: ["Le papyrus", "Des tablettes d'argile", "Du parchemin", "Des feuilles de pierre"],
          bonneReponse: 1,
          explication: "Les scribes mésopotamiens écrivent avec un calame sur de l'argile encore molle.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Que sait-on de la ville d'Uruk ?",
          reponse: "C'est l'une des premières grandes villes de l'histoire, fondée vers -3500 en Mésopotamie, avec plusieurs dizaines de milliers d'habitants, des temples, des palais et des remparts.",
          explication: "Uruk est un exemple emblématique des premières villes mésopotamiennes.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Quel est le but du code d'Hammurabi ?",
          reponse: "Fixer des règles précises et des punitions pour organiser la vie en société et permettre au roi de rendre une justice plus uniforme dans son royaume.",
          explication: "C'est l'un des plus anciens codes de lois connus, gravé sur une stèle de pierre.",
        },
        {
          type: "ouverte",
          difficulte: "avance",
          question:
            "Développement construit : présente les grandes caractéristiques de la civilisation égyptienne (le Nil, l'écriture, le pharaon, les pyramides) en une quinzaine de lignes.",
          reponse:
            "Introduction : le long du Nil se développe, à partir de plus de cinq mille ans, la grande civilisation égyptienne. Première partie : les crues annuelles du Nil fertilisent les terres du désert et permettent une agriculture riche, à l'origine de la formule « l'Égypte est un don du Nil ». Deuxième partie : vers -3200, les Égyptiens inventent les hiéroglyphes, une écriture tracée sur du papyrus, utilisée notamment par les scribes de l'administration. Troisième partie : le pharaon, roi considéré comme un dieu vivant, gouverne le pays et fait construire d'immenses pyramides, comme celle de Khéops vers -2560, pour servir de tombeau après sa mort et sa momification. Conclusion : l'Égypte antique forme ainsi l'une des grandes civilisations fondatrices de l'histoire humaine.",
          explication: "On attend une présentation organisée mobilisant fleuve, écriture, pouvoir et monuments.",
        },
      ],
    },
  ],
  syntheseRevisions: [
    "La Mésopotamie se situe entre le Tigre et l'Euphrate (actuel Irak) ; l'Égypte se développe le long du Nil.",
    "Premières villes vers -3500 (Uruk) : temples, palais, remparts, plusieurs dizaines de milliers d'habitants.",
    "L'écriture cunéiforme (Mésopotamie, -3300) marque la fin de la Préhistoire et le début de l'Histoire.",
    "Les hiéroglyphes (Égypte, -3200) sont écrits sur du papyrus.",
    "Le roi mésopotamien gouverne une cité-État ; Hammurabi rédige un code de lois vers -1750.",
    "Le pharaon, considéré comme un dieu, fait construire des pyramides comme tombeaux (Khéops, vers -2560).",
  ],
},
{
  slug: "rome-republique-empire",
  titre: "Rome, de la République à l'Empire",
  matiere: "histoire-geo",
  niveau: "6eme",
  description:
    "Découvrir l'histoire de Rome, de sa fondation légendaire à la naissance de l'Empire romain : les institutions de la République, la conquête de la Méditerranée et le passage à l'Empire avec Auguste.",
  objectifs: [
    "Connaître la fondation légendaire de Rome et les débuts de son histoire",
    "Comprendre l'organisation politique de la République romaine",
    "Connaître les grandes étapes de la conquête romaine autour de la Méditerranée",
    "Comprendre le passage de la République à l'Empire avec Auguste",
    "Connaître quelques aspects de la vie quotidienne dans l'Empire romain",
  ],
  slides: [
    {
      titre: "La fondation légendaire de Rome",
      illustration: "🐺",
      visuel: "-753",
      contenu: [
        "La légende raconte que Rome est fondée par Romulus en -753",
        "Romulus et son frère Remus auraient été élevés par une louve",
        "Rome se développe sur sept collines, au bord du fleuve Tibre, en Italie",
        "Elle est d'abord dirigée par des rois, avant de devenir une République",
      ],
      voixOff:
        "Selon la légende, Rome est fondée en moins sept cent cinquante-trois par Romulus, qui aurait été élevé, avec son frère jumeau Remus, par une louve dans leur enfance. En réalité, la ville se développe progressivement sur sept collines, au bord du fleuve Tibre, en Italie. Rome est d'abord gouvernée par des rois, avant que les Romains ne décident, selon la tradition, de fonder une République.",
    },
    {
      titre: "La République romaine",
      illustration: "🏛️",
      visuel: "-509, Sénat",
      contenu: [
        "En -509, les Romains chassent leur dernier roi et fondent la République",
        "Le mot République vient du latin « res publica », la chose publique",
        "Le pouvoir est partagé entre le Sénat, les assemblées et deux consuls",
        "Les consuls, élus pour un an, dirigent Rome et commandent les armées",
      ],
      voixOff:
        "En moins cinq cent neuf, les Romains chassent leur dernier roi et fondent la République, un mot qui vient du latin « res publica », c'est-à-dire « la chose publique ». Le pouvoir n'est plus entre les mains d'un seul homme, mais partagé entre le Sénat, une assemblée de grands notables, les assemblées du peuple, et deux consuls, élus chaque année, qui dirigent la cité et commandent les armées.",
    },
    {
      titre: "Patriciens et plébéiens",
      illustration: "⚖️",
      visuel: "Société romaine",
      contenu: [
        "La société romaine distingue les patriciens, familles nobles, et les plébéiens, le peuple",
        "Au début de la République, seuls les patriciens ont accès aux plus hautes fonctions",
        "Les plébéiens obtiennent peu à peu plus de droits, notamment leurs propres représentants",
        "Ces représentants, les tribuns de la plèbe, défendent les intérêts du peuple",
      ],
      voixOff:
        "La société de la République romaine est divisée entre les patriciens, membres des familles nobles les plus anciennes, et les plébéiens, qui forment le reste du peuple. Au début, seuls les patriciens peuvent accéder aux plus hautes fonctions politiques. Mais au fil du temps, les plébéiens obtiennent de nouveaux droits, notamment celui d'élire leurs propres représentants, les tribuns de la plèbe, chargés de défendre leurs intérêts face aux patriciens.",
    },
    {
      titre: "La conquête de l'Italie puis de la Méditerranée",
      illustration: "🗺️",
      visuel: "Guerres puniques",
      contenu: [
        "Rome conquiert progressivement toute l'Italie, du Ve au IIIe siècle av. J.-C.",
        "Elle affronte ensuite Carthage lors des guerres puniques (-264 à -146)",
        "Le général carthaginois Hannibal envahit l'Italie mais est finalement vaincu",
        "En -146, Rome détruit Carthage et domine tout le bassin méditerranéen",
      ],
      voixOff:
        "Après avoir conquis l'ensemble de l'Italie, Rome affronte la puissante cité de Carthage, en Afrique du Nord, lors de trois guerres appelées les guerres puniques, entre moins deux cent soixante-quatre et moins cent quarante-six. Le célèbre général carthaginois Hannibal envahit même l'Italie en traversant les Alpes avec des éléphants, mais il est finalement vaincu. En moins cent quarante-six, Rome détruit Carthage et devient la puissance dominante de toute la Méditerranée.",
    },
    {
      titre: "Jules César et la fin de la République",
      illustration: "👑",
      visuel: "Jules César",
      contenu: [
        "Au Ier siècle av. J.-C., de puissants généraux se disputent le pouvoir à Rome",
        "Jules César conquiert la Gaule (aujourd'hui la France) entre -58 et -51",
        "Il concentre progressivement tous les pouvoirs entre ses mains",
        "Il est assassiné par des sénateurs en -44, craignant qu'il ne devienne roi",
      ],
      voixOff:
        "Au premier siècle avant Jésus-Christ, la République romaine traverse une période de troubles, marquée par la rivalité de puissants généraux. Jules César se distingue en conquérant la Gaule, entre moins cinquante-huit et moins cinquante et un. Devenu très puissant, il concentre progressivement tous les pouvoirs entre ses mains, ce qui inquiète de nombreux sénateurs, attachés à la République. Craignant qu'il ne se proclame roi, ils l'assassinent en moins quarante-quatre.",
    },
    {
      titre: "Auguste, le premier empereur",
      illustration: "👑",
      visuel: "-27, Pax Romana",
      contenu: [
        "Après la mort de César, son fils adoptif Octave prend le pouvoir",
        "En -27, il reçoit le titre d'Auguste et devient le premier empereur romain",
        "La République laisse place à l'Empire, un pouvoir désormais héréditaire",
        "Commence alors la Pax Romana, une longue période de paix relative dans l'Empire",
      ],
      voixOff:
        "Après l'assassinat de César, son fils adoptif Octave élimine progressivement ses rivaux et prend le pouvoir seul. En moins vingt-sept, il reçoit du Sénat le titre d'Auguste, qui signifie « le vénérable », et devient ainsi le tout premier empereur romain. La République laisse place à l'Empire : le pouvoir n'est plus partagé mais concentré entre les mains d'un seul homme, dont la fonction devient héréditaire. Commence alors la Pax Romana, une longue période de paix relative dans tout l'Empire.",
    },
    {
      titre: "L'Empire romain, un immense territoire",
      illustration: "🌍",
      visuel: "Routes, aqueducs",
      contenu: [
        "À son apogée, l'Empire romain entoure toute la mer Méditerranée",
        "Il s'étend de la Bretagne (Angleterre) à l'Égypte et à la Mésopotamie",
        "Un immense réseau de routes relie toutes les provinces de l'Empire",
        "Les Romains construisent aussi des aqueducs pour amener l'eau dans les villes",
      ],
      voixOff:
        "À son apogée, au deuxième siècle après Jésus-Christ, l'Empire romain entoure entièrement la mer Méditerranée, que les Romains appellent « mare nostrum », notre mer. Il s'étend de la Bretagne, l'actuelle Angleterre, jusqu'à l'Égypte et aux confins de la Mésopotamie. Pour administrer et défendre un territoire aussi vaste, les Romains construisent un immense réseau de routes, ainsi que des aqueducs impressionnants pour amener l'eau potable jusque dans les villes.",
    },
    {
      titre: "Ce qu'il faut retenir",
      illustration: "🏆",
      visuel: "📌",
      contenu: [
        "Rome, fondée selon la légende en -753, devient une République en -509",
        "Conquête de l'Italie puis de la Méditerranée (guerres puniques contre Carthage)",
        "César concentre les pouvoirs puis est assassiné en -44",
        "Auguste devient le premier empereur en -27 : début de l'Empire et de la Pax Romana",
      ],
      voixOff:
        "Résumons. Rome, fondée selon la légende en moins sept cent cinquante-trois, devient une République en moins cinq cent neuf, avec un pouvoir partagé entre le Sénat, les assemblées et les consuls. Rome conquiert d'abord l'Italie, puis toute la Méditerranée, notamment en vainquant Carthage lors des guerres puniques. Jules César concentre ensuite tous les pouvoirs mais est assassiné en moins quarante-quatre. Son fils adoptif Auguste devient en moins vingt-sept le premier empereur romain, marquant le début de l'Empire et d'une longue période de paix, la Pax Romana. Bravo, tu connais l'essentiel de ce chapitre !",
    },
  ],
  fiche: {
    intro:
      "Fondée selon la légende en -753, Rome devient une République en -509 puis conquiert progressivement toute la Méditerranée, avant de se transformer en Empire sous Auguste, en -27.",
    sections: [
      {
        titre: "Fondation et République",
        points: [
          "Fondation légendaire de Rome par Romulus, en -753",
          "-509 : fin de la royauté, naissance de la République",
          "Pouvoir partagé entre Sénat, assemblées et deux consuls élus",
        ],
      },
      {
        titre: "La conquête de la Méditerranée",
        points: [
          "Conquête progressive de toute l'Italie",
          "Guerres puniques contre Carthage (-264 à -146), victoire de Rome",
          "Rome devient la première puissance de toute la Méditerranée",
        ],
      },
      {
        titre: "De César à Auguste",
        points: [
          "Jules César conquiert la Gaule (-58 à -51) puis concentre les pouvoirs",
          "César est assassiné en -44 par des sénateurs",
          "Octave (Auguste) devient le premier empereur romain en -27",
        ],
      },
      {
        titre: "L'Empire romain",
        points: [
          "Immense territoire autour de la Méditerranée (« mare nostrum »)",
          "Réseau de routes et d'aqueducs pour relier et alimenter l'Empire",
          "La Pax Romana : une longue période de paix relative",
        ],
      },
    ],
    audio:
      "Fiche de révision : Rome, de la République à l'Empire. Selon la légende, Rome est fondée par Romulus en moins sept cent cinquante-trois. En moins cinq cent neuf, les Romains chassent leur dernier roi et fondent la République, où le pouvoir est partagé entre le Sénat, les assemblées du peuple et deux consuls élus chaque année. Rome conquiert progressivement toute l'Italie, puis affronte Carthage lors des guerres puniques, entre moins deux cent soixante-quatre et moins cent quarante-six, avant de dominer toute la Méditerranée. Au premier siècle avant Jésus-Christ, Jules César conquiert la Gaule puis concentre tous les pouvoirs, ce qui lui vaut d'être assassiné en moins quarante-quatre. Son fils adoptif Octave devient alors le premier empereur romain sous le nom d'Auguste, en moins vingt-sept : c'est le début de l'Empire et d'une longue période de paix, la Pax Romana, pendant laquelle l'Empire romain s'étend tout autour de la Méditerranée, relié par un immense réseau de routes et d'aqueducs.",
  },
  memoCards: [
    { recto: "Qui aurait fondé Rome, et en quelle année ?", verso: "Romulus, selon la légende, en -753." },
    { recto: "Quand la République romaine est-elle fondée ?", verso: "En -509, après le renvoi du dernier roi de Rome." },
    { recto: "Qui dirige la République romaine ?", verso: "Le Sénat, les assemblées du peuple, et deux consuls élus chaque année." },
    { recto: "Quelle est la différence entre patriciens et plébéiens ?", verso: "Les patriciens sont les familles nobles ; les plébéiens forment le reste du peuple romain." },
    { recto: "Qui est Hannibal ?", verso: "Le général carthaginois qui envahit l'Italie pendant les guerres puniques mais est finalement vaincu par Rome." },
    { recto: "Qui conquiert la Gaule et concentre les pouvoirs à Rome ?", verso: "Jules César, entre -58 et -51, assassiné en -44." },
    { recto: "Qui devient le premier empereur romain, et quand ?", verso: "Auguste (Octave), en -27." },
    { recto: "Qu'est-ce que la Pax Romana ?", verso: "Une longue période de paix relative dans l'Empire romain, commencée avec Auguste." },
  ],
  exercices: [
    {
      type: "qcm",
      difficulte: "facile",
      question: "En quelle année Rome aurait-elle été fondée, selon la légende ?",
      choix: ["-753", "-509", "-146", "-27"],
      bonneReponse: 0,
      explication: "La tradition attribue la fondation de Rome à Romulus, en -753.",
    },
    {
      type: "qcm",
      difficulte: "facile",
      question: "Qui dirige Rome pendant la République, élus pour un an ?",
      choix: ["Les rois", "Les consuls", "Les empereurs", "Les pharaons"],
      bonneReponse: 1,
      explication: "Deux consuls, élus chaque année, dirigent Rome et commandent les armées pendant la République.",
    },
    {
      type: "ouverte",
      difficulte: "facile",
      question: "Qui est le premier empereur romain ?",
      reponse: "Auguste (Octave).",
      explication: "Il reçoit le titre d'Auguste en -27, marquant le début de l'Empire romain.",
    },
    {
      type: "qcm",
      difficulte: "facile",
      question: "Contre quelle cité Rome combat-elle lors des guerres puniques ?",
      choix: ["Athènes", "Sparte", "Carthage", "Alexandrie"],
      bonneReponse: 2,
      explication: "Les guerres puniques opposent Rome à Carthage, entre -264 et -146.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Que veut dire « République » en latin ?",
      choix: ["Le pouvoir d'un seul homme", "La chose publique", "La cité sacrée", "Le pouvoir des dieux"],
      bonneReponse: 1,
      explication: "République vient du latin « res publica », qui signifie « la chose publique ».",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Pourquoi Jules César est-il assassiné en -44 ?",
      reponse: "Parce qu'il a concentré tous les pouvoirs entre ses mains, et que des sénateurs, attachés au régime républicain, craignent qu'il ne se proclame roi.",
      explication: "Cet assassinat provoque une nouvelle guerre civile qui aboutira à l'avènement d'Auguste.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Quelle région conquiert Jules César entre -58 et -51 ?",
      reponse: "La Gaule, correspondant en grande partie à la France actuelle.",
      explication: "Cette conquête est racontée par César lui-même dans La Guerre des Gaules.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Qu'est-ce que la Pax Romana ?",
      choix: [
        "Une guerre entre Rome et Carthage",
        "Une longue période de paix relative sous l'Empire romain",
        "Le nom du Sénat romain",
        "Le nom d'un aqueduc célèbre",
      ],
      bonneReponse: 1,
      explication: "La Pax Romana commence avec Auguste et dure environ deux siècles.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Explique comment la République romaine se transforme en Empire.",
      reponse:
        "Après des décennies de troubles et de guerres civiles entre généraux rivaux, Jules César concentre les pouvoirs mais est assassiné en -44. Son fils adoptif Octave élimine ses rivaux, reçoit le titre d'Auguste en -27 et devient le premier empereur : le pouvoir, jusqu'alors partagé et temporaire (consuls élus pour un an), devient alors concentré entre les mains d'un seul homme et héréditaire.",
      explication: "Ce passage marque l'une des ruptures politiques majeures de l'histoire romaine.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Comment les Romains parviennent-ils à administrer un aussi vaste empire ?",
      reponse:
        "Ils construisent un immense réseau de routes reliant toutes les provinces, des aqueducs pour alimenter les villes en eau, organisent l'Empire en provinces administrées par des gouverneurs, et diffusent le droit romain et la citoyenneté romaine.",
      explication: "Ces infrastructures et institutions permettent de relier et de contrôler un territoire immense.",
    },
    {
      type: "qcm",
      difficulte: "avance",
      question: "Quelle expression latine les Romains utilisent-ils pour désigner la mer Méditerranée, qu'ils dominent entièrement ?",
      choix: ["Pax Romana", "Mare nostrum", "Res publica", "Senatus populusque"],
      bonneReponse: 1,
      explication: "« Mare nostrum » signifie « notre mer », en référence à la domination romaine sur toute la Méditerranée.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Pourquoi peut-on dire que la République romaine évolue progressivement vers plus d'égalité entre patriciens et plébéiens ?",
      reponse:
        "Parce qu'au fil du temps, les plébéiens obtiennent de nouveaux droits, comme celui d'élire leurs propres représentants, les tribuns de la plèbe, ce qui leur permet de mieux défendre leurs intérêts face aux patriciens, qui dominaient au début de la République.",
      explication: "Cette évolution illustre les tensions sociales internes à la République romaine.",
    },
  ],
  revisionFinChapitre: [
    {
      type: "qcm",
      difficulte: "facile",
      question: "Sur quel fleuve Rome est-elle construite ?",
      choix: ["Le Nil", "Le Tibre", "Le Rhône", "Le Danube"],
      bonneReponse: 1,
      explication: "Rome se développe sur sept collines, au bord du fleuve Tibre, en Italie.",
    },
    {
      type: "ouverte",
      difficulte: "facile",
      question: "Comment appelle-t-on les deux dirigeants élus chaque année sous la République romaine ?",
      reponse: "Les consuls.",
      explication: "Les deux consuls dirigent Rome et commandent les armées pendant un an.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Qui est le général carthaginois qui envahit l'Italie pendant les guerres puniques ?",
      reponse: "Hannibal.",
      explication: "Il traverse les Alpes avec des éléphants mais est finalement vaincu par Rome.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "En quelle année Auguste devient-il le premier empereur romain ?",
      choix: ["-753", "-509", "-44", "-27"],
      bonneReponse: 3,
      explication: "Octave reçoit le titre d'Auguste en -27, marquant le début de l'Empire.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "En une phrase, explique la différence entre la République et l'Empire romains.",
      reponse: "Sous la République, le pouvoir est partagé entre le Sénat, les assemblées et des consuls élus pour un an ; sous l'Empire, le pouvoir est concentré entre les mains d'un seul homme, l'empereur, et devient héréditaire.",
      explication: "Ce changement politique majeur intervient avec Auguste, en -27.",
    },
  ],
  examens: [
    {
      titre: "Examen 1 — Rome, de la République à l'Empire",
      dureeMinutes: 20,
      questions: [
        {
          type: "qcm",
          difficulte: "facile",
          question: "Qui aurait fondé Rome selon la légende ?",
          choix: ["Jules César", "Romulus", "Auguste", "Hannibal"],
          bonneReponse: 1,
          explication: "La légende attribue la fondation de Rome à Romulus, élevé avec son frère Remus par une louve.",
        },
        {
          type: "ouverte",
          difficulte: "facile",
          question: "En quelle année la République romaine est-elle fondée ?",
          reponse: "En -509.",
          explication: "C'est l'année où les Romains chassent leur dernier roi.",
        },
        {
          type: "qcm",
          difficulte: "moyen",
          question: "Qu'obtiennent progressivement les plébéiens pendant la République ?",
          choix: ["Le trône de Rome", "De nouveaux droits, comme élire des tribuns de la plèbe", "La conquête de la Gaule", "Le titre d'empereur"],
          bonneReponse: 1,
          explication: "Les tribuns de la plèbe défendent les intérêts du peuple face aux patriciens.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Quelles sont les conséquences des guerres puniques pour Rome ?",
          reponse: "Après avoir vaincu Carthage, notamment le général Hannibal, Rome détruit la ville en -146 et devient la puissance dominante de toute la Méditerranée.",
          explication: "Ces trois guerres (-264 à -146) sont décisives dans l'expansion romaine.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Pourquoi Jules César est-il une figure importante de la fin de la République ?",
          reponse: "Parce qu'il conquiert la Gaule entre -58 et -51 et concentre progressivement tous les pouvoirs à Rome, ce qui provoque son assassinat par des sénateurs en -44, craignant une restauration de la royauté.",
          explication: "Son parcours illustre la crise finale de la République romaine.",
        },
        {
          type: "ouverte",
          difficulte: "avance",
          question:
            "Développement construit : explique les grandes étapes de l'histoire de Rome, de sa fondation à la naissance de l'Empire (une quinzaine de lignes).",
          reponse:
            "Introduction : l'histoire de Rome antique se déroule en plusieurs grandes étapes, de sa fondation légendaire à la naissance de l'Empire. Première partie : fondée selon la légende par Romulus en -753, Rome devient une République en -509, avec un pouvoir partagé entre le Sénat, les assemblées et deux consuls élus. Deuxième partie : Rome conquiert progressivement l'Italie puis, après avoir vaincu Carthage lors des guerres puniques, domine toute la Méditerranée. Troisième partie : au premier siècle avant Jésus-Christ, Jules César concentre les pouvoirs après avoir conquis la Gaule, mais il est assassiné en -44 ; son fils adoptif Octave devient alors le premier empereur romain sous le nom d'Auguste, en -27. Conclusion : ce passage de la République à l'Empire marque une transformation politique majeure, suivie d'une longue période de paix, la Pax Romana.",
          explication: "Un bon développement suit l'ordre chronologique : fondation, République, conquêtes, Empire.",
        },
      ],
    },
    {
      titre: "Examen 2 — Rome, de la République à l'Empire",
      dureeMinutes: 20,
      questions: [
        {
          type: "qcm",
          difficulte: "facile",
          question: "Comment appelle-t-on les familles nobles de Rome ?",
          choix: ["Les plébéiens", "Les patriciens", "Les consuls", "Les tribuns"],
          bonneReponse: 1,
          explication: "Les patriciens forment les familles nobles les plus anciennes de Rome.",
        },
        {
          type: "ouverte",
          difficulte: "facile",
          question: "Quel titre reçoit Octave en -27, faisant de lui le premier empereur romain ?",
          reponse: "Le titre d'Auguste.",
          explication: "Auguste signifie « le vénérable » en latin.",
        },
        {
          type: "qcm",
          difficulte: "moyen",
          question: "Que construisent les Romains pour amener l'eau potable dans leurs villes ?",
          choix: ["Des pyramides", "Des aqueducs", "Des temples", "Des amphithéâtres uniquement"],
          bonneReponse: 1,
          explication: "Les aqueducs romains sont de remarquables ouvrages d'ingénierie, encore visibles aujourd'hui.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Qu'est-ce que la Pax Romana et quand commence-t-elle ?",
          reponse: "Une longue période de paix relative dans l'Empire romain, qui commence avec l'arrivée au pouvoir d'Auguste, en -27.",
          explication: "Cette période favorise le développement économique et culturel de l'Empire.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Quelle région, correspondant à la France actuelle, Jules César conquiert-il ?",
          reponse: "La Gaule, conquise entre -58 et -51.",
          explication: "Cette conquête renforce considérablement le prestige et la puissance de César.",
        },
        {
          type: "ouverte",
          difficulte: "avance",
          question:
            "Développement construit : explique comment Rome parvient à dominer puis à administrer tout le bassin méditerranéen (une quinzaine de lignes).",
          reponse:
            "Introduction : entre le Ve siècle avant Jésus-Christ et le début de l'Empire, Rome devient la puissance dominante de toute la Méditerranée. Première partie : Rome conquiert d'abord l'ensemble de l'Italie, puis affronte Carthage lors des guerres puniques (-264 à -146), remportant la victoire malgré l'invasion d'Hannibal, jusqu'à détruire Carthage. Deuxième partie : les conquêtes se poursuivent, notamment avec Jules César qui soumet la Gaule entre -58 et -51. Troisième partie : sous l'Empire, à partir d'Auguste en -27, les Romains administrent cet immense territoire grâce à un réseau de routes et d'aqueducs, à l'organisation en provinces et à la diffusion du droit romain. Conclusion : cette domination fait de la Méditerranée « mare nostrum », la mer des Romains, pendant plusieurs siècles.",
          explication: "On attend une explication chronologique claire, mobilisant conquêtes militaires et outils d'administration.",
        },
      ],
    },
  ],
  syntheseRevisions: [
    "Rome est fondée, selon la légende, par Romulus en -753.",
    "La République romaine naît en -509 : pouvoir partagé entre Sénat, assemblées et consuls élus.",
    "Rome conquiert l'Italie puis la Méditerranée, en battant Carthage lors des guerres puniques (-264 à -146).",
    "Jules César conquiert la Gaule (-58 à -51), concentre les pouvoirs, puis est assassiné en -44.",
    "Auguste devient le premier empereur romain en -27, marquant le début de l'Empire et de la Pax Romana.",
    "L'Empire romain, immense, est relié par un réseau de routes et d'aqueducs autour de la Méditerranée.",
  ],
},
{
