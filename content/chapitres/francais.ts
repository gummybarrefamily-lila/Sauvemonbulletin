...
{
  slug: "conte-merveilleux",
  titre: "Le conte merveilleux",
  matiere: "francais",
  niveau: "6eme",
  description:
    "Découvrir le conte merveilleux : ses personnages types, son schéma narratif, la présence de la magie, et la morale qu'il transmet, à travers des exemples comme Cendrillon ou Le Petit Chaperon rouge.",
  objectifs: [
    "Définir ce qu'est un conte merveilleux",
    "Reconnaître le schéma narratif d'un conte (situation initiale, élément perturbateur, péripéties, dénouement, situation finale)",
    "Identifier les personnages types du conte (héros, adjuvant, opposant)",
    "Repérer les éléments magiques et les formules typiques du conte",
    "Comprendre la valeur morale ou symbolique d'un conte",
  ],
  slides: [
    {
      titre: "Qu'est-ce qu'un conte merveilleux ?",
      illustration: "🏰",
      visuel: "Il était une fois...",
      contenu: [
        "Un conte est un récit court, souvent transmis oralement à l'origine",
        "Le conte merveilleux mêle réalité et magie sans surprendre le lecteur",
        "Il commence souvent par « Il était une fois »",
        "Il se termine souvent par une morale ou un retour à l'ordre",
      ],
      voixOff:
        "Le conte merveilleux est un récit court qui raconte une histoire où la magie fait partie du monde normal, sans jamais étonner les personnages. Il commence traditionnellement par la formule il était une fois, qui installe le lecteur dans un temps et un lieu indéterminés. À l'origine, les contes étaient racontés à voix haute avant d'être écrits, notamment par Charles Perrault.",
    },
    {
      titre: "Le schéma narratif : cinq étapes",
      illustration: "🧩",
      visuel: "Situation initiale → Élément perturbateur → Péripéties → Élément de résolution → Situation finale",
      contenu: [
        "1. Situation initiale : présentation des personnages et du décor",
        "2. Élément perturbateur : un événement bouleverse l'équilibre",
        "3. Péripéties : les aventures et épreuves du héros",
        "4. Élément de résolution : le problème se résout",
        "5. Situation finale : un nouvel équilibre s'installe",
      ],
      voixOff:
        "Tout conte suit un schéma narratif en cinq étapes. D'abord la situation initiale présente les personnages et le cadre. Puis un élément perturbateur vient bouleverser cet équilibre, comme la mort d'un parent ou une malédiction. Viennent ensuite les péripéties, c'est-à-dire les aventures du héros. Un élément de résolution règle le problème, avant la situation finale, qui installe un nouvel équilibre, souvent heureux.",
    },
    {
      titre: "Les personnages types",
      illustration: "🎭",
      visuel: "Héros / Adjuvant / Opposant",
      contenu: [
        "Le héros : personnage principal qui doit surmonter des épreuves",
        "L'adjuvant : aide le héros (fée, animal magique, ami)",
        "L'opposant : s'oppose au héros (sorcière, ogre, marâtre)",
        "Ces rôles se retrouvent dans presque tous les contes",
      ],
      voixOff:
        "Le conte met en scène des personnages types, qui reviennent d'un conte à l'autre. Le héros est le personnage principal, celui qui doit surmonter des épreuves pour atteindre son but. L'adjuvant est celui qui l'aide, comme une fée ou un animal magique. L'opposant, au contraire, se met en travers de son chemin, comme une sorcière ou un ogre. Ces trois rôles structurent presque tous les contes merveilleux.",
    },
    {
      titre: "La magie et le merveilleux",
      illustration: "✨",
      visuel: "citrouille → carrosse",
      contenu: [
        "Le merveilleux : la magie est acceptée sans surprise par les personnages",
        "Objets magiques : baguette, tapis volant, bottes de sept lieues",
        "Personnages surnaturels : fées, ogres, sorcières, animaux parlants",
        "Le merveilleux se distingue du fantastique, où la magie provoque la peur",
      ],
      voixOff:
        "Dans un conte merveilleux, la magie fait partie intégrante du monde de l'histoire : personne ne s'en étonne, ni le héros ni les autres personnages. On y rencontre des objets magiques, comme une baguette ou des bottes de sept lieues, et des personnages surnaturels, comme les fées ou les ogres. Attention à ne pas confondre le merveilleux avec le fantastique, où l'irruption du surnaturel provoque au contraire la peur ou le doute.",
    },
    {
      titre: "Les formules typiques du conte",
      illustration: "📜",
      visuel: "Il était une fois... / Ils vécurent heureux...",
      contenu: [
        "Formule d'ouverture : « Il était une fois... », « Il y a bien longtemps... »",
        "Formule de clôture : « Ils se marièrent et eurent beaucoup d'enfants »",
        "Le temps du récit est souvent l'imparfait et le passé simple",
        "Le conte joue avec le chiffre trois (trois épreuves, trois fils...)",
      ],
      voixOff:
        "Le conte utilise des formules bien reconnaissables. Il commence souvent par il était une fois, et se termine fréquemment par une formule de clôture, comme ils vécurent heureux et eurent beaucoup d'enfants. Le récit est en général écrit à l'imparfait pour la description, et au passé simple pour les actions. On remarque aussi que le conte aime le chiffre trois : trois épreuves, trois fils, trois vœux.",
    },
    {
      titre: "Des exemples célèbres",
      illustration: "👑",
      visuel: "Cendrillon, Le Petit Chaperon rouge, La Belle au bois dormant",
      contenu: [
        "Charles Perrault : Cendrillon, Le Petit Chaperon rouge, Le Chat botté",
        "Les frères Grimm : Blanche-Neige, Hansel et Gretel",
        "Chaque conte met en scène une épreuve à surmonter",
        "Ces contes ont traversé les siècles en étant transmis puis écrits",
      ],
      voixOff:
        "De nombreux contes merveilleux sont devenus célèbres à travers le monde. En France, Charles Perrault a écrit Cendrillon, Le Petit Chaperon rouge et Le Chat botté. En Allemagne, les frères Grimm ont recueilli Blanche-Neige ou Hansel et Gretel. Chacun de ces récits met en scène un héros confronté à une ou plusieurs épreuves qu'il doit surmonter pour parvenir à un dénouement heureux.",
    },
    {
      titre: "La morale du conte",
      illustration: "💡",
      visuel: "Une leçon de vie",
      contenu: [
        "Le conte transmet souvent une leçon de vie ou une valeur",
        "Il peut mettre en garde contre un danger (Le Petit Chaperon rouge)",
        "Il peut récompenser la bonté ou la ruse du héros",
        "La morale est parfois écrite à la fin, parfois seulement suggérée",
      ],
      voixOff:
        "Au-delà du divertissement, le conte merveilleux transmet souvent une leçon de vie. Il peut mettre en garde contre un danger, comme dans Le Petit Chaperon rouge, qui prévient contre les inconnus trop aimables. Il peut aussi récompenser la bonté, la patience ou la ruse du héros. Cette morale est parfois écrite noir sur blanc à la fin du texte, et parfois seulement suggérée au lecteur.",
    },
    {
      ...
      visuel: "📌",
      contenu: [
        "Le conte merveilleux mêle réalité et magie sans surprendre les personnages",
        "Il suit un schéma narratif en cinq étapes",
        "Il met en scène un héros, un adjuvant et un opposant",
        "Il transmet souvent une morale ou une leçon de vie",
      ],
      voixOff:
        "Pour résumer ce chapitre, le conte merveilleux est un récit où la magie fait naturellement partie du monde raconté. Il suit un schéma narratif en cinq étapes : situation initiale, élément perturbateur, péripéties, résolution et situation finale. Il met en scène des personnages types, comme le héros, l'adjuvant et l'opposant, et il transmet souvent une morale. Tu es maintenant capable de reconnaître et d'analyser un conte merveilleux !",
    },
  ],
  fiche: {
    intro:
      "Le conte merveilleux est un récit où le surnaturel est intégré au monde de l'histoire sans étonner personne. Il obéit à des règles précises de construction et met en scène des personnages types.",
    sections: [
      {
        titre: "Le schéma narratif",
        points: [
          "Situation initiale : présentation des personnages, du lieu, du temps",
          "Élément perturbateur : un événement rompt l'équilibre initial",
          "Péripéties : les aventures et épreuves traversées par le héros",
          "Élément de résolution : le problème trouve une solution",
          "Situation finale : un nouvel équilibre, souvent heureux, s'installe",
        ],
      },
      {
        titre: "Les personnages types",
        points: [
          "Le héros : personnage principal, souvent jeune, qui doit surmonter des épreuves",
          "L'adjuvant : aide le héros (fée, animal magique, marraine)",
          "L'opposant : freine ou combat le héros (sorcière, ogre, marâtre)",
          "Ces rôles peuvent être tenus par plusieurs personnages différents",
        ],
      },
      {
        titre: "Les caractéristiques du merveilleux",
        points: [
          "La magie fait partie du monde du conte : elle n'étonne personne",
          "Objets magiques, personnages surnaturels, animaux parlants",
          "Formules typiques : « Il était une fois... », « Ils vécurent heureux... »",
          "Récurrence du chiffre trois (trois épreuves, trois fils, trois vœux)",
        ],
      },
      {
        titre: "La visée du conte",
        points: [
          "Le conte divertit mais transmet aussi souvent une morale",
          "Il peut mettre en garde contre un danger ou un défaut",
          "Il récompense en général la bonté, le courage ou la ruse",
          "La morale peut être explicite (écrite) ou implicite (suggérée)",
        ],
      },
    ],
    audio:
      "Fiche de révision : le conte merveilleux. Le conte merveilleux est un récit où la magie fait naturellement partie du monde de l'histoire, sans étonner les personnages. Il suit un schéma narratif en cinq étapes : la situation initiale présente les personnages ; l'élément perturbateur bouleverse l'équilibre ; les péripéties racontent les aventures du héros ; l'élément de résolution règle le problème ; la situation finale installe un nouvel équilibre. Le conte met en scène des personnages types : le héros, l'adjuvant qui l'aide, et l'opposant qui s'oppose à lui. On y trouve des formules typiques comme il était une fois, des objets magiques, et souvent le chiffre trois. Enfin, le conte transmet fréquemment une morale ou une leçon de vie, explicite ou implicite.",
  },
  memoCards: [
    { recto: "Qu'est-ce qu'un conte merveilleux ?", verso: "Un récit où la magie fait partie du monde de l'histoire, sans surprendre les personnages." },
    { recto: "Les cinq étapes du schéma narratif ?", verso: "Situation initiale, élément perturbateur, péripéties, élément de résolution, situation finale." },
    { recto: "Qu'est-ce qu'un adjuvant ?", verso: "Un personnage qui aide le héros (fée, animal magique, marraine)." },
    { recto: "Qu'est-ce qu'un opposant ?", verso: "Un personnage qui s'oppose au héros (sorcière, ogre, marâtre)." },
    { recto: "Formule d'ouverture typique du conte ?", verso: "« Il était une fois... »" },
    { recto: "Quel chiffre revient souvent dans les contes ?", verso: "Le chiffre trois (trois épreuves, trois fils, trois vœux)." },
    { recto: "Quels temps verbaux utilise le conte ?", verso: "L'imparfait pour les descriptions, le passé simple pour les actions." },
    { recto: "Qui a écrit Cendrillon et Le Petit Chaperon rouge ?", verso: "Charles Perrault, écrivain français du 17e siècle." },
  ],
  exercices: [
    {
      type: "qcm",
      difficulte: "facile",
      question: "Par quelle formule commence traditionnellement un conte ?",
      choix: ["Un jour lointain", "Il était une fois", "C'est ainsi que", "Depuis toujours"],
      bonneReponse: 1,
      explication: "« Il était une fois » est la formule d'ouverture la plus typique du conte merveilleux.",
    },
    {
      type: "qcm",
      difficulte: "facile",
      question: "Qui a écrit Le Petit Chaperon rouge ?",
      choix: ["Victor Hugo", "Charles Perrault", "Jean de La Fontaine", "Homère"],
      bonneReponse: 1,
      explication: "Charles Perrault a écrit ce conte à la fin du 17e siècle.",
    },
    {
      type: "ouverte",
      difficulte: "facile",
      question: "Qu'est-ce qu'un adjuvant dans un conte ?",
      reponse: "C'est un personnage qui aide le héros à surmonter ses épreuves, comme une fée ou un animal magique.",
      explication: "L'adjuvant s'oppose à l'opposant, qui lui fait obstacle.",
    },
    {
      type: "qcm",
      difficulte: "facile",
      question: "Quelle étape du schéma narratif présente les personnages et le décor ?",
      choix: ["L'élément perturbateur", "La situation initiale", "Les péripéties", "La situation finale"],
      bonneReponse: 1,
      explication: "La situation initiale ouvre le récit en présentant le cadre, les personnages et l'équilibre de départ.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Dans Cendrillon, quel est l'élément perturbateur ?",
      choix: ["Le mariage du prince", "La mort du père et la méchanceté de la belle-mère", "L'arrivée de la fée", "Le retour du carrosse en citrouille"],
      bonneReponse: 1,
      explication: "C'est la situation de départ malheureuse imposée par la belle-mère qui rompt l'équilibre et lance l'histoire.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Explique la différence entre le merveilleux et le fantastique.",
      reponse: "Dans le merveilleux, la magie fait partie du monde de l'histoire et n'étonne personne. Dans le fantastique, l'irruption du surnaturel provoque la peur ou le doute des personnages.",
      explication: "C'est une distinction essentielle entre deux genres qui utilisent tous deux le surnaturel.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Cite deux objets magiques que l'on peut rencontrer dans un conte merveilleux.",
      reponse: "Par exemple une baguette magique, des bottes de sept lieues, un tapis volant ou une citrouille transformée en carrosse.",
      explication: "Les objets magiques appartiennent au registre merveilleux et servent souvent d'adjuvants au héros.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Quel temps verbal domine généralement les descriptions dans un conte ?",
      choix: ["Le présent", "Le futur", "L'imparfait", "Le conditionnel"],
      bonneReponse: 2,
      explication: "L'imparfait sert à décrire le décor et les personnages, tandis que le passé simple raconte les actions.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Dans La Belle au bois dormant, identifie le héros, l'adjuvant et l'opposant.",
      reponse: "Le héros est la princesse (ou le prince qui vient la réveiller). L'opposant est la mauvaise fée qui jette la malédiction. Les adjuvants sont les bonnes fées qui atténuent le sort et le prince qui la sauve.",
      explication: "Un même conte peut compter plusieurs adjuvants ou plusieurs opposants selon le moment de l'histoire.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Explique pourquoi le chiffre trois revient souvent dans les contes. Donne un exemple.",
      reponse: "Le chiffre trois structure le récit et crée un effet d'attente : les deux premières tentatives échouent souvent, la troisième réussit. Exemple : les trois vœux, les trois épreuves imposées au héros, ou les trois fils d'un roi.",
      explication: "Cette répétition par trois est un procédé traditionnel du conte, hérité de la tradition orale.",
    },
    {
      type: "qcm",
      difficulte: "avance",
      question: "Quelle affirmation sur la morale du conte est fausse ?",
      choix: [
        "Elle peut être écrite explicitement à la fin du texte",
        "Elle peut être seulement suggérée par le dénouement",
        "Elle est absente de tous les contes merveilleux",
        "Elle met souvent en garde contre un danger ou un défaut",
      ],
      bonneReponse: 2,
      explication: "La plupart des contes merveilleux transmettent une morale, explicite ou implicite ; l'affirmation « elle est absente de tous les contes » est donc fausse.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Rédige la situation initiale d'un conte merveilleux de ton invention (3 à 4 phrases), en utilisant l'imparfait.",
      reponse: "Exemple de réponse : Il était une fois, dans un royaume entouré de forêts, un jeune berger nommé Tom qui vivait seul avec sa grand-mère. Chaque jour, il gardait ses moutons près de la rivière et rêvait de voir la mer. La grand-mère, très âgée, savait qu'un secret magique dormait dans la forêt voisine.",
      explication: "On évalue l'utilisation correcte de l'imparfait, la présence d'un cadre spatio-temporel et d'un ou plusieurs personnages.",
    },
  ],
  revisionFinChapitre: [
    {
      type: "qcm",
      difficulte: "facile",
      question: "Combien d'étapes compte le schéma narratif d'un conte ?",
      choix: ["Trois", "Quatre", "Cinq", "Sept"],
      bonneReponse: 2,
      explication: "Situation initiale, élément perturbateur, péripéties, résolution, situation finale.",
    },
    {
      type: "ouverte",
      difficulte: "facile",
      question: "Cite un exemple de personnage opposant dans un conte.",
      reponse: "Une sorcière, un ogre, ou une marâtre méchante, par exemple.",
      explication: "L'opposant s'oppose au héros et complique sa quête.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Le merveilleux se caractérise par :",
      choix: [
        "une magie qui effraie les personnages",
        "une magie acceptée sans surprise",
        "l'absence totale de magie",
        "des personnages uniquement réels",
      ],
      bonneReponse: 1,
      explication: "Dans le merveilleux, le surnaturel fait naturellement partie du monde de l'histoire.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Quelle est la fonction de l'adjuvant dans un conte ?",
      reponse: "Il aide le héros à surmonter ses épreuves et à atteindre son but.",
      explication: "L'adjuvant peut être une fée, un animal magique ou un ami fidèle.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Nomme un auteur célèbre de contes merveilleux et un de ses contes.",
      reponse: "Charles Perrault, auteur de Cendrillon (ou Le Petit Chaperon rouge, ou Le Chat botté).",
      explication: "On peut aussi citer les frères Grimm avec Blanche-Neige ou Hansel et Gretel.",
    },
  ],
  examens: [
    {
      titre: "Examen 1 — Le conte merveilleux",
      dureeMinutes: 20,
      questions: [
        {
          type: "qcm",
          difficulte: "facile",
          question: "Quelle formule termine souvent un conte merveilleux ?",
          choix: [
            "« Il était une fois »",
          ...
          bonneReponse: 1,
          explication: "Cette formule de clôture marque le retour à un équilibre heureux et durable.",
        },
        {
          type: "ouverte",
          difficulte: "facile",
          question: "Qu'est-ce qu'un héros dans un conte ?",
          reponse: "C'est le personnage principal de l'histoire, celui qui doit surmonter des épreuves pour atteindre son but.",
          explication: "Le héros est souvent jeune et se transforme au fil du récit.",
        },
        {
          type: "qcm",
          difficulte: "moyen",
          question: "Quel est l'élément perturbateur dans Le Petit Chaperon rouge ?",
          choix: [
            "La rencontre avec le loup",
            "L'arrivée du chasseur",
            "Le départ chez la grand-mère",
            "Le repas final",
          ],
          bonneReponse: 0,
          explication: "C'est la rencontre avec le loup qui rompt l'équilibre initial et lance les péripéties.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Explique en quoi le merveilleux se distingue du monde réel, tout en restant crédible pour le lecteur.",
          reponse: "Le merveilleux introduit des éléments magiques (objets, créatures, pouvoirs) qui n'existent pas dans la réalité, mais ces éléments sont acceptés sans étonnement par les personnages, ce qui les rend crédibles à l'intérieur de l'histoire.",
          explication: "Le pacte de lecture du conte repose sur cette acceptation naturelle du surnaturel.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Donne le nom des cinq étapes du schéma narratif dans l'ordre.",
          reponse: "Situation initiale, élément perturbateur, péripéties, élément de résolution, situation finale.",
          explication: "Ce schéma se retrouve dans la quasi-totalité des contes merveilleux.",
        },
        {
          type: "ouverte",
          difficulte: "avance",
          question: "Choisis un conte que tu connais et résume-le en identifiant ses cinq étapes narratives.",
          reponse: "Exemple avec Cendrillon : situation initiale (Cendrillon vit maltraitée par sa belle-mère) ; élément perturbateur (le bal est annoncé) ; péripéties (la fée l'aide, elle danse avec le prince, elle perd sa pantoufle) ; résolution (le prince la retrouve grâce à la pantoufle) ; situation finale (elle épouse le prince et vit heureuse).",
          explication: "On évalue la capacité à retrouver la structure narrative dans un texte connu.",
        },
      ],
    },
    {
      titre: "Examen 2 — Le conte merveilleux",
      dureeMinutes: 20,
      questions: [
        {
          type: "qcm",
          difficulte: "facile",
          question: "Quel chiffre est traditionnellement associé aux contes ?",
          choix: ["Deux", "Trois", "Cinq", "Dix"],
          bonneReponse: 1,
          explication: "Le chiffre trois structure souvent les épreuves et les personnages du conte.",
        },
        {
          type: "ouverte",
          difficulte: "facile",
          question: "Cite un objet ou un personnage magique typique du conte merveilleux.",
          reponse: "Par exemple une baguette magique, une fée, un tapis volant ou un ogre.",
          explication: "Ces éléments appartiennent au registre merveilleux du conte.",
        },
        {
          type: "qcm",
          difficulte: "moyen",
          question: "Le rôle de l'opposant est de :",
          choix: [
            "aider le héros à réussir sa quête",
            "faire obstacle au héros",
            "raconter l'histoire",
            "décrire le décor",
          ],
          bonneReponse: 1,
          explication: "L'opposant crée des difficultés que le héros doit surmonter.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Pourquoi peut-on dire que le conte transmet souvent une leçon de vie ?",
          reponse: "Parce qu'il met en scène des comportements récompensés (la bonté, le courage) ou punis (la méchanceté, l'imprudence), ce qui invite le lecteur à en tirer une morale, explicite ou implicite.",
          explication: "Le conte a une fonction éducative en plus de sa fonction de divertissement.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Quels sont les deux temps verbaux les plus utilisés dans un conte, et à quoi servent-ils ?",
          reponse: "L'imparfait sert à décrire le décor, les personnages et les habitudes. Le passé simple sert à raconter les actions et les événements successifs.",
          explication: "Cette alternance entre description et action structure le récit.",
        },
        {
          type: "ouverte",
          difficulte: "avance",
          question: "Compare rapidement les rôles du héros, de l'adjuvant et de l'opposant dans un conte de ton choix, en citant un exemple précis pour chacun.",
          reponse: "Exemple avec Le Chat botté : le héros est le fils du meunier, qui devient marquis grâce à la ruse ; l'adjuvant est le chat botté, qui invente des stratagèmes pour l'aider ; l'opposant est l'ogre, que le chat doit déjouer par la ruse.",
          explication: "On évalue la compréhension des rôles narratifs et la capacité à les illustrer avec des exemples précis.",
        },
      ],
    },
  ],
  syntheseRevisions: [
    "Le conte merveilleux mêle réalité et magie sans jamais surprendre les personnages.",
    "Il suit un schéma narratif en cinq étapes : situation initiale, élément perturbateur, péripéties, résolution, situation finale.",
    "Les personnages types sont le héros, l'adjuvant (qui l'aide) et l'opposant (qui lui fait obstacle).",
    "Formules typiques : « Il était une fois... » à l'ouverture, une formule heureuse à la clôture.",
    "L'imparfait décrit, le passé simple raconte les actions ; le chiffre trois structure souvent l'intrigue.",
    "Le conte transmet presque toujours une morale, explicite ou implicite, sur le courage, la bonté ou la prudence.",
  ],
},
{
  slug: "fables-poesie",
  titre: "Fables et poésie",
  matiere: "francais",
  niveau: "6eme",
  description:
    "Découvrir la fable, ce court récit en vers qui met en scène des animaux pour délivrer une morale, à travers les œuvres de Jean de La Fontaine et d'Ésope, ainsi que les bases de la versification.",
  objectifs: [
    "Comprendre ce qu'est une fable et sa fonction (plaire et instruire)",
    "Découvrir Jean de La Fontaine et son modèle Ésope",
    "Identifier la structure d'une fable (récit + morale)",
    "Repérer les personnifications d'animaux et leurs caractéristiques symboliques",
    "Connaître le vocabulaire de base de la poésie (vers, strophe, rime)",
  ],
  slides: [
    {
      titre: "Qu'est-ce qu'une fable ?",
      illustration: "🦊",
      visuel: "Récit court + animaux + morale",
      contenu: [
        "La fable est un court récit, souvent en vers, mettant en scène des animaux",
        "Les animaux parlent et se comportent comme des humains",
        "Elle se termine (ou commence) par une morale, une leçon de vie",
        "Sa devise : plaire et instruire",
      ],
      voixOff:
        "La fable est un court récit, le plus souvent écrit en vers, qui met en scène des animaux capables de parler et de se comporter comme des humains. Ce récit se termine généralement par une morale, c'est-à-dire une leçon de vie que le lecteur doit retenir. La fable a donc une double fonction, résumée par la formule plaire et instruire : elle divertit par son histoire tout en enseignant une vérité sur le comportement humain.",
    },
    {
      titre: "Ésope, l'inventeur de la fable",
      illustration: "🏺",
      visuel: "Grèce antique, 6e siècle av. J.-C.",
      contenu: [
        "Ésope est un fabuliste grec qui aurait vécu au 6e siècle avant J.-C.",
        "Ses fables sont écrites en prose, plus courtes que celles de La Fontaine",
        "Il a inventé de nombreuses histoires reprises plus tard, comme Le Corbeau et le Renard",
        "Il aurait été un esclave affranchi, réputé pour sa sagesse",
      ],
      voixOff:
        "Bien avant La Fontaine, c'est le Grec Ésope qui aurait inventé la fable, au sixième siècle avant Jésus-Christ. Ses fables, écrites en prose, sont plus courtes que celles de La Fontaine mais racontent souvent les mêmes histoires, comme celle du corbeau et du renard. Selon la légende, Ésope aurait été un esclave affranchi, réputé pour son intelligence et sa sagesse.",
    },
    {
      titre: "Jean de La Fontaine",
      illustration: "🖋️",
      visuel: "17e siècle, cour de Louis XIV",
      contenu: [
        "Jean de La Fontaine (1621-1695) est un poète français du 17e siècle",
        "Il s'inspire d'Ésope pour écrire ses propres fables, en vers",
        "Il publie 12 livres de Fables, très connues encore aujourd'hui",
        "Ses fables critiquent parfois discrètement la société de son époque",
      ],
      voixOff:
        "Jean de La Fontaine est un poète français du dix-septième siècle, qui a vécu à la cour du roi Louis quatorze. Il s'est inspiré des fables d'Ésope pour écrire les siennes, mais en vers, avec un art du récit très soigné. Il a publié douze livres de fables, encore lus et appris par cœur aujourd'hui. Sous couvert d'histoires d'animaux, La Fontaine critique parfois discrètement les puissants et les défauts de la société de son époque.",
    },
    {
      titre: "La structure d'une fable",
      illustration: "🧩",
      visuel: "Récit → Morale",
      contenu: [
        "Une fable comprend un récit (situation, action, dénouement)",
        "Elle comprend aussi une morale, courte phrase qui résume la leçon",
        "La morale peut être placée au début ou à la fin de la fable",
        "Parfois, la morale n'est pas écrite mais seulement suggérée",
      ],
      voixOff:
        "Une fable est composée de deux parties. D'abord un récit, qui raconte une situation, une action et un dénouement, souvent mettant en scène deux animaux aux caractères opposés. Ensuite une morale, une courte phrase qui résume la leçon à retenir. Cette morale peut être placée au début du texte, à la fin, ou même parfois seulement suggérée sans être clairement écrite, laissant au lecteur le soin de la deviner.",
    },
    {
      titre: "Des animaux aux traits humains",
      illustration: "🐺",
      visuel: "Renard = ruse, Lion = pouvoir, Agneau = innocence",
      contenu: [
        "Chaque animal représente un trait de caractère humain",
        "Le renard symbolise la ruse, le lion la force et le pouvoir",
        "L'agneau représente l'innocence, la fourmi le travail",
        "Ce procédé s'appelle la personnification",
      ],
      voixOff:
        "Dans les fables, chaque animal représente un trait de caractère humain bien précis. Le renard symbolise la ruse et l'habileté, le lion représente la force et le pouvoir, l'agneau incarne l'innocence, et la fourmi le travail et la prévoyance. Ce procédé, qui consiste à donner à un animal des comportements et des sentiments humains, s'appelle la personnification.",
    },
    {
      titre: "Deux fables célèbres",
      illustration: "🐦",
      visuel: "Le Corbeau et le Renard / La Cigale et la Fourmi",
      contenu: [
        "Le Corbeau et le Renard : la flatterie peut faire perdre son bien",
        "La Cigale et la Fourmi : oppose l'insouciance et la prévoyance",
        "Le Lièvre et la Tortue : la lenteur peut triompher de la vantardise",
        "Ces fables sont parmi les plus connues de La Fontaine",
      ],
      voixOff:
        "Parmi les fables les plus célèbres de La Fontaine, Le Corbeau et le Renard raconte comment la flatterie peut faire perdre son bien à celui qui l'écoute. La Cigale et la Fourmi oppose l'insouciance de la cigale à la prévoyance de la fourmi. Le Lièvre et la Tortue montre comment la persévérance et la modestie peuvent triompher de la vantardise et de la précipitation.",
    },
    {
      titre: "Le vocabulaire de la poésie : le vers",
      illustration: "📏",
      visuel: "Un vers = une ligne de poème",
      contenu: [
        "Le vers est une ligne d'un poème",
        "La strophe est un groupe de vers séparé par un blanc",
        "Le nombre de syllabes d'un vers s'appelle le mètre",
        "L'alexandrin est un vers de douze syllabes",
      ],
      voixOff:
        "Pour lire une fable écrite en vers, il faut connaître un peu de vocabulaire de poésie. Le vers est une ligne d'un poème. Plusieurs vers regroupés forment une strophe, séparée des autres par un blanc. On appelle mètre le nombre de syllabes que compte un vers : l'alexandrin, par exemple, est un vers de douze syllabes, très utilisé en poésie française.",
    },
    {
      titre: "La rime",
      illustration: "🎵",
      visuel: "renard / retard → rime",
      contenu: [
        "La rime est la répétition d'un même son à la fin de deux vers",
        "Rimes plates (AABB), croisées (ABAB) ou embrassées (ABBA)",
        "Les rimes créent une musicalité qui rend le texte agréable à écouter",
        "La Fontaine varie les rimes et la longueur des vers dans ses fables",
      ],
      voixOff:
        "La rime est la répétition d'un même son à la fin de deux vers ou plus. Il existe plusieurs dispositions de rimes : les rimes plates, notées A A B B, les rimes croisées, notées A B A B, et les rimes embrassées, notées A B B A. Ces rimes créent une musicalité particulière qui rend le texte agréable à écouter. La Fontaine aime varier la longueur des vers et les rimes pour donner du rythme à ses fables.",
    },
    {
      titre: "Ce qu'il faut retenir",
      illustration: "🏆",
      visuel: "📌",
      contenu: [
        "La fable plaît par son récit et instruit par sa morale",
        "Ésope l'a inventée en Grèce, La Fontaine l'a développée en vers",
        "Les animaux personnifiés symbolisent des traits humains",
        "Vers, strophe, rime : le vocabulaire de base de la poésie",
      ],
      voixOff:
        "Pour conclure, retiens que la fable est un récit court qui plaît par son histoire et instruit par sa morale. Ésope l'a inventée dans la Grèce antique, et Jean de La Fontaine l'a développée en français, en vers, au dix-septième siècle. Les animaux qu'elle met en scène sont personnifiés : ils symbolisent des traits de caractère humains. Enfin, retiens le vocabulaire de base de la poésie : le vers, la strophe et la rime. Tu es prêt à lire et analyser des fables !",
    },
  ],
  fiche: {
    intro:
      "La fable est un court récit, souvent en vers, mettant en scène des animaux personnifiés pour délivrer une morale. Elle plaît par son récit et instruit par la leçon qu'elle transmet.",
    sections: [
      {
        titre: "Définition et fonction de la fable",
        points: [
          "Fable : court récit mettant en scène des animaux qui parlent et agissent comme des humains",
          "Elle comprend un récit et une morale (leçon de vie)",
          "Sa fonction : plaire (par l'histoire) et instruire (par la morale)",
          "La morale peut être explicite (écrite) ou implicite (suggérée)",
        ],
      },
      {
        titre: "Deux grands fabulistes",
        points: [
          "Ésope : fabuliste grec du 6e siècle av. J.-C., fables en prose",
          "Jean de La Fontaine : poète français du 17e siècle, fables en vers",
          "La Fontaine s'inspire d'Ésope mais enrichit le récit et le style",
          "Ses fables critiquent parfois discrètement les puissants de son époque",
        ],
      },
      {
        titre: "La personnification des animaux",
        points: [
          "Chaque animal représente un trait de caractère humain",
          "Le renard : la ruse ; le lion : la force et le pouvoir",
          "L'agneau : l'innocence ; la fourmi : le travail et la prévoyance",
          "La cigale : l'insouciance ; la tortue : la persévérance",
        ],
      },
      {
        titre: "Le vocabulaire de la poésie",
        points: [
          "Le vers : une ligne d'un poème",
          "La strophe : un groupe de vers séparé par un blanc",
          "La rime : répétition d'un même son en fin de vers (plates, croisées, embrassées)",
          "L'alexandrin : un vers de douze syllabes",
        ],
      },
    ],
    audio:
      "Fiche de révision : fables et poésie. La fable est un court récit, souvent écrit en vers, qui met en scène des animaux parlant comme des humains. Elle se compose d'un récit et d'une morale, une leçon de vie que le lecteur doit retenir. Sa fonction est double : plaire par l'histoire et instruire par la morale. Le Grec Ésope aurait inventé la fable au sixième siècle avant Jésus-Christ, en prose. Jean de La Fontaine, poète français du dix-septième siècle, s'en est inspiré pour écrire ses propres fables en vers, comme Le Corbeau et le Renard ou La Cigale et la Fourmi. Dans les fables, chaque animal représente un trait de caractère humain : le renard la ruse, le lion la force, la fourmi le travail. Enfin, pour lire un poème, il faut connaître le vers, qui est une ligne du poème, la strophe, qui regroupe plusieurs vers, et la rime, qui est la répétition d'un même son en fin de vers.",
  },
  memoCards: [
    { recto: "Qu'est-ce qu'une fable ?", verso: "Un court récit, souvent en vers, mettant en scène des animaux personnifiés, terminé par une morale." },
    { recto: "Quelle est la fonction de la fable ?", verso: "Plaire (par le récit) et instruire (par la morale)." },
    { recto: "Qui est Ésope ?", verso: "Un fabuliste grec du 6e siècle av. J.-C., qui écrivait ses fables en prose." },
    { recto: "Qui est Jean de La Fontaine ?", verso: "Un poète français du 17e siècle, auteur de fables en vers inspirées d'Ésope." },
    { recto: "Que symbolise le renard dans les fables ?", verso: "La ruse et l'habileté." },
    { recto: "Que symbolise la fourmi dans les fables ?", verso: "Le travail et la prévoyance." },
    { recto: "Qu'est-ce qu'un vers et une strophe ?", verso: "Le vers est une ligne d'un poème ; la strophe est un groupe de vers séparé par un blanc." },
    { recto: "Qu'est-ce qu'une rime ?", verso: "La répétition d'un même son à la fin de deux vers ou plus (plates, croisées, embrassées)." },
  ],
  exercices: [
    {
      type: "qcm",
      ...
      choix: ["Un poème d'amour", "Un court récit avec une morale", "Une pièce de théâtre", "Un roman long"],
      bonneReponse: 1,
      explication: "La fable est un court récit, souvent en vers, mettant en scène des animaux et se terminant par une morale.",
    },
    {
      type: "qcm",
      difficulte: "facile",
      question: "Qui est l'auteur français le plus connu pour ses fables ?",
      choix: ["Victor Hugo", "Jean de La Fontaine", "Charles Perrault", "Homère"],
      bonneReponse: 1,
      explication: "Jean de La Fontaine a publié douze livres de fables au 17e siècle.",
    },
    {
      type: "ouverte",
      difficulte: "facile",
      question: "Quelle est la double fonction de la fable ?",
      reponse: "Plaire (par le récit) et instruire (par la morale).",
      explication: "C'est la formule traditionnelle utilisée pour décrire la fable.",
    },
    {
      type: "qcm",
      difficulte: "facile",
      question: "Que symbolise généralement le renard dans les fables ?",
      choix: ["La force", "La ruse", "L'innocence", "La lenteur"],
      bonneReponse: 1,
      explication: "Le renard est traditionnellement associé à la ruse et à l'habileté.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Qui a inventé la fable en Grèce antique, avant La Fontaine ?",
      choix: ["Homère", "Ésope", "Zeus", "Perrault"],
      bonneReponse: 1,
      explication: "Ésope aurait inventé la fable au 6e siècle avant J.-C., en écrivant en prose.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Dans La Cigale et la Fourmi, quels traits de caractère opposent les deux personnages ?",
      reponse: "La cigale représente l'insouciance : elle chante tout l'été sans se soucier de l'hiver. La fourmi représente la prévoyance et le travail : elle fait des réserves pour l'hiver.",
      explication: "Cette opposition entre insouciance et prévoyance est au cœur de la morale de cette fable.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Qu'est-ce que la personnification ? Illustre ta réponse avec un exemple tiré d'une fable.",
      reponse: "La personnification consiste à donner des caractéristiques humaines (parole, sentiments, comportements) à un animal ou à un objet. Par exemple, dans Le Corbeau et le Renard, le corbeau et le renard parlent et le renard flatte le corbeau comme le ferait un humain rusé.",
      explication: "C'est un procédé essentiel qui permet à la fable de représenter des comportements humains à travers des animaux.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Combien de syllabes compte un alexandrin ?",
      choix: ["Huit", "Dix", "Douze", "Quatorze"],
      bonneReponse: 2,
      explication: "L'alexandrin est un vers de douze syllabes, très utilisé en poésie française classique.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Explique la morale du Corbeau et le Renard et dis pourquoi elle reste utile aujourd'hui.",
      reponse: "La morale est que la flatterie peut faire perdre son bien à celui qui l'écoute sans se méfier (« Tout flatteur vit aux dépens de celui qui l'écoute »). Elle reste utile aujourd'hui car elle apprend à se méfier des compliments trop intéressés, que ce soit dans la publicité ou dans les relations entre personnes.",
      explication: "Les morales des fables gardent une portée universelle, applicable à des situations très diverses.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Identifie le schéma de rimes (AABB, ABAB ou ABBA) dans ces quatre vers imaginaires, et nomme ce schéma : « Le renard court dans le bois profond (A) / Il cherche une proie sans faire de bruit (B) / La lune éclaire la nuit qui s'enfuit (B) / Et le silence recouvre les monts (A). »",
      reponse: "Il s'agit de rimes embrassées, notées ABBA : le premier vers rime avec le quatrième (profond / monts), et le deuxième avec le troisième (bruit / s'enfuit).",
      explication: "Les rimes embrassées encadrent deux vers aux rimes différentes entre deux vers aux rimes identiques.",
    },
    {
      type: "qcm",
      difficulte: "avance",
      question: "Pourquoi La Fontaine choisit-il de mettre en scène des animaux plutôt que des hommes dans ses fables ?",
      choix: [
        "Parce qu'il n'aimait pas les hommes",
        "Pour critiquer discrètement les comportements humains et la société sans les nommer directement",
        "Parce que c'était plus facile à écrire",
        "Parce que les animaux étaient à la mode",
      ],
      bonneReponse: 1,
      explication: "En utilisant des animaux, La Fontaine peut critiquer certains comportements humains, y compris ceux des puissants, sans les nommer directement et ainsi éviter la censure.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Rédige la morale (une ou deux phrases) d'une fable imaginaire que tu inventerais, mettant en scène deux animaux de ton choix.",
      reponse: "Réponse libre. Exemple : Fable entre une tortue et un aigle : « La patience et l'humilité valent mieux que l'orgueil et la précipitation. » On attend une morale claire, formulée comme une leçon de vie générale.",
      explication: "On évalue la capacité à formuler une morale claire et généralisable à partir d'une situation inventée.",
    },
  ],
  revisionFinChapitre: [
    {
      type: "qcm",
      difficulte: "facile",
      question: "La fable se termine (ou commence) souvent par :",
      choix: ["une chanson", "une morale", "un dialogue", "un résumé"],
      bonneReponse: 1,
      explication: "La morale est la leçon de vie que la fable transmet au lecteur.",
    },
    {
      type: "ouverte",
      difficulte: "facile",
      question: "Cite un fabuliste grec antérieur à La Fontaine.",
      reponse: "Ésope.",
      explication: "Il aurait vécu au 6e siècle avant Jésus-Christ et écrivait ses fables en prose.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Qu'est-ce qu'une strophe ?",
      choix: ["Un seul mot", "Un groupe de vers séparé par un blanc", "La morale d'une fable", "Un animal symbolique"],
      bonneReponse: 1,
      explication: "La strophe regroupe plusieurs vers, séparée des autres strophes par un espace.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Qu'est-ce que la personnification d'un animal dans une fable ?",
      reponse: "C'est le fait de donner à un animal des comportements, des paroles ou des sentiments humains.",
      explication: "Ce procédé permet à la fable de représenter des traits de caractère humains à travers des animaux.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Donne un exemple de rime plate et explique en quoi elle consiste.",
      reponse: "Une rime plate suit le schéma AABB : les deux premiers vers riment ensemble, puis les deux suivants riment entre eux. Exemple de schéma : vers 1 et 2 riment en \"-oup\", vers 3 et 4 riment en \"-in\".",
      explication: "Les rimes plates sont l'une des trois dispositions de rimes les plus courantes, avec les rimes croisées et embrassées.",
    },
  ],
  examens: [
    {
      titre: "Examen 1 — Fables et poésie",
      dureeMinutes: 20,
      questions: [
        {
          type: "qcm",
          difficulte: "facile",
          question: "Une fable met le plus souvent en scène :",
          choix: ["des rois et des reines", "des animaux personnifiés", "des extraterrestres", "des objets sans vie"],
          bonneReponse: 1,
          explication: "Les animaux personnifiés sont les personnages typiques de la fable.",
        },
        {
          type: "ouverte",
          difficulte: "facile",
          question: "Qu'est-ce qu'un vers ?",
          reponse: "Une ligne d'un poème.",
          explication: "Plusieurs vers regroupés forment une strophe.",
        },
        {
          type: "qcm",
          difficulte: "moyen",
          question: "Dans Le Lièvre et la Tortue, quelle qualité permet à la tortue de gagner la course ?",
          choix: ["Sa rapidité", "Sa persévérance", "Sa ruse", "Sa force"],
          bonneReponse: 1,
          explication: "La tortue avance lentement mais sans jamais s'arrêter, contrairement au lièvre trop confiant.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Explique la différence entre les fables d'Ésope et celles de La Fontaine.",
          reponse: "Les fables d'Ésope, plus anciennes, sont écrites en prose et sont souvent plus courtes. Les fables de La Fontaine, inspirées d'Ésope, sont écrites en vers et développent davantage le récit et le style.",
          explication: "La Fontaine reprend souvent les mêmes histoires qu'Ésope mais les enrichit par la forme poétique.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Qu'est-ce qu'une rime croisée ? Donne le schéma correspondant.",
          reponse: "Une rime croisée alterne deux sons de rimes différents selon le schéma ABAB : le premier vers rime avec le troisième, le deuxième avec le quatrième.",
          explication: "C'est l'une des trois principales dispositions de rimes, avec les rimes plates (AABB) et embrassées (ABBA).",
        },
        {
          type: "ouverte",
          difficulte: "avance",
          question: "Choisis une fable que tu connais et explique en quoi elle « plaît » (par son récit) et « instruit » (par sa morale).",
          reponse: "Exemple avec Le Corbeau et le Renard : la fable plaît par son récit vivant et amusant, où le renard flatte habilement le corbeau pour lui voler son fromage. Elle instruit par sa morale, qui met en garde contre les flatteurs et invite à se méfier des compliments trop intéressés.",
          explication: "On évalue la compréhension de la double fonction de la fable à travers un exemple précis.",
        },
      ],
    },
    {
      titre: "Examen 2 — Fables et poésie",
      dureeMinutes: 20,
      questions: [
        {
          type: "qcm",
          difficulte: "facile",
          question: "Jean de La Fontaine a vécu :",
          choix: ["Au Moyen Âge", "Au 17e siècle", "Au 19e siècle", "De nos jours"],
          bonneReponse: 1,
          explication: "La Fontaine est un poète français du 17e siècle, à la cour de Louis XIV.",
        },
        {
          type: "ouverte",
          difficulte: "facile",
          question: "Que symbolise généralement la fourmi dans les fables ?",
          reponse: "Le travail et la prévoyance.",
          explication: "On l'oppose souvent à la cigale, symbole de l'insouciance.",
        },
        {
          type: "qcm",
          difficulte: "moyen",
          question: "Quel est le nombre de syllabes d'un alexandrin ?",
          choix: ["Dix", "Douze", "Quatorze", "Seize"],
          bonneReponse: 1,
          explication: "L'alexandrin, très utilisé en poésie classique française, compte douze syllabes.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Pourquoi peut-on dire que les fables de La Fontaine critiquent parfois la société de son époque ?",
          reponse: "Parce que sous couvert d'histoires d'animaux, La Fontaine dénonce des comportements humains, comme l'abus de pouvoir des puissants (souvent représentés par le lion) ou la flatterie et l'hypocrisie à la cour, sans nommer directement les personnes visées.",
          explication: "Utiliser des animaux permettait à La Fontaine de critiquer discrètement sans s'exposer à la censure.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Qu'est-ce qu'une rime embrassée ? Donne le schéma correspondant.",
          reponse: "Une rime embrassée encadre deux vers aux rimes identiques par deux vers aux rimes différentes, selon le schéma ABBA.",
          explication: "C'est la troisième disposition de rimes classique, avec les rimes plates et croisées.",
        },
        {
          type: "ouverte",
          difficulte: "avance",
          question: "Compare les personnages du Lièvre et de la Tortue en expliquant ce que chacun symbolise, puis explique la morale de cette fable.",
          reponse: "Le lièvre symbolise la vantardise, l'excès de confiance et la précipitation, tandis que la tortue symbolise la modestie, la persévérance et la régularité dans l'effort. La morale de cette fable est que la persévérance et l'effort constant peuvent l'emporter sur des qualités apparemment supérieures mais mal utilisées, comme la rapidité gâchée par l'excès de confiance.",
          explication: "Cette fable est l'une des plus connues pour illustrer l'opposition entre deux qualités contraires.",
        },
      ],
    },
  ],
  syntheseRevisions: [
    "La fable est un court récit, souvent en vers, qui met en scène des animaux personnifiés et se termine par une morale.",
    "Sa double fonction : plaire par le récit et instruire par la morale.",
    "Ésope (Grèce antique, en prose) et Jean de La Fontaine (17e siècle, en vers) sont les deux grands fabulistes à connaître.",
    "Chaque animal symbolise un trait humain : le renard la ruse, le lion le pouvoir, la fourmi le travail.",
    "Le vers est une ligne d'un poème ; la strophe regroupe plusieurs vers ; l'alexandrin compte douze syllabes.",
    "La rime peut être plate (AABB), croisée (ABAB) ou embrassée (ABBA).",
  ],
},
{
  slug: "natures-classes-mots",
  titre: "Les natures (classes) de mots",
  matiere: "francais",
  niveau: "6eme",
  description:
    "Découvrir les natures de mots : le nom, le déterminant, l'adjectif, le verbe, le pronom et les mots invariables, pour mieux comprendre comment une phrase est construite.",
  objectifs: [
    "Savoir ce qu'est la nature (ou classe grammaticale) d'un mot",
    "Reconnaître le nom, le déterminant et l'adjectif qualificatif",
    "Reconnaître le verbe et le pronom",
    "Découvrir les mots invariables (adverbe, préposition, conjonction)",
    "Utiliser des tests simples pour identifier la nature d'un mot",
  ],
  slides: [
    {
      titre: "Qu'est-ce que la nature d'un mot ?",
      illustration: "🪪",
      visuel: "chat = nom",
      contenu: [
        "Chaque mot appartient à une famille : sa nature (ou classe)",
        "On trouve la nature d'un mot dans le dictionnaire",
        "Exemples de natures : nom, verbe, adjectif...",
        "La nature d'un mot ne change jamais, quelle que soit la phrase",
      ],
      voixOff:
        "Tous les mots de la langue française appartiennent à une famille : c'est ce qu'on appelle leur nature, ou leur classe grammaticale. Le dictionnaire indique toujours la nature d'un mot, juste après le mot lui-même. Par exemple, le mot chat est un nom. Cette nature ne change jamais, où que le mot soit placé dans la phrase.",
    },
    {
      titre: "Le nom",
      illustration: "🏷️",
      visuel: "chat, Paris, joie",
      contenu: [
        "Le nom désigne une personne, un animal, une chose ou une idée",
        "Nom commun : chat, table, joie (s'écrit avec une minuscule)",
        "Nom propre : Paris, Léa, France (s'écrit avec une majuscule)",
        "Astuce : un nom accepte presque toujours un déterminant devant lui",
      ],
      voixOff:
        "Le nom sert à désigner une personne, un animal, une chose ou même une idée comme la joie. Il existe deux sortes de noms : le nom commun, comme chat ou table, qui s'écrit avec une minuscule, et le nom propre, comme Paris ou Léa, qui s'écrit toujours avec une majuscule. Pour reconnaître un nom, une astuce simple : on peut presque toujours mettre un petit mot devant lui, comme le ou une.",
    },
    {
      titre: "Le déterminant",
      illustration: "👉",
      visuel: "le, une, mon, ces, trois",
      contenu: [
        "Le déterminant se place devant le nom pour l'introduire",
        "Articles : le, la, les, un, une, des",
        "Déterminants possessifs : mon, ta, ses...",
        "Déterminants démonstratifs (ce, cette) et numéraux (trois, dix)",
      ],
      voixOff:
        "Le déterminant est le petit mot qui se place juste devant le nom pour l'introduire. Les plus courants sont les articles : le, la, les, un, une, des. Il existe aussi des déterminants possessifs, comme mon ou ta, des déterminants démonstratifs, comme ce ou cette, et des déterminants numéraux, comme trois ou dix. Sans déterminant, un nom commun paraît souvent incomplet.",
    },
    {
      titre: "L'adjectif qualificatif",
      illustration: "🎨",
      visuel: "un chat noir, une robe rouge",
      contenu: [
        "L'adjectif qualificatif donne une caractéristique du nom",
        "Il s'accorde en genre et en nombre avec le nom : noir → noire → noirs",
        "Test : on peut souvent ajouter « très » devant lui",
        "Il se place avant ou après le nom qu'il caractérise",
      ],
      voixOff:
        "L'adjectif qualificatif donne des précisions sur le nom : un chat noir, une robe rouge. Il s'accorde toujours en genre et en nombre avec le nom qu'il accompagne : noir devient noire au féminin, puis noirs au masculin pluriel. Pour le reconnaître, un test très pratique consiste à ajouter le mot très devant lui : très noir, très curieux.",
    },
    {
      titre: "Le verbe",
      illustration: "🏃",
      visuel: "je cours, tu chantes, il dort",
      contenu: [
        "Le verbe exprime une action (courir) ou un état (être, sembler)",
        "C'est le seul mot de la phrase qui se conjugue",
        "Il change selon la personne et le temps",
        "Test : « il ... hier » → si on peut mettre le mot au passé, c'est un verbe",
      ],
      voixOff:
        "Le verbe exprime une action, comme courir ou manger, ou bien un état, comme être ou sembler. C'est le seul mot de la langue qui se conjugue : il change de forme selon la personne et selon le temps. Pour le reconnaître, on peut essayer de le mettre à un autre temps, par exemple hier. Si le mot se transforme, c'est bien un verbe.",
    },
    {
      titre: "Le pronom",
      illustration: "🔁",
      ...
      contenu: [
        ...
        "Il évite de répéter le même mot plusieurs fois",
        "Pronoms personnels : je, tu, il, elle, nous, vous, ils, elles",
        "D'autres pronoms existent : celui-ci, le mien, qui...",
      ],
      voixOff:
        "Le pronom remplace un nom ou un groupe nominal pour éviter de le répéter. Dans la phrase Léa lit un livre, elle l'adore, le mot elle remplace Léa. Les pronoms les plus fréquents sont les pronoms personnels : je, tu, il, elle, nous, vous, ils, elles. Il existe aussi d'autres pronoms, comme celui-ci ou qui.",
    },
    {
      titre: "Les mots invariables",
      illustration: "🧭",
      visuel: "vite, dans, et, oh !",
      contenu: [
        "Certains mots ne changent jamais de forme : ils sont invariables",
        "L'adverbe précise un verbe, un adjectif : vite, très, hier",
        "La préposition introduit un complément : à, de, dans, pour, avec",
        "La conjonction relie des mots ou des phrases : et, mais, ou, car",
      ],
      voixOff:
        "Certains mots ne s'accordent jamais et ne se conjuguent jamais : on dit qu'ils sont invariables. L'adverbe apporte une précision, par exemple sur un verbe : il court vite. La préposition introduit un complément, comme dans les mots à, de, dans ou pour. La conjonction relie des mots ou des phrases entre eux : et, mais, ou, car.",
    },
    {
      titre: "Un même mot, plusieurs natures possibles",
      illustration: "⚠️",
      visuel: "la porte / je la vois",
      contenu: [
        "Attention : un même mot peut avoir plusieurs natures selon la phrase",
        "« la » : déterminant devant un nom (la porte) ou pronom devant un verbe (je la vois)",
        "« ferme » peut être un verbe, un nom ou un adjectif",
        "Il faut toujours observer le mot dans sa phrase",
      ],
      voixOff:
        "Attention à un piège fréquent : un même mot peut appartenir à plusieurs natures selon la phrase où il se trouve. Le mot la est un déterminant devant un nom, comme dans la porte, mais un pronom devant un verbe, comme dans je la vois. Il faut donc toujours observer un mot dans sa phrase, et jamais tout seul, pour trouver sa véritable nature.",
    },
    {
      titre: "Ce qu'il faut retenir",
      illustration: "🏆",
      visuel: "📌",
      contenu: [
        "La nature d'un mot dit ce qu'il EST : nom, verbe, adjectif...",
        "Nom, déterminant, adjectif, verbe, pronom : les natures les plus fréquentes",
        "Adverbe, préposition, conjonction : des mots invariables",
        "Un mot s'analyse toujours dans sa phrase, jamais isolé",
      ],
      voixOff:
        "Résumons l'essentiel de ce chapitre. La nature d'un mot dit ce qu'il est : nom, verbe, adjectif, et bien d'autres encore. Les natures les plus fréquentes sont le nom, le déterminant, l'adjectif, le verbe et le pronom. Il existe aussi des mots invariables comme l'adverbe, la préposition et la conjonction. Retiens bien ce réflexe : on analyse toujours un mot dans sa phrase, jamais tout seul. Bravo, tu connais maintenant les principales natures de mots !",
    },
  ],
  fiche: {
    intro:
      "La nature (ou classe grammaticale) d'un mot indique à quelle famille de mots il appartient : nom, verbe, adjectif... Elle est fixe et se trouve dans le dictionnaire.",
    sections: [
      {
        titre: "Les mots qui varient",
        points: [
          "Nom : désigne une personne, une chose, une idée (chat, Léa, joie)",
          "Déterminant : introduit le nom (le, une, mon, ces, trois)",
          "Adjectif qualificatif : caractérise le nom et s'accorde avec lui (noir, curieux)",
          "Verbe : exprime une action ou un état, seul mot qui se conjugue",
          "Pronom : remplace un nom pour éviter une répétition (elle, celui-ci)",
        ],
      },
      {
        titre: "Les mots invariables",
        points: [
          "Adverbe : précise un verbe, un adjectif ou un autre adverbe (vite, très)",
          "Préposition : introduit un complément (à, de, dans, pour, avec, chez)",
          "Conjonction : relie des mots ou des phrases (et, mais, ou, car, donc)",
          "Ces mots s'écrivent toujours de la même façon",
        ],
      },
      {
        titre: "Des tests pour reconnaître une nature",
        points: [
          "Nom : on peut mettre un déterminant devant (le/une + mot)",
          "Adjectif : on peut souvent ajouter « très » devant",
          "Verbe : il change de forme si on change le temps (hier, il...)",
          "Pronom : il remplace un nom déjà cité dans le texte",
        ],
      },
      {
        titre: "Attention aux pièges",
        points: [
          "Un même mot peut avoir plusieurs natures selon la phrase",
          "« la » : déterminant (la porte) ou pronom (je la vois)",
          "« ferme » : verbe (il ferme), nom (une ferme), adjectif (un ton ferme)",
          "Toujours lire le mot dans sa phrase avant de répondre",
        ],
      },
    ],
    audio:
      "Fiche de révision : les natures de mots. La nature d'un mot dit ce qu'il est : nom, verbe, adjectif, et elle se trouve dans le dictionnaire. Le nom désigne une personne, une chose ou une idée. Le déterminant introduit le nom, comme le, une ou mon. L'adjectif qualificatif caractérise le nom et s'accorde avec lui. Le verbe exprime une action ou un état : c'est le seul mot qui se conjugue. Le pronom remplace un nom pour éviter une répétition. Il existe aussi des mots invariables : l'adverbe précise un verbe ou un adjectif, la préposition introduit un complément, et la conjonction relie des mots ou des phrases. Attention, un même mot peut changer de nature selon la phrase : il faut toujours l'observer en contexte.",
  },
  memoCards: [
    { recto: "Qu'est-ce que la nature d'un mot ?", verso: "C'est la famille grammaticale à laquelle il appartient : nom, verbe, adjectif... Elle est indiquée dans le dictionnaire." },
    { recto: "Qu'est-ce qu'un nom ?", verso: "Un mot qui désigne une personne, un animal, une chose ou une idée (chat, Léa, joie)." },
    { recto: "À quoi sert un déterminant ?", verso: "Il se place devant le nom pour l'introduire (le, une, mon, ces, trois)." },
    { recto: "Comment reconnaître un adjectif qualificatif ?", verso: "Il caractérise un nom, s'accorde avec lui et accepte souvent « très » devant." },
    { recto: "Comment reconnaître un verbe ?", verso: "C'est le seul mot qui se conjugue : il change avec le temps et la personne." },
    { recto: "À quoi sert un pronom ?", verso: "Il remplace un nom ou un groupe nominal pour éviter une répétition." },
    { recto: "Cite trois mots invariables.", verso: "L'adverbe, la préposition et la conjonction ne changent jamais de forme." },
    { recto: "« la » : toujours un déterminant ?", verso: "Non ! Déterminant devant un nom (la porte) mais pronom devant un verbe (je la vois)." },
  ],
  exercices: [
    {
      type: "qcm",
      difficulte: "facile",
      question: "Quelle est la nature du mot « chien » dans « Le chien aboie » ?",
      choix: ["Verbe", "Adjectif", "Nom", "Déterminant"],
      bonneReponse: 2,
      explication: "« Chien » désigne un animal et accepte un déterminant devant lui (le chien) : c'est un nom.",
    },
    {
      type: "qcm",
      difficulte: "facile",
      question: "Dans « une belle histoire », quelle est la nature de « belle » ?",
      choix: ["Nom", "Adjectif qualificatif", "Verbe", "Adverbe"],
      bonneReponse: 1,
      explication: "« Belle » caractérise le nom « histoire » et s'accorde avec lui : c'est un adjectif qualificatif.",
    },
    {
      type: "ouverte",
      difficulte: "facile",
      question: "Cite trois natures de mots qui peuvent varier (changer de forme).",
      reponse: "Le nom, l'adjectif et le verbe (on peut aussi citer le déterminant et le pronom).",
      explication: "Ces mots s'accordent en genre et en nombre, ou se conjuguent selon la personne et le temps.",
    },
    {
      type: "qcm",
      difficulte: "facile",
      question: "Dans « Il mange une pomme », quel mot est le verbe ?",
      choix: ["Il", "mange", "une", "pomme"],
      bonneReponse: 1,
      explication: "« Mange » se conjugue (je mangeais, nous mangions) : c'est le verbe de la phrase.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Dans « Je la regarde », quelle est la nature de « la » ?",
      choix: ["Déterminant", "Pronom", "Nom", "Adjectif"],
      bonneReponse: 1,
      explication: "Placé devant le verbe « regarde », « la » remplace un nom : c'est un pronom, pas un déterminant.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Dans « Cette maison ancienne semble abandonnée », donne la nature de « cette », « ancienne » et « semble ».",
      reponse: "« Cette » : déterminant démonstratif. « Ancienne » : adjectif qualificatif. « Semble » : verbe (verbe d'état).",
      explication: "Le déterminant précède le nom, l'adjectif le caractérise et s'accorde, le verbe se conjugue.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Dans « Il court très vite vers l'école », donne la nature de « très », « vite » et « vers ».",
      reponse: "« Très » : adverbe (il modifie l'adverbe « vite »). « Vite » : adverbe (il modifie le verbe « court »). « Vers » : préposition (elle introduit le complément « l'école »).",
      explication: "Ces trois mots sont invariables : deux adverbes et une préposition.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Quel mot de la liste est un pronom ?",
      choix: ["Léa", "elle", "jolie", "courir"],
      bonneReponse: 1,
      explication: "« Elle » remplace un nom déjà cité, comme dans « Léa chante, elle a une belle voix » : c'est un pronom personnel.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Donne la nature de « ferme » dans ces deux phrases : 1. « Mon oncle possède une ferme. » 2. « Ferme la porte, s'il te plaît. »",
      reponse: "1. Nom (précédé du déterminant « une »). 2. Verbe à l'impératif (on peut dire « fermez la porte »).",
      explication: "Un même mot peut changer de nature : on observe le mot dans sa phrase pour trancher.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Analyse la phrase « Le petit chat noir dort tranquillement » : donne la nature de chacun des six mots.",
      reponse: "« Le » : déterminant. « Petit » : adjectif qualificatif. « Chat » : nom. « Noir » : adjectif qualificatif. « Dort » : verbe. « Tranquillement » : adverbe.",
      explication: "On repère d'abord le verbe qui se conjugue, puis le nom noyau, encadré par ses déterminant et adjectifs.",
    },
    {
      type: "qcm",
      difficulte: "avance",
      question: "Dans « Mais elle refusa poliment », quelle est la nature de « mais » ?",
      choix: ["Adverbe", "Conjonction de coordination", "Préposition", "Pronom"],
      bonneReponse: 1,
      explication: "« Mais » relie deux idées ou deux phrases : c'est une conjonction de coordination, invariable.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Dans « Le dîner est prêt » et « Nous allons dîner », le mot « dîner » a-t-il la même nature ? Justifie ta réponse.",
      reponse: "Non. Dans « Le dîner est prêt », « dîner » est un nom (précédé du déterminant « le »). Dans « Nous allons dîner », c'est un verbe à l'infinitif.",
      explication: "Le déterminant devant un mot est un bon indice pour reconnaître un nom, même quand le mot ressemble à un verbe.",
    },
  ],
  revisionFinChapitre: [
    {
      type: "qcm",
      difficulte: "facile",
      question: "Où trouve-t-on la nature d'un mot ?",
      choix: ["Dans un roman", "Dans le dictionnaire", "Dans une carte", "Nulle part"],
      bonneReponse: 1,
      explication: "Le dictionnaire indique toujours la nature de chaque mot, juste après le mot.",
    },
    {
      type: "ouverte",
      difficulte: "facile",
      question: "Quelle est la seule nature de mot qui se conjugue ?",
      reponse: "Le verbe.",
      explication: "Le verbe change selon la personne et le temps ; les autres natures ne se conjuguent pas.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Dans « une jolie fleur », « jolie » est :",
      choix: ["un nom", "un adjectif qualificatif", "un déterminant", "un pronom"],
      bonneReponse: 1,
      explication: "« Jolie » caractérise le nom « fleur » et s'accorde avec lui.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "À quoi sert un pronom ? Donne un exemple.",
      reponse: "Un pronom remplace un nom pour éviter une répétition. Exemple : « Léa chante. Elle a une belle voix. »",
      explication: "« Elle » évite de répéter « Léa » une deuxième fois.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Cite trois mots invariables et explique ce que signifie « invariable ».",
      reponse: "L'adverbe, la préposition et la conjonction sont invariables : ils s'écrivent toujours de la même façon, sans accord ni conjugaison.",
      explication: "Contrairement au nom, à l'adjectif ou au verbe, ces mots ne changent jamais de forme.",
    },
  ],
  examens: [
    {
      titre: "Examen 1 — Les natures de mots",
      dureeMinutes: 20,
      questions: [
        {
          type: "qcm",
          difficulte: "facile",
          question: "La nature d'un mot, c'est :",
          choix: ["sa fonction dans la phrase", "sa famille grammaticale", "sa longueur", "sa place dans le dictionnaire"],
          bonneReponse: 1,
          explication: "La nature (ou classe grammaticale) indique à quelle famille appartient le mot : nom, verbe, adjectif...",
        },
        {
          type: "qcm",
          difficulte: "facile",
          question: "Dans « Les enfants jouent dans le jardin », quel mot est le verbe ?",
          choix: ["enfants", "jouent", "jardin", "dans"],
          bonneReponse: 1,
          explication: "« Jouent » se conjugue (je joue, nous jouions) : c'est le verbe.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Dans « Ma grande sœur lit rapidement », donne la nature de « ma », « grande » et « rapidement ».",
          reponse: "« Ma » : déterminant possessif. « Grande » : adjectif qualificatif. « Rapidement » : adverbe.",
          explication: "Le déterminant introduit le nom « sœur », l'adjectif le caractérise, l'adverbe précise le verbe « lit ».",
        },
        {
          type: "qcm",
          difficulte: "moyen",
          question: "Dans « Nous partons chez nos cousins », « chez » est :",
          choix: ["un adverbe", "une préposition", "une conjonction", "un nom"],
          bonneReponse: 1,
        ...
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Explique pourquoi on peut dire que le nom accepte presque toujours un déterminant devant lui. Donne un exemple.",
          reponse: "Un nom commun a besoin d'un petit mot pour être précisé ou introduit dans la phrase. Exemple : on peut dire « le chat » ou « un chat », mais pas simplement « chat » tout seul dans une phrase normale.",
          explication: "C'est l'un des tests les plus fiables pour identifier un nom.",
        },
        {
          type: "ouverte",
          difficulte: "avance",
          question: "Dans « La porte est fermée » et « Je la vois », donne la nature de « la » dans chaque phrase et explique la différence.",
          reponse: "Dans « La porte est fermée », « la » est un déterminant : il introduit le nom « porte ». Dans « Je la vois », « la » est un pronom : il remplace un nom déjà cité et se place devant le verbe.",
          explication: "Devant un nom, c'est un déterminant ; devant un verbe, c'est un pronom.",
        },
      ],
    },
    {
      titre: "Examen 2 — Les natures de mots",
      dureeMinutes: 20,
      questions: [
        {
          type: "qcm",
          ...
          choix: ["ville", "Paris", "grande", "habiter"],
          bonneReponse: 1,
          explication: "« Paris » désigne un lieu précis et s'écrit avec une majuscule : c'est un nom propre.",
        },
        {
          type: "qcm",
          difficulte: "facile",
          question: "Quel mot peut-on remplacer par « très » pour vérifier sa nature ?",
          choix: ["un nom", "un adjectif", "un verbe", "une préposition"],
          bonneReponse: 1,
          explication: "On peut souvent ajouter « très » devant un adjectif : très grand, très curieux.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Dans « Ils arrivèrent enfin au sommet », donne la nature de « ils », « enfin » et « au ».",
          reponse: "« Ils » : pronom personnel. « Enfin » : adverbe. « Au » : préposition (contraction de « à le ») introduisant le complément « sommet ».",
          explication: "« Ils » remplace un groupe de personnes, « enfin » est invariable, « au » introduit un complément de lieu.",
        },
        {
          type: "qcm",
          difficulte: "moyen",
          question: "Dans « Elle est fatiguée mais heureuse », « mais » est :",
          choix: ["un adverbe", "une préposition", "une conjonction de coordination", "un pronom"],
          bonneReponse: 2,
          explication: "« Mais » relie deux adjectifs et exprime une opposition : c'est une conjonction de coordination.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Qu'est-ce qu'un nom commun et un nom propre ? Donne un exemple de chaque.",
          reponse: "Le nom commun désigne une chose ou un être en général et s'écrit avec une minuscule (exemple : chat). Le nom propre désigne un être ou un lieu précis et s'écrit avec une majuscule (exemple : Léa).",
          explication: "La majuscule est l'indice visuel le plus simple pour distinguer les deux.",
        },
        {
          type: "ouverte",
          difficulte: "avance",
          question: "Dans « Le vieux marin racontait calmement ses aventures », analyse chaque mot en donnant sa nature.",
          reponse: "« Le » : déterminant. « Vieux » : adjectif qualificatif. « Marin » : nom. « Racontait » : verbe. « Calmement » : adverbe. « Ses » : déterminant possessif. « Aventures » : nom.",
          explication: "On repère d'abord le verbe conjugué, puis les deux groupes nominaux qui l'entourent.",
        },
      ],
    },
  ],
  syntheseRevisions: [
    "La nature (ou classe grammaticale) d'un mot dit ce qu'il EST ; elle figure dans le dictionnaire.",
    "Le nom désigne une personne, une chose ou une idée ; il est souvent précédé d'un déterminant.",
    "L'adjectif qualificatif caractérise le nom et s'accorde avec lui ; on peut souvent ajouter « très » devant.",
    "Le verbe est le seul mot qui se conjugue : il change avec le temps et la personne.",
    "Le pronom remplace un nom pour éviter une répétition ; l'adverbe, la préposition et la conjonction sont invariables.",
    "Un même mot peut changer de nature selon la phrase : on l'analyse toujours en contexte, jamais isolé.",
  ],
},
{
  slug: "odyssee",
  titre: "L'Odyssée d'Homère : monstres et héros",
  matiere: "francais",
  niveau: "6eme",
  description:
    "Découvrir L'Odyssée d'Homère, le long voyage d'Ulysse semé d'embûches et de monstres, pour comprendre ce qu'est une épopée et ce qui fait d'Ulysse un héros exemplaire de la mythologie grecque.",
  objectifs: [
    "Situer L'Odyssée dans le temps et connaître son auteur, Homère",
    "Comprendre ce qu'est une épopée",
    "Découvrir les principaux monstres rencontrés par Ulysse",
    "Identifier les qualités qui font d'Ulysse un héros",
    "Repérer le rôle des dieux dans le récit",
  ],
  slides: [
    {
      titre: "Homère et L'Odyssée",
      illustration: "📜",
      visuel: "VIIIe siècle av. J.-C.",
      contenu: [
        "Homère est un poète grec qui aurait vécu au 8e siècle avant J.-C.",
        "L'Odyssée raconte le retour d'Ulysse chez lui, à Ithaque",
        "Ce voyage dure dix longues années, remplies de dangers",
        "Le récit a d'abord été transmis oralement avant d'être écrit",
      ],
      voixOff:
        "Homère est un poète grec qui aurait vécu au huitième siècle avant Jésus-Christ. On lui attribue deux grandes œuvres : l'Iliade et l'Odyssée. L'Odyssée raconte le retour du héros Ulysse chez lui, sur l'île d'Ithaque, après la guerre de Troie. Ce voyage de retour dure dix années entières, semées d'embûches et de monstres. Comme beaucoup de récits antiques, il fut d'abord raconté oralement avant d'être mis par écrit.",
    },
    {
      titre: "Qu'est-ce qu'une épopée ?",
      illustration: "⚔️",
      visuel: "Long poème + héros + exploits",
      contenu: [
        "L'épopée est un long poème qui raconte les exploits d'un héros",
        "Elle mêle des événements historiques et des éléments merveilleux",
        "Les dieux interviennent souvent dans l'action",
        "L'Odyssée est composée de 24 chants (parties)",
      ],
      voixOff:
        "L'épopée est un long poème qui raconte les exploits extraordinaires d'un héros, souvent au service de son peuple ou de sa patrie. Elle mêle des faits qui pourraient être historiques à des éléments merveilleux, comme la présence de monstres ou l'intervention des dieux. L'Odyssée est un exemple célèbre d'épopée : elle est composée de vingt-quatre chants, c'est-à-dire vingt-quatre parties.",
    },
    {
      titre: "Ulysse, le héros rusé",
      illustration: "🛡️",
      visuel: "Force + ruse + intelligence",
      contenu: [
        "Ulysse est le roi d'Ithaque, héros de la guerre de Troie",
        "Il est connu pour son intelligence et sa ruse (le cheval de Troie)",
        "Il doit affronter monstres, tempêtes et pièges pour rentrer chez lui",
        "Son épouse Pénélope et son fils Télémaque l'attendent à Ithaque",
      ],
      voixOff:
        "Ulysse est le roi d'Ithaque et l'un des héros grecs de la guerre de Troie. Il est surtout connu pour son intelligence et sa ruse, comme lorsqu'il a l'idée du cheval de Troie. Sur le chemin du retour, il doit affronter de nombreux dangers : monstres, tempêtes et pièges en tout genre. Pendant ce temps, sa fidèle épouse Pénélope et son fils Télémaque l'attendent à Ithaque, espérant son retour.",
    },
    {
      titre: "Le cyclope Polyphème",
      illustration: "👁️",
      visuel: "Un œil unique",
      contenu: [
        "Polyphème est un cyclope, géant à un seul œil, fils de Poséidon",
        "Il enferme Ulysse et ses compagnons dans sa grotte",
        "Ulysse le rend ivre puis lui crève son unique œil pour s'échapper",
        "Ulysse se vante de son nom : Poséidon devient son ennemi juré",
      ],
      voixOff:
        "Parmi les épreuves les plus célèbres, Ulysse rencontre le cyclope Polyphème, un géant à un seul œil, fils du dieu Poséidon. Ce monstre enferme Ulysse et ses compagnons dans sa grotte et en dévore plusieurs. Grâce à la ruse, Ulysse l'enivre puis lui crève son unique œil pendant son sommeil pour pouvoir s'échapper. Mais en se vantant de son nom en s'enfuyant, Ulysse s'attire la colère de Poséidon, qui devient dès lors son ennemi juré.",
    },
    {
      titre: "Circé la magicienne",
      illustration: "🐷",
      visuel: "Hommes transformés en porcs",
      contenu: [
        "Circé est une magicienne qui vit sur l'île d'Ééa",
        "Elle transforme les compagnons d'Ulysse en porcs",
        "Grâce à une plante magique offerte par le dieu Hermès, Ulysse résiste",
        "Ulysse reste un an sur son île avant de reprendre la mer",
      ],
      voixOff:
        "Sur l'île d'Ééa vit la magicienne Circé, qui transforme les compagnons d'Ulysse en porcs grâce à une potion. Ulysse, lui, résiste à ce sortilège grâce à une plante magique que lui offre le dieu Hermès. Il reste finalement une année entière auprès de Circé avant de reprendre la mer pour poursuivre son voyage vers Ithaque.",
    },
    {
      titre: "Les sirènes et Charybde et Scylla",
      illustration: "🧜",
      visuel: "Chant envoûtant + tourbillon + monstre marin",
      contenu: [
        "Les sirènes attirent les marins par leur chant envoûtant vers la mort",
        "Ulysse se fait attacher au mât pour résister à leur chant",
        "Charybde est un tourbillon qui engloutit les navires",
        "Scylla est un monstre à six têtes qui dévore les marins",
      ],
      voixOff:
        "Ulysse doit ensuite affronter les sirènes, des créatures dont le chant envoûtant attire les marins vers une mort certaine. Pour résister à la tentation, il se fait attacher au mât du navire et bouche les oreilles de ses compagnons avec de la cire. Un peu plus loin, il doit franchir un passage périlleux entre Charybde, un terrible tourbillon, et Scylla, un monstre à six têtes qui dévore les marins un par un.",
    },
    {
      titre: "Le rôle des dieux",
      illustration: "⚡",
      visuel: "Poséidon (contre) / Athéna (pour)",
      contenu: [
        "Les dieux interviennent constamment dans le destin d'Ulysse",
        "Poséidon, dieu de la mer, s'acharne contre lui après l'épisode du cyclope",
        "Athéna, déesse de la sagesse, protège et aide Ulysse",
        "Zeus arbitre parfois les conflits entre les dieux",
      ],
      voixOff:
        "Dans L'Odyssée, les dieux interviennent constamment dans le destin des hommes. Poséidon, le dieu de la mer, s'acharne contre Ulysse après qu'il a blessé son fils Polyphème, provoquant tempêtes et naufrages. À l'inverse, Athéna, déesse de la sagesse, protège et guide Ulysse tout au long de son voyage. Zeus, le roi des dieux, intervient parfois pour arbitrer les désaccords entre les divinités.",
    },
    {
      titre: "Le retour à Ithaque",
      illustration: "🏹",
      visuel: "L'arc d'Ulysse",
      contenu: [
        "De retour à Ithaque, Ulysse se déguise en mendiant",
        "Sa femme Pénélope est assiégée par des prétendants qui veulent sa main",
        "Ulysse gagne le concours du tir à l'arc que seul lui peut réussir",
        "Il élimine les prétendants et retrouve enfin sa famille",
      ],
      voixOff:
        "Après vingt ans d'absence, Ulysse revient enfin à Ithaque, mais il se déguise en mendiant pour observer la situation sans être reconnu. Sa femme Pénélope est assiégée par de nombreux prétendants qui veulent l'épouser, croyant Ulysse mort. Elle organise un concours de tir à l'arc que seul son véritable mari est capable de réussir. Ulysse gagne l'épreuve, élimine les prétendants et retrouve enfin sa famille.",
    },
    {
      titre: "Ce qu'il faut retenir",
      illustration: "🏆",
      visuel: "📌",
      contenu: [
        "L'Odyssée est une épopée grecque attribuée à Homère",
        "Elle raconte le retour d'Ulysse à Ithaque après la guerre de Troie",
        "Ulysse affronte de nombreux monstres grâce à sa ruse et son courage",
        "Les dieux jouent un rôle essentiel : Poséidon contre lui, Athéna pour lui",
      ],
      voixOff:
        "Pour résumer, L'Odyssée est une grande épopée grecque attribuée à Homère, qui raconte le difficile retour d'Ulysse à Ithaque après la guerre de Troie. Tout au long de son voyage, Ulysse affronte des monstres redoutables comme le cyclope, les sirènes ou Charybde et Scylla, grâce à sa ruse et son courage. Les dieux jouent un rôle essentiel dans cette aventure, entre la colère de Poséidon et la protection d'Athéna. Tu connais maintenant les grandes étapes de ce voyage légendaire !",
    },
  ],
  fiche: {
    intro:
      "L'Odyssée est une épopée grecque attribuée à Homère qui raconte le retour du héros Ulysse à Ithaque après la guerre de Troie, à travers un voyage de dix ans semé de monstres et d'épreuves.",
    sections: [
      {
        titre: "L'œuvre et son auteur",
        points: [
          "Homère : poète grec du 8e siècle avant J.-C., auteur présumé de l'Iliade et l'Odyssée",
          "L'épopée : long poème qui raconte les exploits d'un héros, mêlant réel et merveilleux",
          "L'Odyssée compte 24 chants et raconte le retour d'Ulysse à Ithaque",
          "Le récit fut d'abord transmis oralement avant d'être écrit",
        ],
      },
      {
        titre: "Ulysse, un héros rusé",
        points: [
          "Roi d'Ithaque, héros de la guerre de Troie (inventeur du cheval de Troie)",
          "Qualités : intelligence, ruse, courage, ténacité",
          "Attendu par son épouse Pénélope et son fils Télémaque",
          "Son voyage de retour dure dix ans et met sa patience à l'épreuve",
        ],
      },
      {
        titre: "Les monstres rencontrés",
        points: [
          "Polyphème : cyclope à un œil, fils de Poséidon, vaincu par la ruse",
          "Circé : magicienne qui transforme les hommes en porcs",
          "Les sirènes : leur chant attire les marins vers la mort",
          "Charybde et Scylla : un tourbillon et un monstre à six têtes",
        ],
      },
      {
        titre: "Le rôle des dieux",
        points: [
          "Poséidon, dieu de la mer, s'acharne contre Ulysse (vengeance pour son fils)",
          "Athéna, déesse de la sagesse, protège et aide Ulysse",
          "Zeus arbitre parfois les conflits entre les divinités",
          "Les dieux montrent que le destin des hommes dépend aussi du monde divin",
        ],
      },
    ],
    audio:
      "Fiche de révision : L'Odyssée d'Homère. L'Odyssée est une épopée grecque attribuée au poète Homère, qui aurait vécu au huitième siècle avant Jésus-Christ. Elle raconte le retour du héros Ulysse à Ithaque après la guerre de Troie, un voyage qui dure dix ans. Une épopée est un long poème qui raconte les exploits d'un héros, en mêlant des éléments réels et merveilleux. Ulysse est connu pour son intelligence et sa ruse : il affronte de nombreux monstres, comme le cyclope Polyphème, la magicienne Circé qui transforme ses compagnons en porcs, les sirènes au chant envoûtant, et le passage périlleux entre Charybde et Scylla. Tout au long du récit, les dieux interviennent dans son destin : Poséidon, dieu de la mer, s'acharne contre lui, tandis qu'Athéna, déesse de la sagesse, le protège. À son retour, Ulysse retrouve sa femme Pénélope et son fils Télémaque après avoir éliminé les prétendants qui voulaient épouser Pénélope.",
  },
  memoCards: [
    { recto: "Qui est l'auteur de L'Odyssée ?", verso: "Homère, poète grec du 8e siècle avant J.-C." },
    { recto: "Qu'est-ce qu'une épopée ?", verso: "Un long poème qui raconte les exploits d'un héros, mêlant réel et merveilleux." },
    { recto: "Que raconte L'Odyssée ?", verso: "Le retour d'Ulysse à Ithaque après la guerre de Troie, un voyage de dix ans." },
    { recto: "Qui est Polyphème ?", verso: "Un cyclope à un œil, fils de Poséidon, vaincu par la ruse d'Ulysse." },
    { recto: "Que fait Circé aux compagnons d'Ulysse ?", verso: "Elle les transforme en porcs grâce à une potion magique." },
    { recto: "Comment Ulysse résiste-t-il au chant des sirènes ?", verso: "Il se fait attacher au mât du navire et bouche les oreilles de ses compagnons avec de la cire." },
    { recto: "Quel dieu s'acharne contre Ulysse ? Lequel le protège ?", verso: "Poséidon s'acharne contre lui ; Athéna le protège." },
    { recto: "Comment Ulysse retrouve-t-il Pénélope ?", verso: "Déguisé en mendiant, il gagne le concours de tir à l'arc et élimine les prétendants." },
  ],
  exercices: [
    {
      type: "qcm",
      ...
      choix: ["Charles Perrault", "Homère", "Jean de La Fontaine", "Victor Hugo"],
      bonneReponse: 1,
      explication: "Homère est le poète grec auquel on attribue l'Iliade et l'Odyssée.",
    },
    {
      type: "qcm",
      difficulte: "facile",
      question: "Où Ulysse essaie-t-il de rentrer ?",
      choix: ["À Troie", "À Ithaque", "À Athènes", "En Égypte"],
      bonneReponse: 1,
      explication: "Ulysse est le roi d'Ithaque et cherche à y retourner après la guerre de Troie.",
    },
    {
      type: "ouverte",
      difficulte: "facile",
      question: "Qu'est-ce qu'une épopée ?",
      reponse: "Un long poème qui raconte les exploits extraordinaires d'un héros, en mêlant des éléments réels et merveilleux.",
      explication: "L'Odyssée et l'Iliade sont deux célèbres épopées grecques.",
    },
    {
      type: "qcm",
      difficulte: "facile",
      question: "Qui est Polyphème ?",
      choix: ["Un roi grec", "Un cyclope", "Un dieu de la mer", "Le fils d'Ulysse"],
      bonneReponse: 1,
      explication: "Polyphème est un cyclope, géant à un seul œil, fils du dieu Poséidon.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Comment Ulysse échappe-t-il à Polyphème ?",
      choix: [
        "Il le tue avec son épée",
        "Il l'enivre puis lui crève son unique œil",
        "Il le supplie de le laisser partir",
        "Athéna le rend invisible",
      ],
      bonneReponse: 1,
      explication: "Ulysse enivre le cyclope avec du vin puis lui crève l'œil pendant son sommeil pour s'échapper avec ses compagnons.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Que fait Circé aux compagnons d'Ulysse, et comment Ulysse résiste-t-il à son sortilège ?",
      reponse: "Circé transforme les compagnons d'Ulysse en porcs grâce à une potion magique. Ulysse, lui, résiste grâce à une plante magique offerte par le dieu Hermès.",
      explication: "L'intervention d'un dieu (Hermès) permet ici à Ulysse d'échapper au sortilège.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Comment Ulysse fait-il pour entendre le chant des sirènes sans se jeter à la mer ?",
      reponse: "Il se fait attacher solidement au mât du navire, tandis que ses compagnons ont les oreilles bouchées avec de la cire et rament sans l'entendre.",
      explication: "C'est un exemple de la ruse et de la prudence d'Ulysse face au danger.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Pourquoi Poséidon s'acharne-t-il contre Ulysse ?",
      choix: [
        "Parce qu'Ulysse a volé son trident",
        "Parce qu'Ulysse a blessé son fils Polyphème",
        "Parce qu'Ulysse a insulté Zeus",
        "Parce qu'Ulysse a refusé de l'adorer",
      ],
      bonneReponse: 1,
      explication: "En crevant l'œil de Polyphème, fils de Poséidon, Ulysse s'attire la colère durable du dieu de la mer.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Explique en quoi Ulysse peut être considéré comme un héros différent des héros purement guerriers comme Achille.",
      reponse: "Ulysse se distingue par son intelligence et sa ruse plus que par sa seule force physique. Il résout la plupart de ses problèmes grâce à des stratagèmes (le cheval de Troie, la ruse contre Polyphème, l'attache au mât contre les sirènes) plutôt que par le combat direct.",
      explication: "On oppose souvent la ruse d'Ulysse à la force brutale d'un héros comme Achille dans l'Iliade.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Décris le double rôle des dieux dans L'Odyssée, en donnant un exemple pour chaque camp.",
      reponse: "Les dieux peuvent aider ou entraver les héros. Poséidon, dieu de la mer, entrave le voyage d'Ulysse en provoquant tempêtes et naufrages, pour se venger de son fils Polyphème. Athéna, déesse de la sagesse, aide et protège Ulysse tout au long de son parcours, en intervenant discrètement pour le guider.",
      explication: "Ce double rôle des dieux montre que, dans la mythologie grecque, le destin des hommes dépend aussi des relations entre les divinités.",
    },
    {
      type: "qcm",
      difficulte: "avance",
      question: "Comment Ulysse parvient-il à retrouver sa place à Ithaque à son retour ?",
      choix: [
        "Il se présente directement comme le roi",
        "Il se déguise en mendiant et gagne le concours de tir à l'arc",
        "Il envoie son fils Télémaque le représenter",
        "Il demande l'aide de Poséidon",
      ],
      bonneReponse: 1,
      explication: "Déguisé en mendiant, Ulysse observe la situation puis gagne l'épreuve du tir à l'arc que seul lui peut réussir, avant d'éliminer les prétendants.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Pourquoi peut-on dire que L'Odyssée mêle des éléments merveilleux (monstres, magie) à un récit de voyage ? Donne deux exemples précis.",
      reponse: "L'Odyssée raconte un voyage réaliste (un retour de guerre en bateau) mais y intègre des éléments impossibles dans la réalité, propres au merveilleux épique. Par exemple, le cyclope Polyphème, un géant à un œil unique, ou la magicienne Circé, capable de transformer des hommes en porcs, sont des éléments purement merveilleux qui enrichissent le récit du voyage d'Ulysse.",
      explication: "C'est une caractéristique essentielle de l'épopée : mêler le vraisemblable et le merveilleux pour magnifier les exploits du héros.",
    },
  ],
  revisionFinChapitre: [
    {
      type: "qcm",
      difficulte: "facile",
      question: "L'Odyssée est :",
      choix: ["un roman policier", "une épopée grecque", "une fable", "une pièce de théâtre"],
      bonneReponse: 1,
      explication: "L'Odyssée est une épopée, c'est-à-dire un long poème racontant les exploits d'un héros.",
    },
    {
      type: "ouverte",
      difficulte: "facile",
      question: "Quel monstre transforme les hommes en porcs dans L'Odyssée ?",
      reponse: "La magicienne Circé.",
      explication: "Elle utilise une potion magique pour opérer cette transformation.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Combien de temps dure le voyage de retour d'Ulysse ?",
      choix: ["Un an", "Cinq ans", "Dix ans", "Vingt ans"],
      bonneReponse: 2,
      explication: "Le voyage de retour dure dix ans, s'ajoutant aux dix années de la guerre de Troie.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Quelle épreuve permet à Ulysse de se faire reconnaître à son retour à Ithaque ?",
      reponse: "Le concours de tir à l'arc, que seul lui est capable de réussir.",
      explication: "Cela lui permet ensuite d'éliminer les prétendants qui voulaient épouser Pénélope.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Cite deux qualités qui font d'Ulysse un héros.",
      reponse: "Son intelligence et sa ruse, mais aussi son courage et sa ténacité (on peut aussi citer sa patience).",
      explication: "Ces qualités lui permettent de survivre à toutes les épreuves de son voyage.",
    },
  ],
  examens: [
    {
      titre: "Examen 1 — L'Odyssée d'Homère",
      dureeMinutes: 20,
      questions: [
        {
          type: "qcm",
          difficulte: "facile",
          question: "Homère aurait vécu :",
          choix: ["Au Moyen Âge", "Au 8e siècle avant J.-C.", "Au 19e siècle", "Il y a 100 ans"],
          bonneReponse: 1,
          explication: "Homère est un poète de la Grèce antique, du 8e siècle avant Jésus-Christ.",
        },
        {
          type: "ouverte",
          difficulte: "facile",
          question: "Qui attend Ulysse à Ithaque ?",
          reponse: "Son épouse Pénélope et son fils Télémaque.",
          explication: "Ils l'attendent pendant les vingt années de son absence.",
        },
        {
          type: "qcm",
          difficulte: "moyen",
          question: "Quel est le passage périlleux entre un tourbillon et un monstre à six têtes ?",
          choix: ["Le pays des Lotophages", "Charybde et Scylla", "L'île de Circé", "L'île des sirènes"],
          bonneReponse: 1,
          explication: "Ulysse doit choisir entre le tourbillon Charybde et le monstre Scylla, en sacrifiant quelques compagnons.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Explique comment Ulysse résiste au chant des sirènes tout en pouvant l'écouter.",
          reponse: "Il demande à être attaché solidement au mât du navire pour ne pas pouvoir se jeter à l'eau, pendant que ses compagnons, les oreilles bouchées de cire, continuent de ramer sans entendre le chant.",
          explication: "C'est un exemple typique de la ruse d'Ulysse, qui trouve une solution ingénieuse à un danger.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Pourquoi peut-on dire qu'Ulysse est un héros rusé plutôt qu'un héros seulement guerrier ?",
          reponse: "Parce qu'il résout la plupart de ses problèmes par l'intelligence et la ruse plutôt que par la force : l'idée du cheval de Troie, le piège contre Polyphème, la stratégie contre les sirènes en sont des exemples.",
          explication: "Cette ruse est la qualité qui le caractérise le plus dans la tradition grecque.",
        },
        {
          type: "ouverte",
          difficulte: "avance",
          question: "Raconte en quelques phrases l'épisode du cyclope Polyphème, en expliquant pourquoi cet épisode a des conséquences sur toute la suite du voyage d'Ulysse.",
          reponse: "Ulysse et ses compagnons sont enfermés dans la grotte du cyclope Polyphème, qui dévore plusieurs d'entre eux. Ulysse l'enivre de vin puis lui crève son unique œil pendant son sommeil pour s'échapper. Mais en révélant son nom en s'enfuyant, Ulysse s'attire la vengeance du dieu Poséidon, père de Polyphème, qui va s'acharner contre lui pendant tout le reste de son voyage, provoquant tempêtes et naufrages.",
          explication: "Cet épisode est la cause principale des malheurs d'Ulysse pendant le reste de l'épopée.",
        },
      ],
    },
    {
      titre: "Examen 2 — L'Odyssée d'Homère",
      dureeMinutes: 20,
      questions: [
        {
          type: "qcm",
          difficulte: "facile",
          question: "L'Odyssée est composée de :",
          choix: ["10 chants", "24 chants", "100 chants", "3 chants"],
          bonneReponse: 1,
          explication: "L'Odyssée compte vingt-quatre chants, comme l'Iliade.",
        },
        {
          type: "ouverte",
          difficulte: "facile",
          question: "Quelle déesse protège Ulysse tout au long de son voyage ?",
          reponse: "Athéna, déesse de la sagesse.",
          explication: "Elle intervient à plusieurs reprises pour l'aider ou le conseiller.",
        },
        {
          type: "qcm",
          difficulte: "moyen",
          question: "Qui offre à Ulysse la plante magique qui le protège de Circé ?",
          choix: ["Zeus", "Hermès", "Poséidon", "Athéna"],
          bonneReponse: 1,
          explication: "Hermès, messager des dieux, lui offre cette plante pour résister au sortilège de Circé.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Explique pourquoi Ulysse se déguise en mendiant à son retour à Ithaque.",
          reponse: "Il veut observer la situation sans être reconnu, car sa maison est envahie par des prétendants qui veulent épouser sa femme Pénélope en le croyant mort. Ce déguisement lui permet de préparer sa vengeance.",
          explication: "C'est une nouvelle preuve de la ruse et de la prudence d'Ulysse.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Qu'est-ce qui distingue une épopée d'un simple récit d'aventure ? Appuie-toi sur L'Odyssée.",
          reponse: "L'épopée est un long poème (ici en vingt-quatre chants) qui met en scène un héros exceptionnel dont les exploits mêlent des éléments réels et merveilleux, avec l'intervention constante des dieux, ce qui donne au récit une portée plus grande qu'une simple aventure individuelle.",
          explication: "La présence des dieux et la dimension merveilleuse distinguent l'épopée d'un simple récit d'aventures.",
        },
        {
          type: "ouverte",
          difficulte: "avance",
          question: "En t'appuyant sur au moins deux épisodes du voyage d'Ulysse, explique comment ce dernier illustre à la fois le courage et la ruse d'un héros.",
          reponse: "Face à Polyphème, Ulysse fait preuve de courage en affrontant un géant redoutable, et de ruse en l'enivrant pour lui crever l'œil et s'échapper. Face aux sirènes, il fait à nouveau preuve de courage en acceptant d'entendre leur chant mortel, et de ruse en se faisant attacher au mât pour résister à la tentation. Ces deux qualités, mêlées, définissent le portrait d'Ulysse comme héros épique.",
          explication: "On valorise la capacité à combiner plusieurs épisodes pour construire une analyse du personnage d'Ulysse.",
        },
      ],
    },
  ],
  syntheseRevisions: [
    "L'Odyssée est une épopée grecque attribuée à Homère, composée de 24 chants.",
    "Elle raconte le retour d'Ulysse à Ithaque après la guerre de Troie, un voyage de dix ans.",
    "L'épopée est un long poème qui mêle exploits héroïques, éléments merveilleux et intervention des dieux.",
    "Ulysse affronte de nombreux monstres : le cyclope Polyphème, la magicienne Circé, les sirènes, Charybde et Scylla.",
    "Poséidon s'acharne contre Ulysse (vengeance pour son fils Polyphème) ; Athéna le protège.",
    "Ulysse est un héros caractérisé par sa ruse, son intelligence et son courage, plus que par sa seule force.",
  ],
},
{
  slug: "phrase-ponctuation",
  titre: "La phrase et la ponctuation",
  matiere: "francais",
  niveau: "6eme",
  description:
    "Comprendre ce qu'est une phrase, distinguer phrase simple et phrase complexe, reconnaître les quatre types de phrases et maîtriser les signes de ponctuation essentiels.",
  objectifs: [
    "Définir ce qu'est une phrase et reconnaître ses limites (majuscule, point)",
    "Distinguer phrase verbale et phrase non verbale",
    "Distinguer phrase simple (un verbe conjugué) et phrase complexe (plusieurs verbes conjugués)",
    "Connaître les quatre types de phrases : déclarative, interrogative, injonctive, exclamative",
    "Utiliser correctement les signes de ponctuation courants",
  ],
  slides: [
    {
      titre: "Qu'est-ce qu'une phrase ?",
      illustration: "✏️",
      visuel: "Majuscule ... point.",
      contenu: [
        "Une phrase commence par une majuscule et se termine par un point",
        "Elle exprime une idée complète et a un sens tout seul",
        "Une phrase peut être longue ou très courte",
        "« Il pleut. » est une phrase complète à elle seule",
      ],
      voixOff:
        "Une phrase est un groupe de mots qui commence par une majuscule et se termine par un point, un point d'interrogation ou un point d'exclamation. Elle exprime une idée complète et a un sens même isolée du reste du texte. Une phrase peut être très courte, comme il pleut, ou beaucoup plus longue et détaillée.",
    },
    {
      titre: "Phrase verbale et phrase non verbale",
      illustration: "🔤",
      visuel: "Il court. / Silence !",
      contenu: [
        "La phrase verbale contient un verbe conjugué : « Il court vite. »",
        "La phrase non verbale ne contient pas de verbe conjugué : « Silence ! »",
        "La phrase non verbale est souvent courte et expressive",
        "On la trouve dans les titres, les panneaux, les exclamations",
      ],
      voixOff:
        "On distingue deux grandes sortes de phrases. La phrase verbale contient un verbe conjugué, comme dans il court vite. La phrase non verbale, elle, ne contient pas de verbe conjugué, comme dans silence, ou attention au chien. Ce type de phrase, souvent court et expressif, se retrouve fréquemment dans les titres de journaux, les panneaux ou les exclamations spontanées.",
    },
    {
      titre: "Phrase simple : un seul verbe conjugué",
      illustration: "1️⃣",
      visuel: "Le chat dort.",
      contenu: [
        "La phrase simple contient un seul verbe conjugué",
        "Elle correspond à une seule proposition",
        "Exemple : « Le chat dort sur le canapé. »",
        "Elle peut être courte ou enrichie de compléments",
      ],
      voixOff:
        "La phrase simple contient un seul verbe conjugué : elle ne forme donc qu'une seule proposition. Par exemple, le chat dort sur le canapé est une phrase simple, même si elle contient plusieurs mots, car elle ne possède qu'un seul verbe conjugué : dort. On peut l'enrichir de nombreux compléments sans qu'elle devienne pour autant une phrase complexe.",
    },
    {
      titre: "Phrase complexe : plusieurs verbes conjugués",
      illustration: "🔗",
      visuel: "Le chat dort et le chien joue.",
      contenu: [
        "La phrase complexe contient plusieurs verbes conjugués",
        "Elle comprend donc plusieurs propositions",
        "Exemple : « Le chat dort pendant que le chien joue. »",
        "Les propositions peuvent être reliées par un mot ou simplement juxtaposées",
      ],
      voixOff:
        "La phrase complexe, elle, contient plusieurs verbes conjugués, donc plusieurs propositions. Par exemple, le chat dort pendant que le chien joue contient deux verbes conjugués : dort et joue, donc deux propositions. Ces propositions peuvent être reliées par un mot comme pendant que, ou simplement juxtaposées, séparées par une virgule.",
    },
    {
      titre: "La phrase déclarative et la phrase interrogative",
      illustration: "❓",
      visuel: "Il fait beau. / Fait-il beau ?",
      contenu: [
        "La phrase déclarative affirme ou nie quelque chose : « Il fait beau. »",
        "Elle se termine par un point",
        "La phrase interrogative pose une question : « Fait-il beau ? »",
        "Elle se termine toujours par un point d'interrogation",
      ],
      voixOff:
        "Il existe quatre types de phrases selon ce qu'elles expriment. La phrase déclarative affirme ou nie un fait, comme dans il fait beau, et se termine par un simple point. La phrase interrogative pose une question, comme dans fait-il beau, et se termine toujours par un point d'interrogation.",
    },
    {
      titre: "La phrase injonctive et la phrase exclamative",
      illustration: "❗",
      visuel: "Ferme la porte. / Quelle belle journée !",
      contenu: [
        "La phrase injonctive donne un ordre ou un conseil : « Ferme la porte. »",
        "Son verbe est souvent à l'impératif",
        "La phrase exclamative exprime une émotion forte : « Quelle belle journée ! »",
        "Elle se termine toujours par un point d'exclamation",
      ],
      voixOff:
        "La phrase injonctive donne un ordre, un conseil ou une consigne, comme dans ferme la porte : son verbe est souvent conjugué à l'impératif. La phrase exclamative, elle, exprime une émotion forte, comme la surprise ou la joie, dans une phrase comme quelle belle journée ! Elle se termine toujours par un point d'exclamation.",
    },
    {
      titre: "Les signes de ponctuation forte",
      illustration: "📍",
      visuel: ". ? ! ...",
      contenu: [
        "Le point (.) termine une phrase déclarative ou injonctive",
        "Le point d'interrogation (?) termine une phrase interrogative",
        "Le point d'exclamation (!) termine une phrase exclamative",
        "Les points de suspension (...) indiquent une phrase inachevée ou un silence",
      ],
      voixOff:
        "Certains signes de ponctuation marquent la fin d'une phrase : ce sont les ponctuations fortes. Le point termine une phrase déclarative ou injonctive. Le point d'interrogation termine une phrase interrogative. Le point d'exclamation termine une phrase exclamative. Enfin, les points de suspension indiquent une phrase inachevée, une hésitation ou un silence.",
    },
    {
      titre: "Les signes de ponctuation faible",
      illustration: "✂️",
      visuel: ", ; :",
      contenu: [
        "La virgule (,) sépare des mots ou des groupes dans une phrase",
        "Le point-virgule (;) sépare deux propositions proches par le sens",
        "Les deux points (:) annoncent une explication, une liste ou une citation",
        "Ces signes ne terminent jamais une phrase",
      ],
      voixOff:
        "D'autres signes de ponctuation, dits faibles, ne terminent jamais une phrase mais organisent son intérieur. La virgule sépare des mots ou des groupes de mots dans une énumération, par exemple. Le point-virgule sépare deux propositions proches par le sens. Les deux points annoncent une explication, une liste ou une citation. On les retrouve à l'intérieur des phrases, jamais à leur fin.",
    },
    {
      titre: "Ce qu'il faut retenir",
      illustration: "🏆",
      ...
      contenu: [
        ...
        "Phrase simple = un verbe conjugué ; phrase complexe = plusieurs",
        "4 types de phrases : déclarative, interrogative, injonctive, exclamative",
        "Ponctuation forte (. ? ! ...) termine la phrase ; faible (, ; :) l'organise",
      ],
      voixOff:
        "Pour conclure ce chapitre, retiens qu'une phrase commence toujours par une majuscule et se termine par un point. Une phrase simple contient un seul verbe conjugué, une phrase complexe en contient plusieurs. Il existe quatre types de phrases : déclarative, interrogative, injonctive et exclamative. Enfin, la ponctuation forte termine la phrase, tandis que la ponctuation faible l'organise à l'intérieur. Tu maîtrises maintenant les bases de la phrase et de la ponctuation !",
    },
  ],
  fiche: {
    intro:
      "La phrase est l'unité de base d'un texte : elle commence par une majuscule et se termine par un point. Elle peut être simple ou complexe, et se classe en quatre types selon ce qu'elle exprime.",
    sections: [
      {
        titre: "Définir la phrase",
        points: [
          "Une phrase commence par une majuscule et se termine par un point (. ? ! ...)",
          "Elle exprime une idée complète et a un sens à elle seule",
          "Phrase verbale : contient un verbe conjugué (Il court.)",
          "Phrase non verbale : ne contient pas de verbe conjugué (Silence !)",
        ],
      },
      {
        titre: "Phrase simple ou phrase complexe",
        points: [
          "Phrase simple : un seul verbe conjugué, donc une seule proposition",
          "Phrase complexe : plusieurs verbes conjugués, donc plusieurs propositions",
          "Les propositions peuvent être juxtaposées (virgule) ou reliées par un mot",
          "Compter les verbes conjugués permet de distinguer les deux",
        ],
      },
      {
        titre: "Les quatre types de phrases",
        points: [
          "Déclarative : affirme ou nie un fait, se termine par un point",
          "Interrogative : pose une question, se termine par un point d'interrogation",
          "Injonctive : donne un ordre ou un conseil, verbe souvent à l'impératif",
          "Exclamative : exprime une émotion forte, se termine par un point d'exclamation",
        ],
      },
      {
        titre: "Les signes de ponctuation",
        points: [
          "Ponctuation forte (fin de phrase) : point, point d'interrogation, point d'exclamation, points de suspension",
          "Ponctuation faible (à l'intérieur de la phrase) : virgule, point-virgule, deux points",
          "La virgule sépare des mots ou des groupes ; les deux points annoncent une explication",
          "Bien ponctuer une phrase change parfois complètement son sens",
        ],
      },
    ],
    audio:
      "Fiche de révision : la phrase et la ponctuation. Une phrase commence par une majuscule et se termine par un point, un point d'interrogation ou un point d'exclamation ; elle exprime une idée complète. On distingue la phrase verbale, qui contient un verbe conjugué, et la phrase non verbale, qui n'en contient pas. La phrase simple contient un seul verbe conjugué, donc une seule proposition ; la phrase complexe en contient plusieurs. Il existe quatre types de phrases : la phrase déclarative, qui affirme ou nie un fait ; la phrase interrogative, qui pose une question ; la phrase injonctive, qui donne un ordre ou un conseil ; et la phrase exclamative, qui exprime une émotion forte. Enfin, la ponctuation forte, comme le point, le point d'interrogation et le point d'exclamation, termine la phrase, tandis que la ponctuation faible, comme la virgule, le point-virgule et les deux points, organise l'intérieur de la phrase.",
  },
  memoCards: [
    { recto: "Comment commence et se termine une phrase ?", verso: "Par une majuscule, et par un point, un point d'interrogation ou un point d'exclamation." },
    { recto: "Phrase verbale et phrase non verbale ?", verso: "Verbale : contient un verbe conjugué (Il court.). Non verbale : n'en contient pas (Silence !)." },
    { recto: "Comment reconnaître une phrase simple ?", verso: "Elle contient un seul verbe conjugué (une seule proposition)." },
    { recto: "Comment reconnaître une phrase complexe ?", verso: "Elle contient plusieurs verbes conjugués (plusieurs propositions)." },
    { recto: "Les quatre types de phrases ?", verso: "Déclarative, interrogative, injonctive, exclamative." },
    { recto: "Quel signe termine une phrase interrogative ?", verso: "Le point d'interrogation ( ? )." },
    { recto: "Cite trois signes de ponctuation faible.", verso: "La virgule, le point-virgule, les deux points." },
    { recto: "Que donne une phrase injonctive ?", verso: "Un ordre ou un conseil, souvent avec un verbe à l'impératif." },
  ],
  exercices: [
    {
      type: "qcm",
      difficulte: "facile",
      question: "Comment commence toujours une phrase ?",
      choix: ["Par un point", "Par une majuscule", "Par une virgule", "Par un verbe"],
      bonneReponse: 1,
      explication: "Toute phrase commence par une lettre majuscule.",
    },
    {
      type: "qcm",
      difficulte: "facile",
      question: "Quel signe termine une phrase exclamative ?",
      choix: ["Le point", "Le point d'interrogation", "Le point d'exclamation", "La virgule"],
      bonneReponse: 2,
      explication: "La phrase exclamative exprime une émotion forte et se termine par un point d'exclamation.",
    },
    {
      type: "ouverte",
      difficulte: "facile",
      question: "Donne un exemple de phrase non verbale.",
      reponse: "Par exemple : « Silence ! » ou « Attention au chien ! »",
      explication: "Une phrase non verbale ne contient aucun verbe conjugué.",
    },
    {
      type: "qcm",
      difficulte: "facile",
      question: "« Range ta chambre. » est une phrase :",
      choix: ["déclarative", "interrogative", "injonctive", "exclamative"],
      bonneReponse: 2,
      explication: "Cette phrase donne un ordre : c'est une phrase injonctive, avec un verbe à l'impératif.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "« Le chien aboie et le chat se cache. » est une phrase :",
      choix: ["simple", "complexe", "non verbale", "interrogative"],
      bonneReponse: 1,
      explication: "Elle contient deux verbes conjugués (aboie, se cache) : c'est une phrase complexe.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Transforme la phrase déclarative « Tu viens à la fête. » en phrase interrogative.",
      reponse: "« Viens-tu à la fête ? » (ou : « Est-ce que tu viens à la fête ? »)",
      explication: "On peut inverser le sujet et le verbe, ou ajouter « est-ce que », et terminer par un point d'interrogation.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Combien de propositions contient la phrase suivante : « Quand la pluie s'arrête, les enfants sortent jouer. » ? Justifie.",
      reponse: "Deux propositions, car il y a deux verbes conjugués : « s'arrête » et « sortent ». C'est donc une phrase complexe.",
      explication: "On compte le nombre de verbes conjugués pour déterminer le nombre de propositions.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Quel signe de ponctuation annonce souvent une liste ou une explication ?",
      choix: ["La virgule", "Le point-virgule", "Les deux points", "Le point d'exclamation"],
      bonneReponse: 2,
      explication: "Les deux points annoncent une explication, une énumération ou une citation.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Explique la différence de sens entre « Allons manger, les enfants ! » et « Allons manger les enfants ! », et précise le rôle de la virgule.",
      reponse: "Dans la première phrase, la virgule sépare une apostrophe : on s'adresse aux enfants pour les inviter à manger. Dans la seconde, sans virgule, la phrase peut se comprendre comme un ordre de manger les enfants eux-mêmes ! La virgule change donc complètement le sens de la phrase.",
      explication: "Cet exemple célèbre montre l'importance de la ponctuation pour éviter les ambiguïtés de sens.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Récris ce texte en ajoutant la ponctuation manquante : « comme il fait beau aujourd'hui allons nous promener dans le parc »",
      reponse: "« Comme il fait beau aujourd'hui ! Allons nous promener dans le parc. »",
      explication: "On ajoute une majuscule en début de chaque phrase, un point d'exclamation après la première phrase (émotion) et un point après la seconde (ordre/proposition).",
    },
    {
      type: "qcm",
      difficulte: "avance",
      question: "Dans la phrase « Léa se lève, prend son sac et part au collège. », combien y a-t-il de verbes conjugués ?",
      choix: ["Un", "Deux", "Trois", "Quatre"],
      bonneReponse: 2,
      explication: "Trois verbes conjugués : se lève, prend, part. C'est donc une phrase complexe à trois propositions juxtaposées ou coordonnées.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Rédige un court texte de quatre phrases utilisant chacun des quatre types de phrases (déclarative, interrogative, injonctive, exclamative).",
      reponse: "Exemple de réponse : « Il fait très froid ce matin. (déclarative) Vas-tu mettre ton manteau ? (interrogative) Prends aussi une écharpe. (injonctive) Quel hiver glacial ! (exclamative) »",
      explication: "On vérifie que chaque phrase correspond bien à son type et se termine par la ponctuation adaptée.",
    },
  ],
  revisionFinChapitre: [
    {
      ...
      choix: ["un point", "un point d'interrogation", "une virgule", "des points de suspension"],
      bonneReponse: 1,
      explication: "Le point d'interrogation marque la fin d'une question.",
    },
    {
      type: "ouverte",
      difficulte: "facile",
      question: "Qu'est-ce qu'une phrase simple ?",
      reponse: "Une phrase qui contient un seul verbe conjugué (une seule proposition).",
      explication: "On l'oppose à la phrase complexe, qui en contient plusieurs.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "« Quelle bonne surprise ! » est une phrase :",
      choix: ["déclarative", "interrogative", "injonctive", "exclamative"],
      bonneReponse: 3,
      explication: "Elle exprime une émotion forte et se termine par un point d'exclamation.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Cite deux signes de ponctuation faible et explique leur rôle.",
      reponse: "La virgule sépare des mots ou des groupes de mots dans une phrase ; les deux points annoncent une explication, une liste ou une citation.",
      explication: "Ces signes n'indiquent jamais la fin d'une phrase, contrairement au point ou au point d'exclamation.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Comment fait-on pour compter le nombre de propositions dans une phrase ?",
      reponse: "On compte le nombre de verbes conjugués : chaque verbe conjugué correspond à une proposition.",
      explication: "Une phrase avec un seul verbe conjugué est simple ; avec plusieurs, elle est complexe.",
    },
  ],
  examens: [
    {
      titre: "Examen 1 — La phrase et la ponctuation",
      dureeMinutes: 20,
      questions: [
        {
          type: "qcm",
          difficulte: "facile",
          question: "« Le soleil brille. » est une phrase :",
          choix: ["interrogative", "injonctive", "déclarative", "exclamative"],
          bonneReponse: 2,
          explication: "Elle affirme un fait sans exprimer d'émotion particulière : c'est une phrase déclarative.",
        },
        {
          type: "ouverte",
          difficulte: "facile",
          question: "Qu'est-ce qu'une phrase verbale ? Donne un exemple.",
          reponse: "C'est une phrase qui contient un verbe conjugué. Exemple : « Le chien court dans le jardin. »",
          explication: "On l'oppose à la phrase non verbale, qui ne contient pas de verbe conjugué.",
        },
        {
          type: "qcm",
          difficulte: "moyen",
          question: "Combien de propositions contient la phrase « Il pleut, mais nous sortons quand même. » ?",
          choix: ["Une", "Deux", "Trois", "Aucune"],
          bonneReponse: 1,
          explication: "Deux verbes conjugués (pleut, sortons) : c'est une phrase complexe à deux propositions.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Transforme « Vous êtes en retard. » en phrase exclamative.",
          reponse: "« Comme vous êtes en retard ! » (ou : « Quel retard ! »)",
          explication: "On peut utiliser « comme » ou « quel(le) » pour transformer une phrase en phrase exclamative, terminée par un point d'exclamation.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Explique la différence entre la ponctuation forte et la ponctuation faible, avec un exemple de chaque.",
          reponse: "La ponctuation forte marque la fin d'une phrase, comme le point ou le point d'exclamation. La ponctuation faible organise l'intérieur d'une phrase sans la terminer, comme la virgule ou les deux points.",
          explication: "Cette distinction est essentielle pour bien construire et ponctuer un texte.",
        },
        {
          type: "ouverte",
          difficulte: "avance",
          question: "Ponctue correctement ce texte en ajoutant majuscules et signes de ponctuation : « le professeur demanda aux élèves avez-vous fini vos exercices oui répondirent-ils en chœur »",
          reponse: "« Le professeur demanda aux élèves : \"Avez-vous fini vos exercices ?\" \"Oui !\" répondirent-ils en chœur. »",
          explication: "On ponctue le discours rapporté avec des deux points, des guillemets, un point d'interrogation pour la question et un point d'exclamation pour la réponse enthousiaste.",
        },
      ],
    },
    {
      titre: "Examen 2 — La phrase et la ponctuation",
      dureeMinutes: 20,
      questions: [
        {
          type: "qcm",
          difficulte: "facile",
          question: "« Ferme la fenêtre, s'il te plaît. » est une phrase :",
          choix: ["déclarative", "interrogative", "injonctive", "exclamative"],
          bonneReponse: 2,
          explication: "Cette phrase donne un ordre poli, avec un verbe à l'impératif : c'est une phrase injonctive.",
        },
        {
          type: "ouverte",
          difficulte: "facile",
          question: "Qu'est-ce qu'une phrase complexe ?",
          reponse: "Une phrase qui contient plusieurs verbes conjugués, donc plusieurs propositions.",
          explication: "On l'oppose à la phrase simple, qui n'en contient qu'un seul.",
        },
        {
          type: "qcm",
          difficulte: "moyen",
          question: "Quel signe de ponctuation sépare deux propositions proches par le sens, sans les relier par un mot de liaison ?",
          choix: ["La virgule", "Le point-virgule", "Le point d'exclamation", "Les points de suspension"],
          bonneReponse: 1,
          explication: "Le point-virgule relie deux propositions dont le sens est proche, sans utiliser de mot de liaison.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Transforme la phrase « Vous mangez vos légumes. » en phrase injonctive.",
          reponse: "« Mangez vos légumes ! » (ou « Mangez vos légumes. »)",
          explication: "On utilise le mode impératif pour transformer une phrase déclarative en phrase injonctive.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Donne un exemple de phrase simple et un exemple de phrase complexe, en soulignant les verbes conjugués.",
          reponse: "Phrase simple : « Le chat dort. » (un seul verbe conjugué : dort). Phrase complexe : « Le chat dort pendant que le chien joue. » (deux verbes conjugués : dort, joue).",
          explication: "Le nombre de verbes conjugués détermine si une phrase est simple ou complexe.",
        },
        {
          type: "ouverte",
          difficulte: "avance",
          question: "Explique pourquoi une bonne ponctuation est indispensable à la compréhension d'un texte, en t'appuyant sur un exemple précis.",
          reponse: "La ponctuation organise le sens d'une phrase et évite les ambiguïtés. Par exemple, « Allons manger, les enfants ! » (invitation) et « Allons manger les enfants ! » (menace absurde) n'ont pas du tout le même sens selon la présence ou l'absence d'une simple virgule. Une mauvaise ponctuation peut donc rendre un texte incompréhensible ou changer complètement son sens.",
          explication: "Cet exemple classique illustre bien le rôle essentiel de la ponctuation dans la construction du sens.",
        },
      ],
    },
  ],
  syntheseRevisions: [
    "Une phrase commence par une majuscule et se termine par un point, un point d'interrogation ou un point d'exclamation.",
    "La phrase verbale contient un verbe conjugué ; la phrase non verbale n'en contient pas.",
    "La phrase simple contient un seul verbe conjugué ; la phrase complexe en contient plusieurs.",
    "Les quatre types de phrases : déclarative, interrogative, injonctive, exclamative.",
    "Ponctuation forte (termine la phrase) : point, point d'interrogation, point d'exclamation, points de suspension.",
    "Ponctuation faible (organise l'intérieur) : virgule, point-virgule, deux points.",
  ],
},
{
  ...
  niveau: "6eme",
  description:
    "Maîtriser la conjugaison du présent de l'indicatif pour les verbes des trois groupes, ainsi que les verbes irréguliers les plus fréquents, et comprendre les différentes valeurs de ce temps.",
  objectifs: [
    "Connaître les terminaisons du présent pour les trois groupes de verbes",
    "Conjuguer correctement les verbes irréguliers les plus fréquents (être, avoir, aller, dire, faire...)",
    "Identifier les principales valeurs du présent de l'indicatif",
    "Éviter les erreurs fréquentes de conjugaison au présent",
    "Utiliser le présent correctement à l'écrit",
  ],
  slides: [
    {
      titre: "Le présent : un temps très utilisé",
      illustration: "⏰",
      visuel: "je parle, tu finis, il vend",
      contenu: [
        "Le présent de l'indicatif exprime une action qui se déroule maintenant",
        "C'est le temps le plus utilisé à l'oral comme à l'écrit",
        "Chaque verbe se conjugue selon son groupe",
        "Il existe 3 groupes de verbes en français",
      ],
      voixOff:
        "Le présent de l'indicatif est le temps que l'on utilise pour exprimer une action qui se déroule au moment où l'on parle. C'est aussi le temps le plus fréquent, aussi bien à l'oral qu'à l'écrit. Pour bien le conjuguer, il faut d'abord savoir à quel groupe appartient le verbe, car chaque groupe a ses propres terminaisons.",
    },
    {
      titre: "Les verbes du premier groupe",
      illustration: "1️⃣",
      visuel: "parler → je parle, nous parlons",
      contenu: [
        "Le 1er groupe regroupe les verbes en -ER (sauf aller)",
        "Terminaisons : -e, -es, -e, -ons, -ez, -ent",
        "Exemple : je parle, tu parles, il parle, nous parlons, vous parlez, ils parlent",
        "C'est le groupe le plus régulier et le plus nombreux",
      ],
      voixOff:
        "Le premier groupe rassemble tous les verbes qui se terminent par er à l'infinitif, à l'exception du verbe aller. Au présent, leurs terminaisons sont toujours les mêmes : e, es, e, ons, ez, ent. Prenons l'exemple de parler : je parle, tu parles, il parle, nous parlons, vous parlez, ils parlent. C'est le groupe le plus simple et le plus nombreux de la langue française.",
    },
    {
      titre: "Les verbes du deuxième groupe",
      illustration: "2️⃣",
      visuel: "finir → je finis, nous finissons",
      contenu: [
        "Le 2e groupe regroupe des verbes en -IR dont le participe présent est en -issant",
        "Terminaisons : -is, -is, -it, -issons, -issez, -issent",
        "Exemple : je finis, tu finis, il finit, nous finissons, vous finissez, ils finissent",
        "Astuce : « finissant » (en -issant) confirme le 2e groupe",
      ],
      voixOff:
        "Le deuxième groupe regroupe des verbes en ir, comme finir, dont le participe présent se termine en issant : finissant. Leurs terminaisons au présent sont is, is, it, issons, issez, issent. Par exemple : je finis, tu finis, il finit, nous finissons, vous finissez, ils finissent. Cette forme en issons, issez, issent aux personnes du pluriel est la marque du deuxième groupe.",
    },
    {
      titre: "Les verbes du troisième groupe",
      illustration: "3️⃣",
      visuel: "prendre, venir, dire, faire...",
      contenu: [
        "Le 3e groupe regroupe tous les autres verbes : aller + verbes en -IR, -RE, -OIR",
        "Leurs terminaisons sont plus irrégulières",
        "Exemple : je prends, tu prends, il prend, nous prenons, vous prenez, ils prennent",
        "Ce groupe demande d'apprendre chaque verbe par cœur",
      ],
      voixOff:
        "Le troisième groupe rassemble tous les verbes qui n'appartiennent ni au premier ni au deuxième groupe : le verbe aller, ainsi que des verbes en ir, en re et en oir. Leur conjugaison est plus irrégulière, il faut donc bien les apprendre. Par exemple, prendre donne je prends, tu prends, il prend, nous prenons, vous prenez, ils prennent : on remarque le changement entre le singulier et le pluriel.",
    },
    {
      titre: "Les verbes irréguliers essentiels : être et avoir",
      illustration: "⭐",
      visuel: "je suis / j'ai",
      contenu: [
        "Être : je suis, tu es, il est, nous sommes, vous êtes, ils sont",
        "Avoir : j'ai, tu as, il a, nous avons, vous avez, ils ont",
        "Ce sont les deux verbes les plus utilisés et les plus irréguliers",
        "Ils servent aussi d'auxiliaires pour former d'autres temps",
      ],
      voixOff:
        "Être et avoir sont les deux verbes les plus utilisés de la langue française, et aussi les plus irréguliers. Être se conjugue : je suis, tu es, il est, nous sommes, vous êtes, ils sont. Avoir se conjugue : j'ai, tu as, il a, nous avons, vous avez, ils ont. Il faut les connaître parfaitement, car ils servent aussi d'auxiliaires pour construire d'autres temps, comme le passé composé.",
    },
    {
      titre: "D'autres verbes irréguliers fréquents",
      illustration: "🔑",
      visuel: "aller, dire, faire, venir",
      contenu: [
        "Aller : je vais, tu vas, il va, nous allons, vous allez, ils vont",
        "Dire : je dis, tu dis, il dit, nous disons, vous dites, ils disent",
        "Faire : je fais, tu fais, il fait, nous faisons, vous faites, ils font",
        "Attention à « vous dites » et « vous faites » (pas de -ez)",
      ],
      voixOff:
        "D'autres verbes irréguliers reviennent très souvent. Aller se conjugue : je vais, tu vas, il va, nous allons, vous allez, ils vont. Dire se conjugue : je dis, tu dis, il dit, nous disons, vous dites, ils disent. Faire se conjugue : je fais, tu fais, il fait, nous faisons, vous faites, ils font. Attention à une erreur fréquente : on dit vous dites et vous faites, et non vous disez ou vous faisez.",
    },
    {
      titre: "Les valeurs du présent",
      illustration: "🎯",
      visuel: "Présent d'énonciation, de vérité générale, de narration",
      contenu: [
        "Présent d'énonciation : l'action se passe au moment où l'on parle",
        "Présent de vérité générale : une règle toujours vraie (« L'eau bout à 100°C »)",
        "Présent d'habitude : une action répétée (« Je me lève à 7h chaque jour »)",
        "Présent de narration : rend un récit passé plus vivant",
      ],
      voixOff:
        "Le présent ne sert pas seulement à parler de maintenant : il a plusieurs valeurs. Le présent d'énonciation exprime une action qui se déroule au moment où l'on parle. Le présent de vérité générale exprime une règle toujours vraie, comme l'eau bout à cent degrés. Le présent d'habitude exprime une action répétée. Enfin, le présent de narration rend plus vivant un récit qui se déroule pourtant dans le passé.",
    },
    {
      titre: "Attention aux pièges fréquents",
      illustration: "⚠️",
      visuel: "je mange / nous mangeons",
      contenu: [
        "Verbes en -GER : on garde le « e » devant -ons (nous mangeons)",
        "Verbes en -CER : le « c » devient « ç » devant -ons (nous plaçons)",
        "Pas de « s » à la 1ère personne des verbes en -ir, -oir, -re à l'impératif (attention au présent)",
        "« Il faut » et non « il faux » ; « je peux » et non « je peu »",
      ],
      voixOff:
        "Certains verbes présentent des particularités à connaître. Les verbes en ger gardent un e devant la terminaison ons, comme dans nous mangeons, pour garder le son doux du g. Les verbes en cer transforment le c en ç devant ons, comme dans nous plaçons, pour garder le son doux du c. Enfin, attention à l'orthographe de certaines formes fréquentes : il faut, je peux, et non il faux ou je peu.",
    },
    {
      titre: "Ce qu'il faut retenir",
      illustration: "🏆",
      visuel: "📌",
      contenu: [
        "Le présent exprime une action en train de se dérouler, mais pas seulement",
        "3 groupes de verbes, chacun avec ses terminaisons",
        "Être, avoir, aller, dire, faire : à connaître parfaitement",
        "Le présent a plusieurs valeurs : énonciation, vérité générale, habitude, narration",
      ],
      voixOff:
        "Pour conclure ce chapitre, retiens que le présent de l'indicatif exprime en général une action en train de se dérouler, mais qu'il a en réalité plusieurs valeurs. Il existe trois groupes de verbes, chacun avec ses propres terminaisons, et des verbes irréguliers essentiels comme être, avoir, aller, dire et faire, qu'il faut connaître parfaitement. Entraîne-toi régulièrement pour ne plus faire d'erreur !",
    },
  ],
  fiche: {
    intro:
      "Le présent de l'indicatif est le temps le plus utilisé de la langue française. Sa conjugaison dépend du groupe du verbe, et certains verbes très fréquents sont irréguliers.",
    sections: [
      {
        titre: "Les trois groupes de verbes",
        points: [
          "1er groupe (verbes en -ER sauf aller) : -e, -es, -e, -ons, -ez, -ent",
          "2e groupe (verbes en -IR type finir, en -issant) : -is, -is, -it, -issons, -issez, -issent",
          "3e groupe (aller + autres verbes en -ir, -re, -oir) : terminaisons irrégulières",
          "Exemple 3e groupe : je prends, tu prends, il prend, nous prenons, vous prenez, ils prennent",
        ],
      },
      {
        titre: "Les verbes irréguliers essentiels",
        points: [
          "Être : je suis, tu es, il est, nous sommes, vous êtes, ils sont",
          "Avoir : j'ai, tu as, il a, nous avons, vous avez, ils ont",
          "Aller : je vais, tu vas, il va, nous allons, vous allez, ils vont",
          "Dire / Faire : vous dites / vous faites (attention, pas de -ez)",
        ],
      },
      {
        titre: "Les valeurs du présent",
        points: [
          "Présent d'énonciation : l'action a lieu au moment où l'on parle",
          "Présent de vérité générale : une règle toujours vraie",
          "Présent d'habitude : une action qui se répète régulièrement",
          "Présent de narration : rend vivant un récit situé dans le passé",
        ],
      },
      {
        titre: "Pièges d'orthographe à éviter",
        points: [
          "Verbes en -ger : on garde le « e » devant -ons (nous mangeons)",
          "Verbes en -cer : le « c » devient « ç » devant -ons (nous plaçons)",
          "« Il faut », « je peux », « vous dites », « vous faites »",
          "Ne pas confondre 3e personne du singulier et du pluriel : il finit / ils finissent",
        ],
      },
    ],
    audio:
      "Fiche de révision : le présent de l'indicatif. Le présent est le temps le plus utilisé de la langue française. Les verbes du premier groupe, en er, se conjuguent avec les terminaisons e, es, e, ons, ez, ent. Les verbes du deuxième groupe, comme finir, se conjuguent avec is, is, it, issons, issez, issent. Les verbes du troisième groupe ont des terminaisons plus irrégulières et doivent être appris par cœur. Les verbes être, avoir, aller, dire et faire sont irréguliers et très fréquents : il faut les connaître parfaitement. Le présent a plusieurs valeurs : il exprime une action en train de se dérouler, une vérité générale, une habitude, ou rend plus vivant un récit passé grâce au présent de narration. Attention aussi à l'orthographe des verbes en ger et en cer devant la terminaison ons.",
  },
  memoCards: [
    { recto: "Terminaisons du présent, 1er groupe ?", verso: "-e, -es, -e, -ons, -ez, -ent (je parle, nous parlons...)." },
    { recto: "Terminaisons du présent, 2e groupe ?", verso: "-is, -is, -it, -issons, -issez, -issent (je finis, nous finissons...)." },
    { recto: "Conjugue « être » au présent.", verso: "Je suis, tu es, il est, nous sommes, vous êtes, ils sont." },
    { recto: "Conjugue « avoir » au présent.", verso: "J'ai, tu as, il a, nous avons, vous avez, ils ont." },
    { recto: "Conjugue « aller » au présent.", verso: "Je vais, tu vas, il va, nous allons, vous allez, ils vont." },
    { recto: "Piège des verbes en -ger ?", verso: "On garde le « e » devant -ons : nous mangeons, nous voyageons." },
    { recto: "Piège des verbes en -cer ?", verso: "Le « c » devient « ç » devant -ons : nous plaçons, nous commençons." },
    { recto: "Cite deux valeurs du présent.", verso: "Présent d'énonciation (maintenant) et présent de vérité générale (toujours vrai), entre autres." },
  ],
  exercices: [
    {
      type: "qcm",
      difficulte: "facile",
      question: "Quelle est la bonne conjugaison de « parler » à la 1ère personne du pluriel ?",
      choix: ["Nous parlont", "Nous parlons", "Nous parlez", "Nous parle"],
      bonneReponse: 1,
      explication: "Les verbes du 1er groupe prennent -ons à la 1ère personne du pluriel : nous parlons.",
    },
    {
      type: "qcm",
      difficulte: "facile",
      question: "Comment conjugue-t-on « avoir » à la 3e personne du singulier ?",
      choix: ["Il as", "Il a", "Il ai", "Il ont"],
      bonneReponse: 1,
      explication: "« Avoir » se conjugue : j'ai, tu as, il a, nous avons, vous avez, ils ont.",
    },
    {
      type: "ouverte",
      difficulte: "facile",
      question: "Conjugue le verbe « finir » aux six personnes du présent.",
      reponse: "Je finis, tu finis, il finit, nous finissons, vous finissez, ils finissent.",
      explication: "Le verbe « finir » appartient au 2e groupe : terminaisons is, is, it, issons, issez, issent.",
    },
    {
      type: "qcm",
      difficulte: "facile",
      question: "Quelle phrase est correctement orthographiée ?",
      choix: ["Vous faisez vos devoirs.", "Vous faites vos devoirs.", "Vous fesez vos devoirs.", "Vous faisiez vos devoirs."],
      bonneReponse: 1,
      explication: "Le verbe « faire » donne « vous faites » à la 2e personne du pluriel du présent.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Quelle est la bonne orthographe pour « nous » + le verbe « manger » au présent ?",
      choix: ["Nous mangons", "Nous mangeons", "Nous mangeont", "Nous mangont"],
      bonneReponse: 1,
      explication: "Les verbes en -ger gardent le « e » devant -ons pour conserver le son [j] : nous mangeons.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Conjugue le verbe « prendre » aux six personnes du présent.",
      reponse: "Je prends, tu prends, il prend, nous prenons, vous prenez, ils prennent.",
      explication: "« Prendre » est un verbe du 3e groupe : attention au doublement du « n » à la 3e personne du pluriel.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Corrige les erreurs dans cette phrase : « Ils dise que nous alons trop vite. »",
      reponse: "« Ils disent que nous allons trop vite. »",
      explication: "« Dire » donne « ils disent » ; « aller » donne « nous allons » (avec deux L).",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Dans « L'eau bout à 100 degrés », quelle est la valeur du présent ?",
      choix: ["Présent d'habitude", "Présent de vérité générale", "Présent de narration", "Présent d'énonciation"],
      bonneReponse: 1,
      explication: "C'est une règle scientifique toujours vraie : c'est un présent de vérité générale.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Conjugue le verbe « venir » aux six personnes du présent et explique la particularité de la 3e personne du pluriel.",
      reponse: "Je viens, tu viens, il vient, nous venons, vous venez, ils viennent. À la 3e personne du pluriel, le « n » est doublé et le radical change légèrement (vien-nent), comme pour « prendre » ou « tenir ».",
      explication: "Ce doublement de consonne est fréquent dans plusieurs verbes irréguliers du 3e groupe.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Dans le texte suivant, identifie la valeur du présent employé : « Napoléon franchit les Alpes en 1800. Il surprend ainsi l'armée autrichienne. »",
      reponse: "C'est un présent de narration : bien que les faits se déroulent dans le passé (1800), l'auteur utilise le présent pour rendre le récit plus vivant, comme si l'action se déroulait sous nos yeux.",
      explication: "Le présent de narration est très utilisé dans les récits historiques et littéraires pour créer un effet de proximité.",
    },
    {
      type: "qcm",
      difficulte: "avance",
      question: "Quelle phrase illustre un présent d'habitude ?",
      choix: [
        "Je me lève à 7 heures tous les matins.",
        "Regarde, il pleut !",
        "Le Soleil se lève à l'est.",
        "Un jour, le lion rencontre le renard.",
      ],
      bonneReponse: 0,
      explication: "« Tous les matins » indique une action répétée régulièrement : c'est un présent d'habitude.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Explique pourquoi on écrit « nous commençons » avec une cédille et donne un autre exemple du même type.",
      reponse: "On ajoute une cédille sous le « c » pour qu'il garde le son [s] devant le « o » de la terminaison -ons ; sans cédille, il se prononcerait [k]. Autre exemple : nous plaçons, nous avançons, nous lançons.",
      explication: "C'est la même règle que pour le « e » des verbes en -ger : elle sert à conserver la prononciation du radical.",
    },
  ],
  revisionFinChapitre: [
    {
      ...
      bonneReponse: 1,
      explication: "Il existe trois groupes : les verbes en -er (sauf aller), les verbes en -ir type finir, et les autres.",
    },
    {
      type: "ouverte",
      difficulte: "facile",
      question: "Conjugue « être » à la 1ère personne du singulier et du pluriel.",
      reponse: "Je suis ; nous sommes.",
      explication: "« Être » est un verbe très irrégulier à connaître par cœur.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Quelle est la bonne forme : « Vous ... vos affaires » avec le verbe « dire » ?",
      choix: ["disez", "dites", "disont", "dit"],
      bonneReponse: 1,
      explication: "« Dire » donne « vous dites » à la 2e personne du pluriel, sans -ez.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Pourquoi écrit-on « nous voyageons » avec un « e » avant -ons ?",
      reponse: "Pour conserver le son doux du « g » (comme dans « je ») devant la terminaison -ons.",
      explication: "C'est la règle des verbes en -ger au présent, à la 1ère personne du pluriel.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Donne un exemple de présent d'énonciation et un exemple de présent de vérité générale.",
      reponse: "Présent d'énonciation : « Je te parle en ce moment. » Présent de vérité générale : « La Terre tourne autour du Soleil. »",
      explication: "Le premier concerne l'instant de parole, le second exprime une vérité toujours valable.",
    },
  ],
  examens: [
    {
      titre: "Examen 1 — Le présent de l'indicatif",
      dureeMinutes: 20,
      questions: [
        {
          type: "qcm",
          difficulte: "facile",
          question: "Quelle terminaison n'appartient PAS au 1er groupe au présent ?",
          choix: ["-e", "-ons", "-issons", "-ent"],
          bonneReponse: 2,
          explication: "« -issons » est une terminaison du 2e groupe (nous finissons), pas du 1er groupe.",
        },
        {
          type: "ouverte",
          difficulte: "facile",
          question: "Conjugue le verbe « chanter » aux six personnes du présent.",
          reponse: "Je chante, tu chantes, il chante, nous chantons, vous chantez, ils chantent.",
          explication: "Verbe régulier du 1er groupe : terminaisons e, es, e, ons, ez, ent.",
        },
        {
          type: "qcm",
          difficulte: "moyen",
          question: "Quelle phrase est correcte ?",
          choix: ["Nous plaçons nos affaires.", "Nous placons nos affaires.", "Nous placont nos affaires.", "Nous plaçont nos affaires."],
          bonneReponse: 0,
          explication: "Le « c » de « placer » devient « ç » devant -ons pour garder le son [s].",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Corrige les erreurs : « Il vont au marché et il font les courses. »",
          reponse: "« Ils vont au marché et ils font les courses. »",
          explication: "Avec un sujet pluriel (ils), il faut accorder le verbe au pluriel : vont, font.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Explique la différence entre le présent d'énonciation et le présent de narration, avec un exemple pour chacun.",
          reponse: "Le présent d'énonciation exprime une action au moment où l'on parle : « Je mange maintenant. » Le présent de narration raconte un fait passé comme s'il se déroulait sous nos yeux, pour le rendre plus vivant : « En 1789, le peuple prend la Bastille. »",
          explication: "Le présent de narration est souvent utilisé dans les récits historiques ou littéraires.",
        },
        {
          type: "ouverte",
          difficulte: "avance",
          question: "Conjugue le verbe « pouvoir » aux six personnes du présent, puis rédige une phrase l'utilisant à la 1ère personne du singulier.",
          reponse: "Je peux, tu peux, il peut, nous pouvons, vous pouvez, ils peuvent. Exemple de phrase : « Je peux t'aider à faire tes devoirs. »",
          explication: "« Pouvoir » est un verbe irrégulier du 3e groupe, à ne pas confondre avec « je peu » (sans x), qui est fautif.",
        },
      ],
    },
    {
      titre: "Examen 2 — Le présent de l'indicatif",
      dureeMinutes: 20,
      questions: [
        {
          type: "qcm",
          ...
          choix: ["1er groupe", "2e groupe", "3e groupe", "Aucun groupe"],
          bonneReponse: 1,
          explication: "« Finir » fait -issant au participe présent (finissant) : c'est un verbe du 2e groupe.",
        },
        {
          type: "ouverte",
          difficulte: "facile",
          question: "Conjugue le verbe « avoir » aux six personnes du présent.",
          reponse: "J'ai, tu as, il a, nous avons, vous avez, ils ont.",
          explication: "« Avoir » est un verbe irrégulier essentiel, notamment utilisé comme auxiliaire.",
        },
        {
          type: "qcm",
          difficulte: "moyen",
          question: "Quelle phrase illustre un présent de vérité générale ?",
          choix: [
            "Je regarde la télévision en ce moment.",
            "Deux et deux font quatre.",
            "Il arrive demain.",
            "Attends, j'arrive !",
          ],
          bonneReponse: 1,
          explication: "C'est une vérité mathématique toujours valable, indépendante du moment où l'on parle.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Corrige les erreurs dans la phrase : « Nous mangons et nous commencons à travailler. »",
          reponse: "« Nous mangeons et nous commençons à travailler. »",
          explication: "Verbe en -ger : on garde le « e » (mangeons) ; verbe en -cer : le « c » devient « ç » (commençons).",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Donne la conjugaison du verbe « dire » aux six personnes du présent et signale la forme la plus irrégulière.",
          reponse: "Je dis, tu dis, il dit, nous disons, vous dites, ils disent. La forme la plus irrégulière est « vous dites » (et non « vous disez »).",
          explication: "C'est l'une des erreurs les plus fréquentes en conjugaison du présent.",
        },
        {
          type: "ouverte",
          difficulte: "avance",
          question: "Rédige un court texte de 3 phrases au présent racontant ta journée type, en utilisant au moins un verbe de chaque groupe.",
          reponse: "Exemple de réponse : « Chaque matin, je me lève à 7 heures. Je finis mon petit-déjeuner avant de partir au collège. Ensuite, je prends le bus avec mes amis. » (« lève » : 1er groupe, « finis » : 2e groupe, « prends » : 3e groupe)",
          explication: "On vérifie la bonne conjugaison au présent et l'identification correcte du groupe de chaque verbe.",
        },
      ],
    },
  ],
  syntheseRevisions: [
    "Le présent de l'indicatif exprime une action au moment où l'on parle, mais il a aussi d'autres valeurs.",
    "1er groupe (verbes en -er) : -e, -es, -e, -ons, -ez, -ent (je parle, nous parlons).",
    "2e groupe (verbes en -ir type finir) : -is, -is, -it, -issons, -issez, -issent.",
    "3e groupe : terminaisons irrégulières, à apprendre par cœur (je prends, nous prenons).",
    "Être, avoir, aller, dire, faire : verbes irréguliers essentiels à connaître parfaitement.",
    "Pièges d'orthographe : « nous mangeons », « nous commençons », « vous dites », « vous faites ».",
  ],
},
{
  slug: "recits-creation",
  titre: "Récits de création et déluges",
  matiere: "francais",
  niveau: "6eme",
  description:
    "Découvrir les récits de création du monde et les récits de déluge à travers différentes cultures et mythologies, pour comprendre comment les hommes ont cherché à expliquer les origines du monde.",
  objectifs: [
    "Comprendre ce qu'est un mythe et un récit de création",
    "Découvrir plusieurs récits de création du monde (grec, biblique, égyptien)",
    "Comparer différents récits de déluge",
    "Identifier les points communs entre ces récits fondateurs",
    "Comprendre la fonction de ces récits pour les sociétés humaines",
  ],
  slides: [
    {
      titre: "Qu'est-ce qu'un mythe de création ?",
      illustration: "🌍",
      visuel: "Chaos → Monde ordonné",
      contenu: [
        "Un mythe est un récit qui explique une origine ou un phénomène",
        "Le récit de création raconte comment le monde est apparu",
        "Il répond à des questions que l'homme se pose depuis toujours",
        "Chaque culture a inventé ses propres récits de création",
      ],
      voixOff:
        "Un mythe est un récit ancien qui cherche à expliquer une origine ou un phénomène du monde. Le récit de création raconte comment l'univers, la Terre et les êtres vivants sont apparus. Depuis toujours, les hommes se sont posé des questions sur leurs origines, et chaque culture a inventé ses propres réponses sous forme de récits que l'on appelle des mythes.",
    },
    {
      titre: "La création du monde chez les Grecs",
      illustration: "⛰️",
      visuel: "Chaos → Gaïa → Ouranos → Zeus",
      contenu: [
        "Au commencement était le Chaos, un vide immense et confus",
        "Gaïa, la Terre, apparaît, puis Ouranos, le Ciel",
        "De leur union naissent les Titans, puis les dieux de l'Olympe",
        "Zeus devient le roi des dieux après avoir vaincu son père Cronos",
      ],
      voixOff:
        "Dans la mythologie grecque, au tout début n'existait que le Chaos, un vide sombre et confus. De lui naquit Gaïa, la Terre, puis Ouranos, le Ciel. De leur union naquirent les Titans, des géants puissants, puis leurs enfants, les dieux de l'Olympe. Zeus, le plus jeune de ces dieux, finit par détrôner son père Cronos et devint le roi de tous les dieux.",
    },
    {
      titre: "La création du monde dans la Bible",
      illustration: "📖",
      visuel: "6 jours de création",
      contenu: [
        "Dieu crée le monde en six jours selon le livre de la Genèse",
        "Jour 1 : la lumière ; jour 4 : le Soleil, la Lune, les étoiles",
        "Jour 6 : les animaux, puis l'homme et la femme",
        "Le septième jour, Dieu se repose",
      ],
      voixOff:
        "Dans le livre de la Genèse, premier livre de la Bible, Dieu crée le monde en six jours. Le premier jour, il crée la lumière ; le quatrième jour, le Soleil, la Lune et les étoiles ; et le sixième jour, les animaux, puis l'homme et la femme à son image. Le septième jour, Dieu se repose : c'est l'origine du jour de repos hebdomadaire dans plusieurs religions.",
    },
    {
      titre: "La création du monde en Égypte ancienne",
      illustration: "☀️",
      visuel: "Noun → Rê",
      contenu: [
        "Au commencement existait Noun, un océan primordial infini",
        "Le dieu Rê (ou Atoum) émerge de cet océan et crée la lumière",
        "Rê crée ensuite les autres dieux et les éléments du monde",
        "Le Soleil traverse chaque jour le ciel sur une barque",
      ],
      voixOff:
        "Les Égyptiens de l'Antiquité racontaient qu'au commencement n'existait que Noun, un océan primordial et infini plongé dans l'obscurité. De cet océan émergea le dieu Rê, parfois appelé Atoum, qui créa la lumière puis les autres dieux et les éléments du monde. Chaque jour, selon ce mythe, Rê traverse le ciel à bord d'une barque solaire, de l'aube jusqu'au crépuscule.",
    },
    {
      titre: "Qu'est-ce qu'un récit de déluge ?",
      illustration: "🌊",
      visuel: "Une immense inondation punit les hommes",
      contenu: [
        "Le déluge est une inondation immense qui détruit presque toute vie",
        "Il est souvent envoyé par une ou plusieurs divinités en colère",
        "Un seul homme (et sa famille) survit grâce à un bateau",
        "Ce héros doit ensuite repeupler la Terre",
      ],
      voixOff:
        "Le récit de déluge raconte une inondation si immense qu'elle détruit presque toute forme de vie sur Terre. Dans la plupart des versions, ce déluge est envoyé par une ou plusieurs divinités en colère contre les humains. Un seul homme, prévenu à l'avance, survit avec sa famille grâce à la construction d'un bateau, et doit ensuite repeupler la Terre.",
    },
    {
      titre: "Noé et le déluge biblique",
      illustration: "🐘",
      visuel: "L'Arche de Noé",
      contenu: [
        "Dieu, déçu par la méchanceté des hommes, décide d'envoyer le déluge",
        "Il ordonne à Noé de construire une arche",
        "Noé y fait entrer sa famille et un couple de chaque animal",
        "Après quarante jours de pluie, une colombe annonce la fin du déluge",
      ],
      voixOff:
        "Dans la Bible, Dieu, déçu par la méchanceté grandissante des hommes, décide d'envoyer un déluge pour purifier la Terre. Il ordonne à Noé, un homme juste, de construire une immense arche. Noé y fait entrer sa famille ainsi qu'un couple de chaque espèce animale. Après quarante jours et quarante nuits de pluie, une colombe rapporte un rameau d'olivier, signe que les eaux se retirent.",
    },
    {
      titre: "D'autres récits de déluge dans le monde",
      illustration: "🌐",
      visuel: "Mésopotamie, Grèce, civilisations amérindiennes",
      contenu: [
        "Le récit d'Utnapishtim (épopée de Gilgamesh, Mésopotamie)",
        "Le déluge de Deucalion dans la mythologie grecque",
        "Des récits de déluge existent aussi en Chine, en Inde, en Amérique",
        "Ces récits se ressemblent malgré la distance entre les cultures",
      ],
      voixOff:
        "Le récit de Noé n'est pas unique : bien avant la Bible, l'épopée mésopotamienne de Gilgamesh racontait déjà l'histoire d'Utnapishtim, sauvé du déluge par une arche. Les Grecs racontaient celle de Deucalion et Pyrrha, seuls survivants d'un déluge envoyé par Zeus. On trouve aussi des récits de déluge en Chine, en Inde et chez plusieurs peuples d'Amérique, preuve que cette histoire a fasciné l'humanité entière.",
    },
    {
      titre: "Pourquoi ces récits se ressemblent-ils ?",
      illustration: "🔍",
      visuel: "Points communs entre les mythes",
      contenu: [
        "Ils répondent tous à la même question : d'où vient le monde ?",
        "Ils organisent souvent le chaos en un monde ordonné",
        "Le déluge exprime souvent une punition suivie d'un renouveau",
        "Ces récits transmettent des valeurs propres à chaque culture",
      ],
      voixOff:
        "Ces récits venus de cultures très différentes se ressemblent parce qu'ils répondent tous à la même grande question : d'où vient le monde ? On y retrouve souvent le même mouvement, du chaos vers un monde ordonné. Le déluge, lui, exprime fréquemment l'idée d'une punition suivie d'un renouveau, d'une seconde chance donnée à l'humanité. Chaque culture y ajoute ses propres valeurs et croyances.",
    },
    {
      titre: "Ce qu'il faut retenir",
      illustration: "🏆",
      visuel: "📌",
      contenu: [
        "Le mythe de création explique l'origine du monde et des hommes",
        "Grecs, Égyptiens et Hébreux ont chacun leur récit de création",
        "Le déluge punit les hommes puis permet un nouveau départ",
        "Ces récits, bien que différents, posent les mêmes grandes questions",
      ],
      voixOff:
        "Pour conclure, retiens que le mythe de création cherche à expliquer l'origine du monde et des êtres humains, et que chaque civilisation, grecque, égyptienne ou biblique, a construit son propre récit. Le déluge, quant à lui, raconte une punition suivie d'un renouveau pour l'humanité. Bien que ces récits diffèrent par leurs détails, ils posent tous les mêmes grandes questions sur nos origines.",
    },
  ],
  fiche: {
    intro:
      "Les récits de création et de déluge sont des mythes fondateurs présents dans de nombreuses cultures. Ils cherchent à expliquer l'origine du monde, des hommes, et parfois leur destruction partielle suivie d'un renouveau.",
    sections: [
      {
        titre: "Le mythe : définition",
        points: [
          "Un mythe est un récit qui explique une origine ou un phénomène naturel",
          "Il met en scène des dieux, des héros ou des forces surnaturelles",
          "Il était souvent transmis oralement avant d'être écrit",
          "Chaque civilisation a ses propres mythes de création",
        ],
      },
      {
        titre: "Trois récits de création",
        points: [
          "Grec : du Chaos naissent Gaïa (la Terre) et Ouranos (le Ciel), puis les dieux",
          "Biblique : Dieu crée le monde en six jours (Genèse) et se repose le septième",
          "Égyptien : le dieu Rê émerge de l'océan primordial Noun et crée la lumière",
          "Ces récits organisent le passage du chaos à un monde ordonné",
        ],
      },
      {
        titre: "Le récit de déluge",
        points: [
          "Une inondation immense punit les hommes, souvent envoyée par une divinité",
          "Un héros averti (Noé, Utnapishtim, Deucalion) construit un bateau",
          "Il sauve sa famille et parfois des animaux",
          "Le déluge se termine par un signe (colombe, arc-en-ciel) et un renouveau",
        ],
      },
      {
        titre: "Pourquoi comparer ces récits ?",
        points: [
          "Des récits venus de cultures éloignées se ressemblent étonnamment",
          "Ils répondent tous à la question des origines du monde",
          "Le déluge exprime souvent l'idée de punition puis de seconde chance",
          "Comparer les mythes aide à comprendre les valeurs de chaque culture",
        ],
      },
    ],
    audio:
      "Fiche de révision : récits de création et déluges. Un mythe est un récit qui explique une origine ou un phénomène naturel, souvent transmis oralement avant d'être écrit. Le récit de création raconte l'apparition du monde. Chez les Grecs, du Chaos naissent la Terre et le Ciel, puis les dieux de l'Olympe. Dans la Bible, Dieu crée le monde en six jours et se repose le septième. En Égypte, le dieu Rê émerge de l'océan primordial Noun et crée la lumière. Le récit de déluge raconte une inondation immense envoyée pour punir les hommes : un héros averti, comme Noé, construit un bateau pour sauver sa famille, avant qu'un signe n'annonce la fin des eaux et un renouveau. Ces récits venus de cultures différentes se ressemblent car ils répondent tous aux mêmes grandes questions sur les origines du monde.",
  },
  memoCards: [
    { recto: "Qu'est-ce qu'un mythe ?", verso: "Un récit qui explique une origine ou un phénomène du monde, souvent avec des dieux ou des héros." },
    { recto: "Que raconte le mythe grec de création ?", verso: "Du Chaos naissent Gaïa (la Terre) et Ouranos (le Ciel), puis les Titans et les dieux de l'Olympe." },
    { recto: "Combien de jours Dieu met-il pour créer le monde (Bible) ?", verso: "Six jours ; le septième jour, il se repose." },
    { recto: "Qui est Rê dans le mythe égyptien ?", verso: "Le dieu qui émerge de l'océan primordial Noun et crée la lumière." },
    { recto: "Qu'est-ce qu'un récit de déluge ?", verso: "Une inondation immense qui punit les hommes ; un héros survit grâce à un bateau." },
    { recto: "Qui construit l'arche dans la Bible ?", verso: "Noé, sur l'ordre de Dieu, pour sauver sa famille et un couple de chaque animal." },
    { recto: "Cite un autre héros du déluge (hors Bible).", verso: "Utnapishtim (épopée de Gilgamesh, Mésopotamie) ou Deucalion (mythologie grecque)." },
    { recto: "Pourquoi ces récits se ressemblent-ils ?", verso: "Parce qu'ils répondent tous à la même question sur l'origine du monde et expriment souvent punition puis renouveau." },
  ],
  exercices: [
    {
      type: "qcm",
      difficulte: "facile",
      question: "Qu'est-ce qu'un mythe ?",
      choix: ["Un roman policier", "Un récit qui explique une origine", "Un poème d'amour", "Une pièce de théâtre comique"],
      bonneReponse: 1,
      explication: "Le mythe cherche à expliquer une origine ou un phénomène du monde à travers un récit.",
    },
    {
      type: "qcm",
      difficulte: "facile",
      question: "Dans la Bible, en combien de jours Dieu crée-t-il le monde ?",
      choix: ["Trois", "Six", "Sept", "Dix"],
      bonneReponse: 1,
      explication: "Dieu crée le monde en six jours, puis se repose le septième jour.",
    },
    {
      type: "ouverte",
      difficulte: "facile",
      question: "Qui construit l'arche dans le récit biblique du déluge ?",
      reponse: "Noé.",
      explication: "Dieu lui ordonne de construire une arche pour sauver sa famille et les animaux.",
    },
    {
      type: "qcm",
      difficulte: "facile",
      question: "Qu'existe-t-il au tout début du mythe grec de création ?",
      choix: ["La Terre", "Le Chaos", "Zeus", "L'Olympe"],
      bonneReponse: 1,
      explication: "Le Chaos est le vide originel d'où naissent Gaïa et Ouranos.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Quel dieu égyptien émerge de l'océan primordial Noun ?",
      choix: ["Zeus", "Rê", "Cronos", "Poséidon"],
      bonneReponse: 1,
      explication: "Rê (ou Atoum) émerge de Noun et crée la lumière et les autres dieux.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Quel signe annonce, dans le récit de Noé, que le déluge touche à sa fin ?",
      reponse: "Une colombe rapporte un rameau d'olivier, signe que les eaux se retirent.",
      explication: "Ce signe marque la fin de la punition et le début d'un renouveau pour l'humanité.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Cite un autre récit de déluge que celui de Noé, en précisant sa culture d'origine.",
      reponse: "Le récit d'Utnapishtim dans l'épopée de Gilgamesh (Mésopotamie), ou celui de Deucalion et Pyrrha (mythologie grecque).",
      explication: "Ces récits sont antérieurs ou parallèles au récit biblique et présentent une structure très proche.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Que symbolise généralement le déluge dans les mythes ?",
      choix: [
        "Une simple pluie sans conséquence",
        "Une punition suivie d'un renouveau",
        "Une fête entre les dieux",
        "La naissance du premier homme",
      ],
      bonneReponse: 1,
      explication: "Le déluge punit les hommes de leurs fautes, puis permet un nouveau départ pour l'humanité.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Compare le mythe de création grec et le mythe de création biblique : quel est leur point commun principal ?",
      reponse: "Dans les deux récits, le monde passe d'un état de désordre ou de vide (le Chaos, ou la Terre \"informe et vide\") à un monde organisé, créé par des forces divines. Les deux racontent une progression du chaos vers un ordre.",
      explication: "Cette structure du chaos vers l'ordre se retrouve dans de très nombreux récits de création à travers le monde.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Pourquoi peut-on dire que les récits de déluge, bien que venus de cultures très éloignées, se ressemblent beaucoup ?",
      reponse: "Parce qu'ils partagent une structure commune : une divinité en colère envoie une inondation pour punir les hommes, un héros est prévenu et construit un bateau, il sauve sa famille (et parfois des animaux), puis un signe annonce la fin du déluge et un nouveau départ pour l'humanité.",
      explication: "Cette ressemblance interroge encore aujourd'hui historiens et chercheurs sur les origines communes ou parallèles de ces récits.",
    },
    {
      type: "qcm",
      difficulte: "avance",
      question: "Quelle affirmation est correcte concernant les mythes de création ?",
      choix: [
        "Ils n'existent que dans la culture grecque",
        "Ils ont tous été écrits à la même époque",
        "Chaque civilisation a construit ses propres récits pour expliquer les origines du monde",
        "Ils ne mettent jamais en scène de divinités",
      ],
      bonneReponse: 2,
      explication: "Grecs, Égyptiens, Hébreux et bien d'autres peuples ont chacun élaboré leurs propres récits d'origine.",
    },
    {
      type: "ouverte",
      difficulte: "avance",
      question: "Selon toi, pourquoi les hommes ont-ils inventé des récits pour expliquer l'origine du monde, avant l'existence de la science ?",
      reponse: "Réponse ouverte attendue : les hommes cherchaient à comprendre et à expliquer des phénomènes qu'ils ne pouvaient pas encore analyser scientifiquement (le jour, la nuit, les catastrophes naturelles...). Les mythes donnaient du sens à leur existence et transmettaient aussi des valeurs et des règles de vie en société.",
      explication: "On valorisera toute réponse argumentée montrant la fonction explicative et culturelle du mythe.",
    },
  ],
  revisionFinChapitre: [
    {
      type: "qcm",
      difficulte: "facile",
      question: "Un mythe de création raconte :",
      choix: ["une histoire d'amour", "l'apparition du monde", "un procès", "un voyage en train"],
      bonneReponse: 1,
      explication: "Le mythe de création explique comment le monde et les hommes sont apparus.",
    },
    {
      type: "ouverte",
      difficulte: "facile",
      question: "Que fait Noé pour survivre au déluge ?",
      reponse: "Il construit une arche pour sauver sa famille et un couple de chaque animal.",
      explication: "Dieu lui donne cette mission car il est considéré comme un homme juste.",
    },
    {
      type: "qcm",
      difficulte: "moyen",
      question: "Chez les Grecs, qui naît en premier de l'union de Gaïa et Ouranos ?",
      choix: ["Zeus directement", "Les Titans", "Les hommes", "Les animaux"],
      bonneReponse: 1,
      explication: "Les Titans sont les premiers enfants de Gaïa et Ouranos, avant les dieux de l'Olympe.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Que symbolise en général le déluge dans les mythes du monde entier ?",
      reponse: "Une punition envoyée aux hommes, suivie d'un renouveau ou d'un nouveau départ pour l'humanité.",
      explication: "C'est une structure que l'on retrouve dans de nombreuses cultures.",
    },
    {
      type: "ouverte",
      difficulte: "moyen",
      question: "Cite le nom du dieu égyptien de la création et de l'océan dont il émerge.",
      reponse: "Le dieu Rê (ou Atoum) émerge de l'océan primordial Noun.",
      explication: "Rê crée ensuite la lumière et les autres divinités égyptiennes.",
    },
  ],
  examens: [
    {
      titre: "Examen 1 — Récits de création et déluges",
      dureeMinutes: 20,
      questions: [
        {
          type: "qcm",
          difficulte: "facile",
          question: "Un mythe met souvent en scène :",
          choix: ["des dieux et des héros", "uniquement des animaux", "des personnages historiques réels", "des robots"],
          bonneReponse: 0,
          explication: "Les mythes mettent en scène des forces surnaturelles, des dieux ou des héros.",
        },
        {
          type: "ouverte",
          difficulte: "facile",
          question: "Qu'est-ce que le Chaos dans le mythe grec de création ?",
          reponse: "Le vide originel, sombre et confus, qui existait avant la naissance de la Terre et du Ciel.",
          explication: "De ce vide naissent Gaïa (la Terre) et Ouranos (le Ciel).",
        },
        {
          type: "qcm",
          difficulte: "moyen",
          question: "Quel jour, selon la Genèse, Dieu crée-t-il l'homme et la femme ?",
          choix: ["Le premier jour", "Le quatrième jour", "Le sixième jour", "Le septième jour"],
          bonneReponse: 2,
          explication: "Dieu crée les animaux puis l'homme et la femme le sixième jour, avant de se reposer le septième.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Explique le rôle du bateau (ou de l'arche) dans les récits de déluge.",
          reponse: "Le bateau permet au héros averti et à sa famille de survivre à l'inondation ; il permet aussi souvent de sauvegarder des animaux, afin de pouvoir repeupler la Terre après la fin du déluge.",
          explication: "Cet élément se retrouve dans presque tous les récits de déluge à travers le monde.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Donne un point commun et une différence entre le mythe de création grec et le mythe de création biblique.",
          reponse: "Point commun : les deux racontent un passage du désordre (le Chaos, ou le vide) vers un monde organisé. Différence : chez les Grecs, le monde naît de plusieurs générations de divinités qui se succèdent (Chaos, Gaïa, Ouranos, Titans, dieux de l'Olympe), alors que dans la Bible, un seul Dieu crée le monde en six jours de façon organisée et progressive.",
          explication: "On valorise la capacité à comparer deux récits en identifiant ressemblance et différence.",
        },
        {
          type: "ouverte",
          difficulte: "avance",
          question: "Pourquoi peut-on dire que les récits de création et de déluge remplissaient une fonction importante pour les sociétés anciennes ?",
          reponse: "Ils permettaient d'expliquer l'origine du monde et des phénomènes naturels avant l'existence de la science, de transmettre des valeurs morales (le courage, la justice, le respect des dieux) et de donner un sens commun à une communauté à travers des récits partagés.",
          explication: "Cette fonction explicative, morale et sociale du mythe est essentielle à comprendre pour ce chapitre.",
        },
      ],
    },
    {
      titre: "Examen 2 — Récits de création et déluges",
      dureeMinutes: 20,
      questions: [
        {
          type: "qcm",
          difficulte: "facile",
          question: "Dans quel livre trouve-t-on le récit biblique de la création du monde ?",
          choix: ["L'Odyssée", "La Genèse", "L'Iliade", "Les Fables"],
          bonneReponse: 1,
          explication: "La Genèse est le premier livre de la Bible ; il raconte la création du monde et le déluge de Noé.",
        },
        {
          type: "ouverte",
          difficulte: "facile",
          question: "Quel animal Noé envoie-t-il pour savoir si les eaux se retirent ?",
          reponse: "Une colombe.",
          explication: "Elle revient avec un rameau d'olivier, signe que la Terre redevient habitable.",
        },
        {
          type: "qcm",
          difficulte: "moyen",
          question: "Dans quelle œuvre trouve-t-on le récit d'Utnapishtim, survivant d'un déluge ?",
          choix: ["L'épopée de Gilgamesh", "L'Odyssée d'Homère", "Les Fables de La Fontaine", "La Genèse"],
          bonneReponse: 0,
          explication: "Cette épopée mésopotamienne est antérieure à la Bible et raconte un déluge très semblable.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Explique pourquoi, selon le récit biblique, Dieu décide d'envoyer le déluge.",
          reponse: "Parce qu'il est déçu et attristé par la méchanceté grandissante des hommes sur Terre ; il décide de purifier le monde en n'épargnant que Noé, considéré comme juste, et sa famille.",
          explication: "Le déluge biblique a donc une valeur morale de punition et de purification.",
        },
        {
          type: "ouverte",
          difficulte: "moyen",
          question: "Donne le nom des deux survivants du déluge dans la mythologie grecque.",
          reponse: "Deucalion et Pyrrha.",
          explication: "Ils repeuplent la Terre après le déluge envoyé par Zeus, selon la légende.",
        },
        {
          type: "ouverte",
          difficulte: "avance",
          question: "En comparant trois récits de création vus dans ce chapitre (grec, biblique, égyptien), montre qu'ils obéissent tous à un même mouvement du désordre vers l'ordre.",
          reponse: "Chez les Grecs, le Chaos (désordre) laisse place à Gaïa et Ouranos puis à un monde organisé autour des dieux de l'Olympe. Dans la Bible, la Terre \"informe et vide\" devient un monde ordonné en six jours de création. En Égypte, l'océan sombre et infini de Noun laisse place à la lumière créée par Rê, puis à un monde organisé autour des dieux égyptiens. Dans les trois cas, on part d'un état confus ou vide pour arriver à un monde structuré.",
          explication: "Cette question invite à synthétiser les trois récits étudiés en dégageant leur structure commune.",
        },
      ],
    },
  ],
  syntheseRevisions: [
    "Un mythe explique une origine ou un phénomène du monde à travers un récit mettant en scène des dieux ou des héros.",
    "Le mythe grec de création part du Chaos, d'où naissent Gaïa (la Terre) et Ouranos (le Ciel), puis les dieux de l'Olympe.",
    "Dans la Bible, Dieu crée le monde en six jours puis se repose le septième jour (livre de la Genèse).",
    "En Égypte ancienne, le dieu Rê émerge de l'océan primordial Noun et crée la lumière.",
    "Le récit de déluge (Noé, Utnapishtim, Deucalion) suit toujours la même structure : punition, survie grâce à un bateau, puis renouveau.",
    "Ces récits venus de cultures différentes se ressemblent car ils répondent tous aux mêmes grandes questions sur les origines du monde.",
  ],
},
{
